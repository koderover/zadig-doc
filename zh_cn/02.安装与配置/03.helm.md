...
```bash
helm upgrade --install zadig --namespace zadig  koderover-chart/zadig --version=1.3.0 --set endpoint.FQDN=<your domain>
```
### IP + PORT 访问
...
```bash
helm upgrade --install zadig --namespace zadig  koderover-chart/zadig --version=1.3.0 \
