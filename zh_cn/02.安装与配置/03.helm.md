...
# 需要确保 global.extensions.extAuth.extauthzServerRef.namespace 和安装 Zadig 系统的 Namespace 一致
```
### IP + PORT 访问
...
Zadig Chart 除了 Zadig 系统外，还内置了一些必要的组件 MongoDB、Minio、MySQL，可以根据您的安装环境实际情况选择是否安装这些组件
