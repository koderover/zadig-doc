...
::: tip 前提
需要先在系统模板库里创建 K8s YAML 模板，请参考 [K8s YAML 模板管理](/pages/k8s_yaml_template/)
:::
...
使用 Helm Chart 部署的项目中点击服务部分，进入服务管理页面。
...
#### 模板库
::: tip 前提
需要先在系统模板库里创建 Helm Chart 模板，请参考 [Helm Chart 模板管理](/pages/helm_chart_template/)
:::
