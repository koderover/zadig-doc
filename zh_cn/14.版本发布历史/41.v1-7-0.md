...
::: warning 背景信息
1. <font color=#FF000 >**不支持跨版本升级**</font>，如果当前系统版本 < v1.6.0，请先参考 [v1.6.0 升级方式](/release-notes/v1.6.0/#版本升级方式) 升级到 v1.6.0，再按照以下方式升级到 v1.7.0。

2. v1.7.0 版本中未保留用户账号信息，安装完成后，使用系统提供的内置账号密码在用户管理里新建即可。
:::
