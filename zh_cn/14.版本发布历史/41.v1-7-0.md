...
::: danger 背景信息
1. 如果当前系统版本 < v1.6.0，请先升级到 v1.6.0，升级方式参考文档 [v1.6.0 升级方式](/release-notes/v1.6.0/#版本升级方式)。再按照以下方式升级到v1.7.0。**不支持跨版本升级**

2. 1.7.0 版本中未保留用户账号信息，安装完成后，使用系统提供的内置账号密码在用户管理里新建即可。
:::
