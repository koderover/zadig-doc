...
::: warning 注意
<Badge text="v1.3.0 +"/> 版本，系统自动添加 webhook，无需手动配置
:::

## GitLab Webhook 配置 <span style="font-size:14px;color:#e20382;">1.2.0及以下版本适用</span> 
...
## GitHub Webhook 配置 <span style="font-size:14px;color:#e20382;">1.2.0 及以下版本适用</span> 
