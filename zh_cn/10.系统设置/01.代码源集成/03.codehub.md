...
permalink: /settings/codehost/codehub
---
...
- 首先登录 CodeHub
- 查看[如何获取 Access Key / Secret Key](https://support.huaweicloud.com/devg-apisign/api-sign-provide-aksk.html )  文档获取 Access Key / Secret Key。
- 查看[如何获取 Username / Password](https://support.huaweicloud.com/usermanual-codehub/codehub_ug_8003.html ) 文档获取 Username / Password。
