...
- 安装 Zadig，参考 [快速安装](/quick-start/try-out-install)
...
::: tip
代码源集成请参考 [GitHub 集成](/settings/codehost/github)
:::
...
::: warning
请提前配置好代码源和镜像仓库集成，如安装时未配置，具体配置请参照[`系统设置->集成管理->代码源集成`](/settings/codehost/gitlab) 以及 [`系统设置->镜像仓库`](/settings/image-registry/)
:::
...
关于 GitHub Webhook 配置请参考 [`GitHub Webhook`](/settings/webhook-config/#github-webhook-配置-1-3-0-以下版本适用)
:::
