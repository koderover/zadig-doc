...
2. 基于构建模板，为服务配置构建，参考文档：[构建](/Zadig%20v2.0.0/project/build/template/)。
...
| 减少维护负担 | 1. 多个服务构建相似，配置一份构建脚本，减少维护成本<br> 2. 规范并统一服务构建物料的管理方式，减少维护和管理负担| 1. [共享构建脚本](/Zadig%20v2.0.0/project/build/#Zadig-共享构建)<br> 2. [使用构建模板](/Zadig%20v2.0.0/project/build/template/) |
:::
