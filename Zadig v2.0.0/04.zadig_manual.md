...
permalink: /Zadig v2.0.0/product-manual/usage/
---
...
为了解决这些问题，Zadig 应运而生。它通过平台工程和技术升级提升组织效能，建立全流程一体化工程协同基线，释放团队生产力。Zadig 旨在帮助企业更高效地进行软件交付，解决流程挑战，提升组织效能。

## 与开源 Zadig 有什么不同

Zadig 是一款开源 CI/CD 产品，Zadig 则是一款面向企业级场景的云原生 DevOps 价值链平台。在能力上，Zadig 提供的是代码到可靠部署物的最佳路径，而 Zadig 在此基础上额外提供了可靠部署物到稳定运行时的最安全路径。

![产品使用手册](../_images/diff_zadig_zadigx.png)

在功能层面上，Zadig 包含开源 Zadig 的一切，额外支持发布管理能力，编排组织、流程、内外部系统，管理代码、配置、数据变更流程，支持灰度组合策略。用一个简单的公式可以表示为：

<strong>`Zadig = Zadig ➕ 发布上线管理 ➕ 集成企业现有的工具（项目管理、配置管理、代码管理、商用系统、自建系统、OpenAPI...)`</strong>
...
IDE 热部署，本地编写完代码热部署到远端环境，具体参考：[VSCode 插件使用指南](/Zadig%20v2.0.0/zadig-toolkit/overview/)。
...
- [Zadig 发布策略](/Zadig%20v2.0.0/project/release-workflow/)
- [Zadig 工作流审批](/Zadig%20v2.0.0/project/workflow-approval/)
...
- [客户交付](/Zadig%20v2.0.0/plutus/overview/)
