...
| Gitee 公有云 | [Gitee 代码源集成](/Zadig%20v2.0.0/settings/codehost/gitee/)| 采用 OAuth2 的方式进行授权认证 |
| Gitee 私有部署  | [Gitee 代码源集成](/Zadig%20v2.0.0/settings/codehost/gitee-enterprise/)| 采用 OAuth2 的方式进行授权认证 |
...
> 如何实现和 Jira Issue 的联动可参考文档：[在 Zadig 中追踪 Jira Issue](/Zadig%20v2.0.0/settings/jira/#在-zadigx-中追踪-issue)。
