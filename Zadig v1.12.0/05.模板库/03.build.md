...
permalink: /Zadig v1.12.0/template/build/
---
...
使用构建模板创建构建时，按照顺序完成对应代码库的配置即可，参考[使用构建模板](/Zadig%20v1.12.0/project/build/#zadig-构建模板)。
:::

## 使用构建模板

参考[使用构建模板](/Zadig%20v1.12.0/project/build/#zadig-构建模板)。
