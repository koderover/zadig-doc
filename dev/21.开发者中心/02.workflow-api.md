    ...
    "inputs": [
        {
            ...
            "parameters": {
                "registry": "https://koderover.tencentcloudcr.com/test",
                "service_list": [
                    {
                        "service_module": "service2",
                        "service_name": "service2",
                        "repo_info": [{
                            "codehost_name": "kr-test-gitlab",
                ...
                "target_list": [
                    {
                        ...
                        "image_name": "koderover.tencentcloudcr.com/test/service2:20220929170402-7-0505"
                    }
                ]
            }
        }
...
|`inputs`   |[]input| 触发工作流执行的具体参数    |无    |must |
