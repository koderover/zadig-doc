...
Zadig 发布工作流支持蓝绿发布、金丝雀发布、分批次灰度发布、更新 K8s YAML 等任务，下面展开介绍相关概念和具体使用。
...
![配置工作流](../_images/release_workflow_blue_green_1.png)
![配置工作流](../_images/release_workflow_blue_green_2.png)
...
![配置工作流](../_images/release_workflow_blue_green_3.png)
![配置工作流](../_images/release_workflow_blue_green_4.png)

4. 添加蓝绿发布任务。点击「+ 任务」，选择「蓝绿发布」任务并配置。

![配置工作流](../_images/release_workflow_blue_green_5.png)
![配置工作流](../_images/release_workflow_blue_green_6.png)
...
![执行工作流](../_images/release_workflow_blue_green_7.png)
![执行工作流](../_images/release_workflow_blue_green_8.png)
...
![执行工作流](../_images/release_workflow_blue_green_10.png)
![执行工作流](../_images/release_workflow_blue_green_11.png)
...
![配置工作流](../_images/release_workflow_canary_1.png)
![配置工作流](../_images/release_workflow_canary_2.png)
...
![配置工作流](../_images/release_workflow_canary_3.png)
![配置工作流](../_images/release_workflow_canary_4.png)
...
![配置工作流](../_images/release_workflow_canary_6.png)
![配置工作流](../_images/release_workflow_canary_7.png)
...
![执行工作流](../_images/release_workflow_canary_8.png)
![执行工作流](../_images/release_workflow_canary_9.png)

- 工作流完成部署金丝雀和验证任务，等待人工审核。此时环境中已部署 1 个金丝雀实例，如下图所示。

![执行工作流](../_images/release_workflow_canary_10.png)
![执行工作流](../_images/release_workflow_canary_11.png)

- 人工审核通过并完成金丝雀发布。此时环境已更新为金丝雀版本，如下图所示。

![执行工作流](../_images/release_workflow_canary_12.png)
![执行工作流](../_images/release_workflow_canary_13.png)
...
![配置工作流](../_images/release_workflow_gray_1.png)
![配置工作流](../_images/release_workflow_gray_2.png)
...
![执行工作流](../_images/release_workflow_gray_4.png)
![执行工作流](../_images/release_workflow_gray_5.png)
...
![配置工作流](../_images/release_workflow_gray_rollback_1.png)
![配置工作流](../_images/release_workflow_gray_rollback_2.png)
...
![执行工作流](../_images/release_workflow_gray_rollback_3.png)
![执行工作流](../_images/release_workflow_gray_rollback_4.png)
...
![配置工作流](../_images/release_workflow_patch_yaml_1.png)
![配置工作流](../_images/release_workflow_patch_yaml_2.png)
...
![执行工作流](../_images/release_workflow_patch_yaml_3.png)
![执行工作流](../_images/release_workflow_patch_yaml_4.png)
