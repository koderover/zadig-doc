...
permalink: /dev/project/service/k8s/prod/
---
...
可参考[核心概念](/dev/quick-start/concepts/#服务组件)了解更多信息，此处相关字段说明如下：
...
参考 [服务编排](/dev/project/service/k8s/#服务编排)。
...
参考 [变量配置](/dev/project/service/k8s/#系统内置变量)。
