...
### 代码信息
> 需事先在 Zadig 中集成代码源，参考文档：[代码源集成](/dev/settings/codehost/gitlab/)。
...
使用 `SonarQube` 工具进行代码扫描时配置的相关参数，可参考 [SonarQube 文档](https://docs.sonarqube.org/latest/analysis/analysis-parameters/)按需设置。
