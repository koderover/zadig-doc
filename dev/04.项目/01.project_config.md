...
陈述各个权限项和功能的对应关系，各功能模块中完整的功能文档分别参见：[工作流](/dev/project/workflow/)/[环境](/dev/project/env/k8s)/[服务](/dev/project/service/k8s/)/[构建](/dev/project/build/)/[测试](/dev/project/test/)/[版本管理](/dev/project/version/)/[代码扫描](/dev/project/scan/)。
...
创建后，Helm Chart 项目中环境的全局变量可以使用变量组，详情参考[更新全局变量](/dev/project/env/helm/chart/#更新全局变量)
