...
![版本交付](./_images/version_createDelivery_04.png '版本交付')
![版本交付](./_images/version_createDelivery_05.png '版本交付')

点击`版本发布`，可将版本中包含的镜像更新所选环境中。
...
- 进入项目->环境，点击创建环境，创建方式选择`回溯`，选择某一个版本，点击确定使用这个版本创建环境，如下图所示：
