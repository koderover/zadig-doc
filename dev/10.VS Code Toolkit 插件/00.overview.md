...
## 准备工作
- 系统准备：安装 Zadig（ [v1.4.0](/dev/release-notes/v1.4.0/#版本升级方式) ~ [v1.6.0](/dev/release-notes/v1.6.0/#版本升级方式) 均可）
...
::: warning
如果 Zadig 是[基于 Helm 命令安装](/dev/install/helm-deploy/)，需配置 [`kubernetes.server` 参数](/dev/install/helm-deploy/#其他参数)，以下功能才可正常使用。
:::
