...
```json
{
    "workflow_name": "sdd-helm-4-workflow-dev",
    "env_name": "dev",
    "targets": [
        {
            "name": "gss-1",
    ...
    "test_reports": [
        {
            ...
            "function_test_report": {
                ...
                "skips": 0,
                "errors": 0,
                "detail_url": "/v1/projects/detail/sdd-helm-4/pipelines/multi/testcase/sdd-helm-4-workflow-dev/51/test/sdd-helm-4-workflow-dev-51-test?is_workflow=1&service_name=test&test_type=function"
            }
        }
   ],
    "status": "timeout"
...
|`images`|[][Image](#image)|分发镜像信息|
|`test_reports`|[][TestReport](#test_reports)|工作流执行完成回调信息
