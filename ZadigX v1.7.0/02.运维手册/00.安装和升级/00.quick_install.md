...
permalink: /ZadigX v1.7.0/stable/quick-install/
---
...
安装后，通过[官网自助](https://koderover.com/getLicense)获取试用许可证，试用过程如需获得帮助可加群。
...
### 第二步：备份数据以及安装参数
- 参考文档：[备份数据](/ZadigX%20v1.7.0/stable/backup-and-restore/#数据备份)进行数据备份。
