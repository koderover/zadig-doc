...
permalink: /v1.15.0/project/service/helm/chart/
---
...
### 从 Chart 仓库同步服务
::: tip 前提
需要先集成 Helm Chart 仓库，参考：[集成 Helm Chart 仓库](/v1.15.0/settings/helm/)。
:::
...
### 使用模板新建单个服务
::: tip 前提
需要先在系统模板库里创建 Helm Chart 模板，请参考 [Helm Chart 模板管理](/v1.15.0/template/helm_chart/)
:::
...
## 策略配置
在策略中设置部署服务的超时时间以及交付物命名规则。细节可阅读：[策略配置](/v1.15.0/project/service/k8s/#策略配置)。
