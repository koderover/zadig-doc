...
permalink: /v1.15.0/project/overview/
---
...
可参照以下项目向导快速搭建项目：
* [K8s YAML 项目](/v1.15.0/project/k8s-yaml/)
* [K8s Helm Chart 项目](/v1.15.0/project/helm-chart/)
* [K8s 托管项目](/v1.15.0/project/host-k8s-resources/)
* [主机项目](/v1.15.0/project/vm/)
