...
permalink: /Zadig v3.4/settings/configsystem/nacos/
---
...
在自定义工作流中编排 Nacos 配置变更任务即可实现 Nacos 配置自动变更，参考文档：[Nacos 配置变更](/Zadig%20v3.4/project/workflow-jobs/#nacos-配置变更)。
