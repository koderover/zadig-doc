...
permalink: /Zadig v2.3.0/install/all-in-one-sealos/
---
...
sealos run --env IP=${IP} --env PORT=${PORT} labring/zadig:2.3.0
```
...
::: tip
专业版许可证获取和配置参考文档：[许可证](/Zadig%20v2.3.0/enterprise-mgr/#许可证)
:::
