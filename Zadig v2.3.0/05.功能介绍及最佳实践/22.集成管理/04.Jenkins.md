...
permalink: /Zadig v2.3.0/settings/jenkins/
---
...
为服务配置构建时使用 Jenkins 构建即可，具体可参考文档：[Jenkins 构建](/Zadig%20v2.3.0/project/build/#jenkins-构建)。

### 执行多个 Jenkins Job

在工作流中编排执行 Jenkins Job 任务即可，具体可参考文档：[执行 Jenkins Job](/Zadig%20v2.3.0/project/workflow-jobs/#ci-cd)。
