...
permalink: /Zadig v2.3.0/project/overview/
---
...
- [K8s YAML 项目](/Zadig%20v2.3.0/project/k8s-yaml/)
- [K8s Helm Chart 项目](/Zadig%20v2.3.0/project/helm-chart/)
- [K8s 托管项目](/Zadig%20v2.3.0/project/host-k8s-resources/)
- [主机项目](/Zadig%20v2.3.0/project/vm/)
...
- `访问权限`：可选`公开`或`私有`，定义该项目的默认权限。
    - 公开项目：用户默认享有 `read-only` 角色中的权限，可查看项目中的资源。该角色的细节请阅[权限配置](/Zadig%20v2.3.0/project/permission/#权限配置)。
...
具体集成参数配置可参考文档 [代码源集成](/Zadig%20v2.3.0/settings/codehost/overview/)。

### 主机
> 适用于主机类型的项目。

具体集成参数配置可参考文档 [主机集成](/Zadig%20v2.3.0/settings/vm-management/#添加主机)。
