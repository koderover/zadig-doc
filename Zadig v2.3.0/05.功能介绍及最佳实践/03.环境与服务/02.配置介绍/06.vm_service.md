...
permalink: /Zadig v2.3.0/project/service/vm/
---
...
具体详细参考[构建配置](/Zadig%20v2.3.0/project/build/)。
...
安全登录到目标机器上执行部署操作。需要提前在系统中配置好主机资源，可参考[主机管理](/Zadig%20v2.3.0/settings/vm-management/)。
...
点击`策略`，设置部署服务的超时时间以及交付物命名规则，细节可阅读：[策略配置](/Zadig%20v2.3.0/project/service/k8s/#策略配置)。
