...
permalink: /ZadigX v1.4.0/settings/codehost/gitee-enterprise/
---

<Badge text="企业版" />

本文主要介绍在 ZadigX 上如何集成 Gitee 企业版代码源。 

::: tip
Gitee 企业版代码源在 ZadigX 中的使用范围说明如下：
...
点击 `同意授权` 后，跳转到 ZadigX 系统，至此 Gitee 企业版集成完毕。
