...
permalink: /ZadigX v1.4.0/settings/app/
---
...
- [项目-选择项目 -> 构建 -> 新增构建配置](/ZadigX%20v1.4.0/project/build/)
- [测试管理 -> 新建测试配置](/ZadigX%20v1.4.0/project/test/#测试配置)
- [项目-选择项目 -> 代码扫描 -> 新建代码扫描配置](/ZadigX%20v1.4.0/project/scan/)
