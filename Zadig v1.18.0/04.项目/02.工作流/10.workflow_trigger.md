...
产品工作流中支持 Git 触发器和定时器，具体使用可参考文档：[产品工作流触发器操作](/Zadig%20v1.18.0/project/workflow/#git-webhook)、[产品工作流定时器操作](/Zadig%20v1.18.0/project/workflow/#定时器)。
...
- 其他参数：请参考 [Git 触发器基本配置](/Zadig%20v1.18.0/project/workflow/#自动创建)中的描述
...
- 其他参数：参考[定时器配置](/Zadig%20v1.18.0/project/workflow/#定时器)
