...
### 服务变量变更
为使 K8s YAML 服务变量功能更易用，v1.18.0 版本中下线了服务变量可见性功能。如果你有使用此功能，并且服务配置中有使用嵌套变量，在升级前请将多个变量的可见性保持一致。服务变量可见性设置可参考文档：[变量设置](/Zadig%20v1.17.0/project/service/k8s/#自定义变量)。
