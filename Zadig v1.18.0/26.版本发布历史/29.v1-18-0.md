...
1. 需要正确配置服务变量的可见性，环境中使用的变量需要显示声明出来，变量可见性配置可参考文档：[变量设置](/Zadig%20v1.17.0/project/service/k8s/#自定义变量)。
...
::: warning
内置软件包原始下载地址中的资源将会与 2023.09.15 删除，如果有使用需要，请参考文档 [软件包管理](/Zadig%20v1.18.0/settings/app/) 进行配置。
:::
