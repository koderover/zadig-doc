...
permalink: /ZadigX dev/quick-start/a-basic-project/
---
...
- 安装 ZadigX，参考[安装文档](/ZadigX%20dev/stable/install)
- 集成 GitHub 代码源并 fork [案例源码](https://github.com/koderover/zadig/tree/main)，代码源集成参考文档：[GitHub 集成](/ZadigX%20dev/settings/codehost/github/)
- 集成镜像仓库，参考文档：[`镜像仓库集成`](/ZadigX%20dev/settings/image-registry/)

::: tip
如果你使用的不是 GitHub 代码源，也可以将代码下载，上传到自己的代码源后再在 ZadigX 中集成，参考文档：[代码源集成](/ZadigX%20dev/settings/codehost/overview/)。
:::

## 第 1 步：项目配置

访问 ZadigX 系统，点击产品交付 -> 项目 -> 新建项目按钮，创建项目，选择 K8s YAML 项目，具体内容如下图所示：
...
> 钉钉和企业微信的配置请参考文档：[通知配置](/ZadigX%20dev/project/workflow/#im-状态通知)。
