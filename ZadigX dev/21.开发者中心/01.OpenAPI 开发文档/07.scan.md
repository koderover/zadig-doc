...
| 参数名     | 类型   | 描述         | 必填 |
| ---------- | ------ | ------------ | ---- |
| `scanName` | string | 扫描对象名称 | 是   |

**Body 参数说明**

| 参数名       | 说明           | 类型              | 必填 |
| ------------ | -------------- | ----------------- | ---- |
| `scan_repos` | 代码源相关数据 | [][Repo](#repo-1) | 是   |
...
| `source`     | 仓库来源：github、gitlab、gerrit、codehub、gitee、gitee-enterprise、other | string | 是   |
| `prs`        | pr号列表                                                     | []int  | 否   |
...
| `source`     | 仓库来源：github、gitlab、gerrit、codehub、gitee、gitee-enterprise、other | string |
...
```json
{
    ...
    "end_time": 1689898944,
    "result_link": "http://124.221.18.196:9000",
    "repo_info": [
        {
            "repo_owner": "kr-test-org1",
            "source": "gitlab",
