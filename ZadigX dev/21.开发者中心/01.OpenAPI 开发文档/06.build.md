...
```
GET /openapi/build?projectName=<projectName>&pageNum=<pageNum>&pageSize=<pageSize>
```
...
| `pageSize`    | int    | 分页参数-当前页展示条数 | 否       | 20     |
...
```
GET /openapi/build/:buildName/detail?projectName=<projectName>
```
...
```
DELETE /openapi/build?name=<build_name>&projectName=<project_name>
```
