...
- [飞书审批](/ZadigX%20dev/project/common-workflow/#人工审批)
- [飞书通知](/ZadigX%20v1.4.0/project/workflow/#飞书)

### 通过飞书项目自动触发工作流

支持在自定义工作流中配置飞书项目触发器，实现飞书项目状态变更后自动触发 ZadigX 工作流，如何使用可参考文档：[飞书触发器](/ZadigX%20dev/project/common-workflow/#飞书触发器)。
