...
permalink: /Zadig dev/project/helm-chart/
---
...
创建服务并为服务配置构建。创建服务可参考文档：[新建 K8s Helm Chart 服务](/Zadig%20dev/project/service/helm/chart/#新建服务)。
...
点击`添加构建`为服务组件配置构建，参考文档：[构建配置](/Zadig%20dev/project/build/)。
