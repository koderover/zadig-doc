...
permalink: /Zadig dev/project/host-k8s-resources/
---
...
2. 配置多集群请参考 [集群管理](/Zadig%20dev/pages/cluster_manage/)。
:::

![配置托管项目](../_images/env_delegate_onboarding_1.png)

### 配置服务构建
系统会自动解析服务组件，点击`添加构建`，为服务组件添加构建配置，可参考文档：[构建配置](/Zadig%20dev/project/build/)。
...
## 托管项目切换 K8s YAML 项目 <Badge text="企业版" />
