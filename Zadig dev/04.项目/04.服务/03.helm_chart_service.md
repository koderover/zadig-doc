...
- `从代码库同步`：从代码库中同步服务的 Helm Chart 配置，支持的代码源请参考文档：[代码源信息](/Zadig%20dev/settings/codehost/overview/#功能兼容列表)。
...
2. 支持的代码源清参考文档：[代码源信息](/Zadig%20dev/settings/codehost/overview/#功能兼容列表)
:::
...
参考文档：[服务组件](/Zadig%20dev/project/service/module/#k8s-helm-chart-项目)。
