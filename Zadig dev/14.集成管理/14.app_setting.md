...
permalink: /Zadig dev/settings/app/
---
...
- [项目-选择项目 -> 构建 -> 新增构建配置](/Zadig%20dev/project/build/)
- [测试管理 -> 新建测试配置](/Zadig%20dev/project/test/#测试配置)
- [项目-选择项目 -> 代码扫描 -> 新建代码扫描配置](/Zadig%20dev/project/scan/)
