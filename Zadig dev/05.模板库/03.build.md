...
permalink: /Zadig dev/template/build/
---
...
点击 `+` 按钮，填写模板名称，参考[构建配置](/Zadig%20dev/project/build/)完成构建模板的配置。
...
使用构建模板创建构建时，按照顺序完成对应代码库的配置即可，参考[使用构建模板](/Zadig%20dev/project/build/#zadig-构建模板)。
:::


## 使用模板

参考[使用构建模板](/Zadig%20dev/project/build/#zadig-构建模板)。
