...
1. 参考 [代码源集成](/v1.14.0/settings/codehost/gitlab/)，将上述代码库在 Zadig 中集成。
2. 参考 [镜像仓库集成](/v1.14.0/settings/image-registry/)，将构建镜像对应的镜像仓库在 Zadig 中集成。
...
配置完毕后，在自定义工作流中添加任务，选择任务后保存工作流即可，更多进阶功能可参考 [自定义工作流](/v1.14.0/project/common-workflow/)。
