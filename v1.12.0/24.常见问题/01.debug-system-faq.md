...
permalink: /v1.12.0/faq/debug-system/
---
...
1. 通过 [All in one](/v1.12.0/install/all-in-one/) 或者 [Kubernetes 脚本](/v1.12.0/install/install-on-k8s/)安装时，可以显式配置 ENCRYPTION_KEY 环境变量，或记录脚本自动生成的 ENCRYPTION_KEY，如下图所示：
