...
permalink: /v1.8.0/release-notes/v1.4.0/
---
...
2. 如果当前系统版本 < v1.3.0，请先升级到 v1.3.0，具体升级过程参见 [v.1.3.0 升级方式](/v1.8.0/release-notes/v1.3.0/)，再按照以下方式升级到 v1.4.0
:::
...
2. 如果使用[`基于 Helm 命令安装`](/v1.8.0/install/helm-deploy/) 安装，执行以下步骤升级 v1.4.0：
