...
permalink: /v1.8.0/release-notes/v1.7.0/
---
...
2. <font color=#FF000 >**不支持跨版本升级**</font>，如果当前 Zadig 系统版本 < v1.6.0，请先参考 [v1.6.0 升级方式](/v1.8.0/release-notes/v1.6.0/#版本升级方式) 升级到 v1.6.0，再按照以下方式升级到 v1.7.0。
...
# 配置必要的参数，具体参考[基于现有 Kubernetes 安装](/v1.8.0/install/install-on-k8s/)
./install.sh
```
