...
permalink: /Zadig v3.2/release-notes/v3.2.1/
---

2024 年 1 月 10 日，Zadig 正式发布 v3.2.1 版本。
...
如果当前系统版本 < v3.2.0，请先升级到 v3.2.0，具体升级过程参见 [v3.2 升级方式](/Zadig%20v3.1/release-notes/v3.2.0/#版本升级过程)，注意其中版本号需要改为 `3.2.0`，再按照以下方式升级到 v3.2.1
:::
