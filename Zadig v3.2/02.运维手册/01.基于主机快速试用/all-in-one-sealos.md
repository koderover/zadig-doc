...
permalink: /Zadig v3.2/install/all-in-one-sealos/
---
...
sealos run --env IP=${IP} --env PORT=${PORT} labring/zadig:3.2.0
```
...
::: tip
专业版许可证获取和配置参考文档：[许可证](/Zadig%20v3.2/enterprise-mgr/#许可证)
:::
