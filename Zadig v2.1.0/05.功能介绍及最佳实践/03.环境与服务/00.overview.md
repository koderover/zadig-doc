...
- [构建配置](/Zadig%20v2.1.0/project/build/#zadig-构建)
- [产品工作流构建部署配置](/Zadig%20v2.1.0/project/workflow/#构建部署)
- [自定义工作流部署任务配置](/Zadig%20v2.1.0/project/workflow-jobs/#部署任务)

2. 在环境中直接修改服务组件镜像来对其进行更新，参考文档：[服务实例操作](/Zadig%20v2.1.0/project/env/service/#服务实例操作)。
3. 通过修改服务配置文件中的镜像信息，并在环境中更新服务来实现服务组件的更新，参考文档：[更新服务](/Zadig%20v2.1.0/project/env/k8s/#更新服务)。
