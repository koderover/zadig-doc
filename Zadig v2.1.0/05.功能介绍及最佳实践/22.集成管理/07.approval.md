...
permalink: /Zadig v2.1.0/settings/approval/
---
...
参考文档：[飞书审批](/Zadig%20v2.1.0/project/workflow-approval/#飞书审批)

### 在 Zadig 中使用钉钉审批

参考文档：[钉钉审批](/Zadig%20v2.1.0/project/workflow-approval/#钉钉审批)
