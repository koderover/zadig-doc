...
permalink: /v1.10.0/template/k8s_yaml/
---
...
可以在 K8s YAML 模板中使用系统内置变量和自定义标量。
...
## 使用模板
在 [K8s YAML 项目](/v1.10.0/project/k8s-yaml/)中创建服务时可选择从模板导入服务，参考[使用模板新建服务](/v1.10.0/project/service/#新建服务)。
