...
| Gitee 公有云 | [Gitee 代码源集成](/Zadig%20v1.17.0/settings/codehost/gitee/)| 采用 OAuth2 的方式进行授权认证 |
| Gitee 私有部署 <Badge text="企业版" /> | [Gitee 代码源集成](/Zadig%20v1.17.0/settings/codehost/gitee-enterprise/)| 采用 OAuth2 的方式进行授权认证 |
...
> 如何实现和 Jira Issue 的联动可参考文档：[在 Zadig 中追踪 Jira Issue](/Zadig%20v1.17.0/settings/jira/#代码与任务-issue-进行关联)。
...
> 如何实现基于 PR 的独立测试环境可参考文档：[Pull Request 独立测试环境](/Zadig%20v1.17.0/workflow/trigger/#进阶使用场景-pull-request-独立测试环境)。
