...
- 安装 Zadig，参考 [快速安装](/Zadig%20v1.17.0/quick-start/try-out-install)
...
::: warning
请提前配置好代码源和镜像仓库集成，具体配置请参照[`代码源集成`](/Zadig%20v1.17.0/settings/codehost/overview/) 和 [`镜像仓库集成`](/Zadig%20v1.17.0/settings/image-registry/)。
:::
