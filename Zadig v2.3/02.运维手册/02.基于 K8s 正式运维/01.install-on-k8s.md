...
permalink: /Zadig v2.3/install/install-on-k8s/
---
...
|场景 |下载源 | 说明 |
|---|---|---|
|快速体验|官方下载源：[https://download.koderover.com/install?type=quickstart](https://download.koderover.com/install?type=quickstart) <br> GitHub 源：[https://github.com/koderover/zadig/releases/download/v2.3.1/install_quickstart.sh](https://github.com/koderover/zadig/releases/download/v2.3.1/install_quickstart.sh) | 不提供持久化存储能力，不推荐生产使用 |
|生产使用|官方下载源：[https://download.koderover.com/install?type=standard](https://download.koderover.com/install?type=standard) <br> GitHub 源：[https://github.com/koderover/zadig/releases/download/v2.3.1/install.sh](https://github.com/koderover/zadig/releases/download/v2.3.1/install.sh) | 提供持久化存储能力 |

根据实际情况下载安装脚本并添加可执行权限，使用 GitHub 源下载示例如下：

```bash
# 快速体验：
curl -LO https://github.com/koderover/zadig/releases/download/v2.3.1/install_quickstart.sh
chmod +x ./install_quickstart.sh

# 生产使用：
curl -LO https://github.com/koderover/zadig/releases/download/v2.3.1/install.sh
chmod +x ./install.sh
```
...
::: tip
许可证获取和配置参考文档：[许可证](/Zadig%20v2.3/enterprise-mgr/#许可证)
:::
## 升级

使用 Helm 命令进行升级，升级过程参考[文档](/Zadig%20v2.3/install/helm-deploy/#升级)。
...
curl -SsL https://github.com/koderover/zadig/releases/download/v2.3.1/uninstall.sh |bash
```
