...
permalink: /Zadig v2.3/api/workflow/
---
...
参考[创建自定义工作流参数](/Zadig%20v2.3/api/workflow/#创建自定义工作流)
...
| `workflow_type` | 工作流类型 `custom` | string |
...
|`workflow_type`|工作流类型 `custom`|string|是|
...
| `workflow_type` | 工作流类型 `custom`| string | 是   | 无     |
