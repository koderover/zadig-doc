...
permalink: /v1.7.0/faq/debug-system
---
...
## 安装 v1.7.0 及以上版本，zadig-init Pod 状态为 Error
...
## 安装 v1.7.0 及以上版本，报错 Error: failed to install CRD crds/enterprise.gloo.solo.io_v1_AuthConfig.yaml: ...
...
v1.7.0 及以上版本的 Zadig 系统对 Kubernetes 集群版本有要求。遇到此种错误请检查您的 Kubernetes 集群版本，需要集群版本在 1.16 及以上，才能正常安装使用。