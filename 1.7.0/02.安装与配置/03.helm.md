...
```bash
helm upgrade --install zadig --namespace <NAMESPACE> koderover-chart/zadig --set endpoint.FQDN=<your domain>
# v1.7.0+ 版本需加上以下参数，且确保 <NAMESPACE> 和安装 Zadig 系统的 Namespace 一致
#   --set global.extensions.extAuth.extauthzServerRef.namespace=<NAMESPACE>
#   --set dex.config.issuer=http://<your domain>/dex
#   --set dex.fullnameOverride=zadig-<NAMESPACE>-dex
