...
permalink: /Zadig v3.3/api/workflow/
---
...
参考[创建工作流参数](/Zadig%20v3.3/api/workflow/#创建工作流)
...
```
GET /openapi/logs/sse/v4/workflow/<工作流标识>/<工作流任务 ID>/<jobTask名称>/<tails行数>
```
...
```
GET /openapi/logs/log/v4/workflow/{工作流标识}/tasks/{工作流任务 ID}/jobs/<jobTask名称>
```
