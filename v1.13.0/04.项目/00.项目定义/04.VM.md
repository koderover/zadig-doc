...
> 可参阅 [主机服务](/v1.13.0/project/service/#主机服务)，完成相关配置项。
...
为服务选择将部署的主机资源，并配置部署方式，填写部署脚本。更详细的信息可参考[主机服务配置](/v1.13.0/project/service/#主机服务)的`资源配置`和`部署配置`模块。
...
### 探活配置
为 `backend` 服务设置探活检测。
> 关于探活更详细的信息可参考[主机服务配置](/v1.13.0/project/service/#主机服务)中的`探活配置`部分。
