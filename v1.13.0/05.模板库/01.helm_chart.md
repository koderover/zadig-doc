...
permalink: /v1.13.0/template/helm_chart/
---
...
::: tip 前提
支持从 GitHub/GitLab/Gerrit/Gitee 代码仓库导入创建 Helm Chart 模板，关于代码仓库的集成可参考：[代码仓库集成](/v1.13.0/settings/codehost/github/)
:::
...
> 对服务开启`自动同步`操作参考[使用模板新建服务](/v1.13.0/project/service/helm/chart/#使用模板新建单个服务)。
...
## 使用模板
在 [K8s Helm Chart 项目](/v1.13.0/project/helm-chart/)中创建服务时可选择从模板导入服务，参考[使用模板新建服务](/v1.13.0/project/service/helm/chart/#使用模板新建单个服务)。
