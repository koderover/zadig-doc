...
permalink: /cn/ZadigX v1.8.0/faq/debug-system/
---
...
恢复托管集群，在 Zadig 系统中重新连接挂接集群，参考文档：[集群管理](/ZadigX%20v1.8.0/pages/cluster_manage/)。
...
> 集群管理参考文档：[集群管理](/ZadigX%20v1.8.0/pages/cluster_manage/)。
