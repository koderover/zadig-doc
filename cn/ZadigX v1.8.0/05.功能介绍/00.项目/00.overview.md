...
permalink: /cn/ZadigX v1.8.0/project/overview/
---
...
具体集成参数配置可参考文档 [代码源集成](/ZadigX%20v1.8.0/settings/codehost/overview/)。

### 主机
> 适用于主机类型的项目。

具体集成参数配置可参考文档 [主机集成](/ZadigX%20v1.8.0/settings/vm-management/#添加主机)。
