...
permalink: /cn/ZadigX v1.8.0/settings/codehost/overview/
---
...
| Gitee 公有云 | [Gitee 代码源集成](/ZadigX%20v1.8.0/settings/codehost/gitee/)| 采用 OAuth2 的方式进行授权认证 |
| Gitee 私有部署  | [Gitee 代码源集成](/ZadigX%20v1.8.0/settings/codehost/gitee-enterprise/)| 采用 OAuth2 的方式进行授权认证 |
