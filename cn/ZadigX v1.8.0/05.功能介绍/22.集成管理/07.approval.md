...
permalink: /cn/ZadigX v1.8.0/settings/approval/
---
...
参考文档：[飞书审批](/ZadigX%20v1.8.0/project/workflow-approval/#飞书审批)

### 在 ZadigX 中使用钉钉审批

参考文档：[钉钉审批](/ZadigX%20v1.8.0/project/workflow-approval/#钉钉审批)
