...
permalink: /cn/ZadigX v1.8.0/test/apipost/
---
...
参考文档：[通知配置](/ZadigX%20v1.8.0/project/test/#通知配置)。
...
配置自定义工作流，编排构建、部署（开发环境）、测试任务，参考文档：[自定义工作流](/ZadigX%20v1.8.0/project/common-workflow/)。
