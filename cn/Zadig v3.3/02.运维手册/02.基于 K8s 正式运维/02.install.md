...
permalink: /cn/Zadig v3.3/stable/install/
---
...
- 请务必做好数据备份，参考文档：[备份数据](/cn/Zadig%20v3.3/stable/backup-and-restore/#数据备份)。
- 请备份好当前的安装参数。
...
将目标版本的备份数据恢复，参考文档：[数据导入](/cn/Zadig%20v3.3/stable/backup-and-restore/#数据导入)。
