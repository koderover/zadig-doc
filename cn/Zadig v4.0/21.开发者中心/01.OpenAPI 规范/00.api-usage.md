...
|              | 更新服务                     | 测试环境：[PUT /openapi/environments/service/yaml](/cn/Zadig%20v4.0/api/env/#测试环境-8)<br>生产环境：[PUT /openapi/environments/production/service/yaml](/cn/Zadig%20v4.0/api/env/#生产环境-8)                                                        |
...
|              | 查看环境 Helm 服务 Values    | 测试环境：[GET /openapi/environments/service/values](/cn/Zadig%20v4.0/api/env/#查看环境-helm-服务-values)<br>生产环境：[GET /openapi/environments/production/service/values](/cn/Zadig%20v4.0/api/env/#查看环境-helm-服务-values-2)                  |
...
|              | 设置入口服务                 | [POST /openapi/environments/:name/share/portal/:serviceName](/cn/Zadig%20v4.0/api/env/#设置入口服务)                                                                                                                                                   |
...
| 更新发布计划以及发布内容 | [PATCH /openapi/release_plan/v1/:id](/cn/Zadig%20v4.0/api/release-plan/#更新发布计划以及发布内容) |
...
<!-- | 获取交付物追踪信息 | [GET /api/directory/dc/artifact](/cn/Zadig%20v4.0/api/delivery-center/#获取交付物追踪信息) | -->
