...
permalink: /cn/Zadig v4.0/project/overview/
---
...
- [K8s YAML 项目](/cn/Zadig%20v4.0/project/k8s-yaml/)
- [K8s Helm Chart 项目](/cn/Zadig%20v4.0/project/helm-chart/)
- [K8s 托管项目](/cn/Zadig%20v4.0/project/host-k8s-resources/)
- [自由项目](/cn/Zadig%20v4.0/project/vm/)
...
- `访问权限`：可选`公开`或`私有`，定义该项目的默认权限。
    - 公开项目：用户默认享有 `read-only` 角色中的权限，可查看项目中的资源。该角色的细节请阅[权限配置](/cn/Zadig%20v4.0/project/permission/#权限配置)。
...
具体集成参数配置参考 [代码源集成](/cn/Zadig%20v4.0/settings/codehost/overview/)。

### 主机
> 适用于自由项目。

具体集成参数配置参考 [主机集成](/cn/Zadig%20v4.0/settings/vm-management/#添加主机)。
