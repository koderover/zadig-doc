...
permalink: /cn/Zadig v4.0/template/helm_chart/
---
...
::: tip 提示
支持的代码仓库参考：[代码源信息](/cn/Zadig%20v4.0/settings/codehost/overview/#功能兼容列表)，关于代码仓库的集成参考：[代码仓库集成](/cn/Zadig%20v4.0/settings/codehost/overview/)
:::
...
> 对服务开启`自动同步`操作参考[使用模板新建服务](/cn/Zadig%20v4.0/project/service/helm/chart/#使用模板新建单个服务)。

![应用到服务](../../../../_images/apply_helm_template_to_service.png)

## 使用模板
在 [K8s Helm Chart 项目](/cn/Zadig%20v4.0/project/helm-chart/)中新建服务时可选择从模板导入服务，参考[使用模板新建服务](/cn/Zadig%20v4.0/project/service/helm/chart/#使用模板新建单个服务)。
