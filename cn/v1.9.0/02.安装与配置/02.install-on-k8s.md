...
permalink: /cn/v1.9.0/install/install-on-k8s/
---
...
|场景 |下载地址 | 说明 |
|---|---|---|
|快速体验|[https://github.com/koderover/zadig/releases/download/v1.9.0/install_quickstart.sh](https://github.com/koderover/zadig/releases/download/v1.9.0/install_quickstart.sh) | 不提供持久化存储能力，不推荐生产使用 |
|生产使用|[https://github.com/koderover/zadig/releases/download/v1.9.0/install.sh](https://github.com/koderover/zadig/releases/download/v1.9.0/install.sh) | 提供持久化存储能力 |
