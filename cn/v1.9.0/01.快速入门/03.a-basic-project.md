...
permalink: /cn/v1.9.0/quick-start/a-basic-project/
---
...
- 安装 Zadig，参考 [快速安装](/v1.9.0/quick-start/try-out-install)
...
::: tip
代码源集成请参考 [GitHub 集成](/v1.9.0/settings/codehost/github/)
:::
...
::: warning
请提前配置好代码源和镜像仓库集成，如安装时未配置，具体配置请参照[`系统设置->集成管理->代码源集成`](/v1.9.0/settings/codehost/gitlab/) 以及 [`系统设置->镜像仓库`](/v1.9.0/settings/image-registry/)
:::
