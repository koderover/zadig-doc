...
permalink: /cn/v1.9.0/project/vm/
---
...
## 服务配置
> 可参阅 [主机服务](/v1.9.0/project/service/#主机服务)，完成相关配置项。
...
> 更细节的信息可参考[构建配置](/v1.9.0/project/build/)。
...
> 更详细的信息可参考[主机服务配置](/v1.9.0/project/service/#新增服务-3)的`资源配置`和`部署配置`模块。
...
### 探活配置
为 `backend` 服务设置探活检测。
> 关于探活更详细的信息可参考[主机服务配置](/v1.9.0/project/service/#新增服务-3)中的`探活配置`部分。
