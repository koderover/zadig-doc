...
permalink: /cn/Zadig v2.1.0/test/apipost/
---
...
参考文档：[通知配置](/cn/Zadig%20v2.1.0/project/test/#通知配置)。
...
配置自定义工作流，编排构建、部署（开发环境）、测试任务，参考文档：[自定义工作流](/cn/Zadig%20v2.1.0/project/common-workflow/)。
