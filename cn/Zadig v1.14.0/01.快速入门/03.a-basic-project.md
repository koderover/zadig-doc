...
permalink: /cn/Zadig v1.14.0/quick-start/a-basic-project/
---
...
- 安装 Zadig，参考 [快速安装](/cn/Zadig%20v1.14.0/quick-start/try-out-install)
...
::: tip
代码源集成请参考 [GitHub 集成](/cn/Zadig%20v1.14.0/settings/codehost/github/)
:::
...
::: warning
请提前配置好代码源和镜像仓库集成，具体配置请参照[`代码源集成`](/cn/Zadig%20v1.14.0/settings/codehost/gitlab/) 和 [`镜像仓库集成`](/cn/Zadig%20v1.14.0/settings/image-registry/)。
:::
