...
permalink: /cn/ZadigX v1.6.0/tool-chain/
---
...
**配置参考**
- [创建项目](/ZadigX%20v1.6.0/api/project/)
- [创建服务](/ZadigX%20v1.6.0/api/service/#创建服务)
- [效能洞察](/ZadigX%20v1.6.0/api/insight/#数据概览)
...
**配置参考**
- [Jira 问题状态变更](/ZadigX%20v1.6.0/project/workflow-jobs/#jira-问题状态变更)
- [飞书工作项状态变更](/ZadigX%20v1.6.0/project/workflow-jobs/#飞书工作项状态变更)
...
**配置参考**
- [Apollo 配置变更](/ZadigX%20v1.6.0/project/workflow-jobs/#apollo-配置变更)
- [Nacos 配置变更](/ZadigX%20v1.6.0/project/workflow-jobs/#nacos-配置变更)
...
[安全服务接入](/ZadigX%20v1.6.0/security-manual/)
...
[测试能力接入](/ZadigX%20v1.6.0/test-manual/)
...
**配置参考**
- [OpenAPI](/ZadigX%20v1.6.0/api/usage)
- [自定义工作流任务](/ZadigX%20v1.6.0/settings/custom-task/)
