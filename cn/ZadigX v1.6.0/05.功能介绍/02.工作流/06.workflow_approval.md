...
permalink: /cn/ZadigX v1.6.0/project/workflow-approval/
---
...
::: tip
在开启飞书审批之前，需要先在系统中集成飞书审批应用，具体可参考文档：[集成飞书审批](/ZadigX%20v1.6.0/settings/approval/#飞书)。
:::
...
1. 配置手机号可参考文档：[账号信息](/ZadigX%20v1.6.0/preferences/#账号设置)。
...
::: tip
在开启钉钉审批之前，需要先在系统中集成钉钉审批应用，具体可参考文档：[集成钉钉审批](/ZadigX%20v1.6.0/settings/approval/#钉钉)。
:::
