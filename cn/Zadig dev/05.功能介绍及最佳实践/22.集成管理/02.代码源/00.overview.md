...
permalink: /cn/dev/settings/codehost/overview/
---
...
| Gitee 公有云 | [Gitee 代码源集成](/dev/settings/codehost/gitee/)| 采用 OAuth2 的方式进行授权认证 |
| Gitee 私有部署  | [Gitee 代码源集成](/dev/settings/codehost/gitee-enterprise/)| 采用 OAuth2 的方式进行授权认证 |
