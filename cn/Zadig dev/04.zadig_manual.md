...
permalink: /cn/dev/product-manual/usage/
---
...
IDE 热部署，本地编写完代码热部署到远端环境，具体参考：[VSCode 插件使用指南](/dev/zadig-toolkit/overview/)。
...
- [Zadig 发布策略](/dev/project/release-workflow/)
- [Zadig 工作流审批](/dev/workflow/approval/)
