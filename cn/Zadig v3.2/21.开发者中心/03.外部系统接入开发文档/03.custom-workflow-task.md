...
permalink: /cn/Zadig v3.2/settings/custom-task/
---
...
> 支持的代码源请参考文档：[代码源信息](/cn/Zadig%20v3.2/settings/codehost/overview/)。
...
1. 参考 [代码源集成](/cn/Zadig%20v3.2/settings/codehost/overview/)，将上述代码库在 Zadig 中集成。
2. 参考 [镜像仓库集成](/cn/Zadig%20v3.2/settings/image-registry/)，将构建镜像对应的镜像仓库在 Zadig 中集成。
...
配置完毕后，在工作流中添加任务，选择任务后保存工作流即可，更多进阶功能可参考 [工作流](/cn/Zadig%20v3.2/project/common-workflow/)。
