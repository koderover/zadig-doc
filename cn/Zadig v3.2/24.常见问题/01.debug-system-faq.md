...
permalink: /cn/Zadig v3.2/faq/debug-system/
---
...
恢复托管集群，在 Zadig 系统中重新连接挂接集群，参考文档：[集群管理](/cn/Zadig%20v3.2/pages/cluster_manage/)。
...
> 集群管理参考文档：[集群管理](/cn/Zadig%20v3.2/pages/cluster_manage/)。
