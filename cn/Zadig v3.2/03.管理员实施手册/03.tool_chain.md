...
permalink: /cn/Zadig v3.2/tool-chain/
---
...
**配置参考**
- [创建项目](/cn/Zadig%20v3.2/api/project/)
- [新建服务](/cn/Zadig%20v3.2/api/service/#新建服务)
- [效能洞察](/cn/Zadig%20v3.2/api/insight/#数据概览)
...
**配置参考**
- [Jira 问题状态变更](/cn/Zadig%20v3.2/project/workflow-jobs/#jira-问题状态变更)
- [飞书工作项状态变更](/cn/Zadig%20v3.2/project/workflow-jobs/#飞书工作项状态变更)
...
**配置参考**
- [Apollo 配置变更](/cn/Zadig%20v3.2/project/workflow-jobs/#apollo-配置变更)
- [Nacos 配置变更](/cn/Zadig%20v3.2/project/workflow-jobs/#nacos-配置变更)
...
[安全服务接入](/cn/Zadig%20v3.2/security-manual/)
...
[测试能力接入](/cn/Zadig%20v3.2/test-manual/)
...
**配置参考**
- [OpenAPI](/cn/Zadig%20v3.2/api/usage)
- [工作流自定义任务](/cn/Zadig%20v3.2/settings/custom-task/)
