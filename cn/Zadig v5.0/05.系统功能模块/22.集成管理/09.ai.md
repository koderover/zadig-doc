...
![新增 AI 模型](./_images/ai/ai_model_add.png)
...
![华为云 ModelArts Studio](./_images/ai/ai_huawei_1.png)

2. 在 Zadig 上，访问`系统设置` -> `系统集成` -> `AI 模型`，添加华为云 ModelArts Studio AI 模型。

![华为云 ModelArts Studio](./_images/ai/ai_huawei.png)
...
![火山方舟](./_images/ai/ai_volcano_1.png)

2. 在 Zadig 上，访问`系统设置` -> `系统集成` -> `AI 模型`，添加火山方舟 AI 模型。

![火山方舟](./_images/ai/ai_volcano.png)
...
![阿里云百炼](./_images/ai/ai_bailian_1.png)

2. 在 Zadig 上，访问`系统设置` -> `系统集成` -> `AI 模型`，添加阿里云百炼 AI 模型。

![阿里云百炼](./_images/ai/ai_bailian.png)
