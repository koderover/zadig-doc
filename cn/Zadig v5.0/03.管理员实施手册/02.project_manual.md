...
5. 执行工作流：进入项目 -> 工作流，执行工作流更新指定环境的服务。工作流的更多功能可参考 [工作流](/cn/Zadig%20v5.0/project/common-workflow/)。
...
5. 配置工作流：配置测试和生产环境对应工作流，参考 [工作流](/cn/Zadig%20v5.0/project/common-workflow/)。
...
5. 配置工作流：配置测试环境和生产环境对应工作流，参考 [工作流](/cn/Zadig%20v5.0/project/common-workflow/)。
...
参考 [下线服务](/cn/Zadig%20v5.0/project/workflow-jobs/#下线服务)。
