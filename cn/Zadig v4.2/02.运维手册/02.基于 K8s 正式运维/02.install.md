...
permalink: /cn/Zadig v4.2/stable/install/
---
...
- 务必备份数据，参考：[备份数据](/cn/Zadig%20v4.2/stable/backup-and-restore/#数据备份)
- 备份当前安装参数
...
恢复目标版本备份数据，参考：[数据导入](/cn/Zadig%20v4.2/stable/backup-and-restore/#数据导入)
