...
permalink: /cn/Zadig v4.2/sonar-scan/practice/
---
...
在 Zadig 使用代码扫描需先集成 Sonar Server，具体方式参考[文档](/cn/Zadig%20v4.2/settings/sonar/)。
...
配置说明：
- 扫描环境：基础运行环境
- 依赖的软件包：选择对应版本的 JAVA 和 Maven，软件包的管理参考[文档](/cn/Zadig%20v4.2/settings/app/)
