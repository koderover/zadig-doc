...
permalink: /cn/Zadig v1.15.0/project/k8s-yaml/
---
...
> 更细节的信息可参考 [K8s YAML 服务](/cn/Zadig%20v1.15.0/project/service/k8s/)。
...
> 更细节的信息可参考[构建配置](/cn/Zadig%20v1.15.0/project/build/)。
