...
permalink: /cn/Zadig v1.17.0/project/workflow-jobs/
---
...
点击变量配置可对被触发工作流中的变量进行配置，具体请参考 [触发 Zadig 工作流的变量配置](/cn/Zadig%20v1.17.0/project/common-workflow/#触发-zadig-工作流任务)。
