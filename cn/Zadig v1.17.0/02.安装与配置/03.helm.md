...
permalink: /cn/Zadig v1.17.0/install/helm-deploy/
---
...
::: tip
如果有自己的 S3 对象存储，可以选择不安装 Minio。在 Zadig 安装完后成访问 `系统设置` -> `对象存储` 来配置即可，配置过程详见[对象存储](/cn/Zadig%20v1.17.0/settings/object-storage/)。
:::
