...
permalink: /cn/Zadig v1.12.0/project/helm-chart/
---
...
> 更细节的信息可参考 [Helm Chart 服务](/cn/Zadig%20v1.12.0/project/service/helm/chart/)。
...
>  更细节的信息请参阅 [构建配置](/cn/Zadig%20v1.12.0/project/build/)。
