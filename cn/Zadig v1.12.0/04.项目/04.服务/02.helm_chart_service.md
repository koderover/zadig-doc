...
permalink: /cn/Zadig v1.12.0/project/service/helm/chart/
---
...
### 从 Chart 仓库同步服务
::: tip 前提
需要先集成 Helm Chart 仓库，参考：[集成 Helm Chart 仓库](/cn/Zadig%20v1.12.0/settings/helm/)。
:::
...
### 使用模板新建单个服务
::: tip 前提
需要先在系统模板库里创建 Helm Chart 模板，请参考 [Helm Chart 模板管理](/cn/Zadig%20v1.12.0/template/helm_chart/)
:::
