...
permalink: /cn/v1.10.0/release-notes/v1.10.0/
---
...
2. 如果在 v1.9.0 中开启了构建缓存，需要在 **集群管理** 中，为构建所在的集群显式配置使用 **对象存储** 或 **集群存储**。构建缓存配置请参考：[缓存资源配置](/v1.10.0/pages/cluster_manage/#缓存资源配置)。
