...
permalink: /cn/Zadig v1.16.0/release-notes/v1.13.0/
---
...
## 版本升级过程
::: warning
如果当前系统版本 < v1.12.0，请先升级到 v1.12.0，具体升级过程参见 [v1.12.0 升级方式](/cn/Zadig%20v1.16.0/release-notes/v1.12.0/#版本升级过程)，再按照以下方式升级到 v1.13.0
:::
...
::: warning 升级后注意事项
升级后需要根据 [文档](/cn/Zadig%20v1.16.0/settings/account/custom/) 重新构建部署 dex。
:::
