...
permalink: /cn/Zadig v1.16.0/project/host-k8s-resources/
---
...
> 2. 配置多集群请参考[集群管理](/cn/Zadig%20v1.16.0/pages/cluster_manage/)。

![配置托管项目](../_images/env_delegate_onboarding_1.png)

## 配置服务构建
- 系统会自动解析服务组件，可为其`添加构建`，如何配置构建参考[构建](/cn/Zadig%20v1.16.0/project/build/)。
