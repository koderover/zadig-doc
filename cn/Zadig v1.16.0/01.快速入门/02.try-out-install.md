...
permalink: /cn/Zadig v1.16.0/quick-start/try-out-install/
---
::: warning
目前支持三种模式来快速安装 Zadig，详细配置或正式使用安装请参考[安装与配置](/cn/Zadig%20v1.16.0/install/overview/)
:::
...
详细安装过程参考[基于 Helm 命令安装](/cn/Zadig%20v1.16.0/install/helm-deploy/)
