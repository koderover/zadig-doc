...
permalink: /cn/Zadig v2.2.0/stable/install/
---
...
1. Kubernetes 集群，版本：v1.16 ~ v1.29，节点建议：2 台 8C16G，且对该集群有管理员操作权限
...
- 请务必做好数据备份，参考文档：[备份数据](/cn/Zadig%20v2.2.0/stable/backup-and-restore/#数据备份)。
- 请备份好当前的安装参数。
...
将目标版本的备份数据恢复，参考文档：[数据导入](/cn/Zadig%20v2.2.0/stable/backup-and-restore/#数据导入)。
