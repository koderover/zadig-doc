...
permalink: /cn/Zadig v4.1/release-notes/v1.18.0/
---

Zadig v1.18.0 版本于 2023 年 8 月 11 日发布。
...
> 服务变量的可见性配置可参考 [变量设置](/cn/Zadig%20v1.17.0/project/service/k8s/#自定义变量)。
...
::: warning
内置软件包原始下载地址中的资源将会于 2023.10.31 删除，如果有使用需要，请参考 [软件包管理](/cn/Zadig%20v2.2.0/settings/app/) 进行配置。
:::
