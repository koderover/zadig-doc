...
permalink: /cn/Zadig v4.1/project/workflow-trigger/
---
...
- 其他参数：参考 [Git 触发器基本配置](/cn/Zadig%20v4.1/project/common-workflow/#git-触发器)中的描述
...
3. 参考 [Git 触发器基本配置](/cn/Zadig%20v4.1/project/common-workflow/#git-触发器)，填写 Zadig 中的相关配置后保存即可。
...
- 其他参数：参考 [定时器配置](/cn/Zadig%20v4.1/project/common-workflow/#定时器)
...
通过调用 OpenAPI 来触发工作流，具体操作参考 [执行工作流](/cn/Zadig%20v4.1/api/workflow/#执行工作流)。