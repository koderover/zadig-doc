...
permalink: /cn/Zadig v4.1/project/service/helm/chart/
---
...
- `从代码库同步`：从代码库中同步服务的 Helm Chart 配置，支持的代码源参考 [代码源信息](/cn/Zadig%20v4.1/settings/codehost/overview/#功能兼容列表)。
...
::: tip
1. 需要在系统中集成代码源，参考 [代码源集成](/cn/Zadig%20v4.1/settings/codehost/overview/)
2. 支持的代码源参考 [代码源信息](/cn/Zadig%20v4.1/settings/codehost/overview/#功能兼容列表)
:::
...
### 从 Chart 仓库同步服务
::: tip 前提
需要先集成 Helm Chart 仓库，参考 [集成 Helm Chart 仓库](/cn/Zadig%20v4.1/settings/helm/)。
:::
...
### 使用模板新建单个服务
::: tip 前提
需要先在系统模板库里新建 Helm Chart 模板，参考 [Helm Chart 模板管理](/cn/Zadig%20v4.1/template/helm_chart/)
:::
...
参考 [服务版本回滚](/cn/Zadig%20v4.1/project/service/versions/)。

## 服务组件

参考 [服务组件](/cn/Zadig%20v4.1/env/overview/#什么是服务组件#k8s-helm-chart-项目)。
...
- `交付物命名规则`：细节参考 [策略配置](/cn/Zadig%20v4.1/project/service/k8s/#策略配置)。
