...
permalink: /cn/Zadig v4.1/project/service/vm/
---
...
具体详细参考 [构建配置](/cn/Zadig%20v4.1/project/build/)。
...
安全登录到目标机器上执行部署操作。需要提前在系统中配置好主机资源，参考 [主机管理](/cn/Zadig%20v4.1/settings/vm-management/)。
...
点击`策略`，设置部署服务的超时时间以及交付物命名规则，细节参考 [策略配置](/cn/Zadig%20v4.1/project/service/k8s/#策略配置)。
