...
permalink: /cn/ZadigX v1.5.0/project/version/
---
...
> Helm 仓库需事先集成，具体配置参考 [Helm 仓库](/ZadigX%20v1.5.0/settings/helm/)。<br>在配置镜像 Tag 时，若一个 Chart 中包括多个[服务组件](/ZadigX%20v1.5.0/project/service/module/)，可使用`应用全部`来快速设置所有服务组件的镜像 Tag。
