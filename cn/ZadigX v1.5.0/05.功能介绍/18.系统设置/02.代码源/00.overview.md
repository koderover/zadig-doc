...
permalink: /cn/ZadigX v1.5.0/settings/codehost/overview/
---
...
| Gitee 公有云 | [Gitee 代码源集成](/ZadigX%20v1.5.0/settings/codehost/gitee/)| 采用 OAuth2 的方式进行授权认证 |
| Gitee 私有部署  | [Gitee 代码源集成](/ZadigX%20v1.5.0/settings/codehost/gitee-enterprise/)| 采用 OAuth2 的方式进行授权认证 |
...
> 如何实现基于 PR 的独立测试环境可参考文档：[Pull Request 独立测试环境](/ZadigX%20v1.5.0/workflow/trigger/#进阶使用场景-pull-request-独立测试环境)。
