...
- `回调类型`: 需要和飞书应用配置一致。**如果 Zadig 部署在内网环境，选择`长连接`**。
- `APP ID`：在 步骤 1 中获取
...
参考文档：[飞书审批](/cn/Zadig%20v3.4/workflow/approval/#飞书审批)

### 在 Zadig 中使用钉钉审批

参考文档：[钉钉审批](/cn/Zadig%20v3.4/workflow/approval/#钉钉审批)


### 在 Zadig 中使用企业微信审批

参考文档：[钉钉审批](/cn/Zadig%20v3.4/workflow/approval/#企业微信审批)
