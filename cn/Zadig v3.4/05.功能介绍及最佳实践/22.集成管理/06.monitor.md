...
permalink: /cn/Zadig v3.4/settings/monitor/
---
...
在自定义工作流中配置 `Grafana 服务监测任务`即可使用 Grafana 监测服务是否健康，参考：[Grafana 监测](/cn/Zadig%20v3.4/project/workflow-jobs/#grafana-监测)。
