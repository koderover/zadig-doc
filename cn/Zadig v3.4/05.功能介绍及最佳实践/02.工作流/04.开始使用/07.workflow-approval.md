...
::: tip
在开启飞书审批之前，需要先在系统中集成飞书审批应用，具体参考 [集成飞书审批](/cn/Zadig%20v3.4/settings/approval/#飞书)。
:::
...
1. 配置手机号参考 [账号信息](/cn/Zadig%20v3.4/preferences/#账号设置)。
...
::: tip
在开启钉钉审批之前，需要先在系统中集成钉钉审批应用，具体参考 [集成钉钉审批](/cn/Zadig%20v3.4/settings/approval/#钉钉)。
:::
...
::: tip
在开启企业微信审批之前，需要先在系统中集成企业微信审批应用，具体参考 [集成企业微信审批](/cn/Zadig%20v3.4/settings/approval/#企业微信)。
:::
