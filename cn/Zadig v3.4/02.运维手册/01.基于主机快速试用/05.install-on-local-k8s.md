...
sealos run labring/kubernetes:v1.24.0 labring/helm:v3.22.0 labring/calico:v3.24.1 labring/openebs:v3.4.1
sealos run --env IP=${IP} --env PORT=${PORT} labring/zadig:3.4.1
```
