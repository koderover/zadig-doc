...
permalink: /cn/Zadig v5.0/faq/debug-system/
---
...
使用了错误的入口导致的。 访问 Zadig 系统的统一流量入口在 gateway-proxy 服务上，只需要将流量打入 gateway-proxy 服务中即可， **不要**将流量直接打入 zadig-portal 服务中。
...
恢复托管集群，在 Zadig 系统中重新连接挂接集群，参考 [集群管理](/cn/Zadig%20v5.0/pages/cluster_manage/)。
...
> 集群管理参考 [集群管理](/cn/Zadig%20v5.0/pages/cluster_manage/)。
