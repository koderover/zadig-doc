...
![img](./_images/openclaw-plugin/openclaw_plugin_6.png)

2. 研发自测与联调。执行工作流，查看服务状态与服务日志。

![img](./_images/openclaw-plugin/openclaw_plugin_7.png)

3. 构建日志分析及优化。分析工作流构建日志。

![img](./_images/openclaw-plugin/openclaw_plugin_8.png)

4. 批量清理无用的构建。批量删除未被引用的构建。

![img](./_images/openclaw-plugin/openclaw_plugin_9.png)
