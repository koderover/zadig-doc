...
permalink: /cn/Zadig v4.3/api/release-plan/
---
...
| `parameters`   | [][Parameter](/cn/Zadig%20v4.3/api/workflow/#parameter) | 全局变量，具体字段可参考创建自定义工作流一节                 |
| `inputs`       | [][Input](/cn/Zadig%20v4.3/api/workflow/#input_arg)     | 工作流任务 Job 输入参数 ，具体字段可参考创建自定义工作流一节 |
| `remark`       | string                                                  | 备注                                                         |
