...
![安装 CLI 与 Skill](./_images/zadig-cli/zadig_cli_install-2.png)
...
![查看 CLI 版本](./_images/zadig-cli/zadig_cli_version-2.png)
...
![检查连接状态](./_images/zadig-cli/zadig_cli_auth_status-2.png)
...
![检查本地安装和网络状态](./_images/zadig-cli/zadig_cli_doctor-2.png)
...
![检查 Agent Skill](./_images/zadig-cli/zadig_cli_doctor_agent-2.png)
...
![复制项目](./_images/zadig-cli/zadig_cli_copy_project-2.png)

### 运维日常-清理工作流

批量清理无用工作流

![批量清理工作流](./_images/zadig-cli/zadig_cli_cleanup_workflow-2.png)

### 研发交付-更新服务

使用工作流更新服务。

![使用工作流更新服务](./_images/zadig-cli/zadig_cli_update_service-2.png)

### 研发排障-查看服务日志

查看并分析服务日志。

![查看服务日志](./_images/zadig-cli/zadig_cli_service_log-2.png)

### 效能分析-查看构建日志

查看工作流构建日志，定位效能瓶颈。

![分析构建日志](./_images/zadig-cli/zadig_cli_build_log-2.png)
