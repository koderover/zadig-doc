...
permalink: /cn/Zadig v4.1/stable/alter-rules/
---

## 告警规则

本节介绍了[监控告警配置](/cn/Zadig%20v4.1/stable/monitoring-alter-config/#告警规则配置)中配置的告警项，具体告警规则详见[监控告警配置](/cn/Zadig%20v4.1/stable/monitoring-alter-config/#告警规则配置)，这里只介绍规则描述和处理方法。
