...
permalink: /cn/Zadig v5.0/install/install-on-local-k8s/
---
...
```
![本地安装](./_images/install-on-local-k8s/install_zadig_on_local_1.png)
...
![本地安装](./_images/install-on-local-k8s/install_zadig_on_init.png)

::: tip
专业版许可证获取与配置详见：[许可证](/cn/Zadig%20v5.0/enterprise-mgr/#许可证)
:::
