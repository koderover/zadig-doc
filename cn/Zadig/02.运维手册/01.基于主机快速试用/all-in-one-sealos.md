...
permalink: /cn/Zadig v5.0/install/all-in-one-sealos/
---
...
::: tip 提示
若您已经安装 Sealos，可跳过此步骤，请确认使用 v5.0.0 或更高版本。
:::
...
![预期安装结果](./_images/all-in-one-sealos/sealos_install_success.png)
...
![预期安装结果](./_images/all-in-one-sealos/get_endpoint.png)

在安装结果输出中，你可以获得系统的访问地址。

::: tip
专业版许可证获取和配置参考 [许可证](/cn/Zadig%20v5.0/enterprise-mgr/#许可证)
:::
