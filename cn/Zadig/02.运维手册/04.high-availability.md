...
permalink: /cn/Zadig v4.2/stable/high-availability/
---
...
- 配置应用多副本，根据业务用量和资源占用情况调整组件副本数：
  ...
  **dind：** 参考[Dind 资源配置](/cn/Zadig%20v4.2/pages/cluster_manage/#dind-资源配置)
...
参考 [部署运维 FAQs](/cn/Zadig%20v4.2/faq/debug-system/)。
