...
permalink: /cn/Zadig v3.3/stable/high-availability/
---
...
- 配置应用多副本，根据业务用量和资源占用情况调整组件副本数。各组件副本调整方式如下：
  ...
  ```
  - **dind：** 参考[Dind 资源配置](/cn/Zadig%20v3.3/pages/cluster_manage/#dind-资源配置)
...
参考文档：[部署运维 FAQs](/cn/Zadig%20v3.3/faq/debug-system/)。
