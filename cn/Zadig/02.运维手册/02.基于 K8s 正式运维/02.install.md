...
permalink: /cn/Zadig v5.0/stable/install/
---
...
1. Kubernetes 集群，版本 v1.16+，建议 2 台 8C16G，需管理员权限
...
![配置授权凭证](./_images/install/install_customer_1.png)
![配置授权凭证](./_images/install/install_customer_2.png)

### [推荐] 官方安装支持

开启「供应商维护配置」后，Zadig 官方可远程协助安装。

![配置授权凭证](./_images/install/install_customer_211_3.png)
...
![安装](./_images/install/install_1.png)
...
![安装](./_images/install/install_2.png)
...
![本地安装](./_images/install/install_zadig_on_init.png)
...
- 务必备份数据，参考：[备份数据](/cn/Zadig%20v5.0/stable/backup-and-restore/#数据备份)
- 备份当前安装参数
![备份](./_images/install/upgrade_1.png)
...
恢复目标版本备份数据，参考：[数据导入](/cn/Zadig%20v5.0/stable/backup-and-restore/#数据导入)

### 步骤 2：执行回滚

客户控制台 > `版本`，选择目标版本后点击`部署`。

![安装](./_images/install/rollback.png)
