...
permalink: /cn/Zadig v5.0/stable/zadig-to-zadigx/
---
...
3. Zadig 的版本不能低于 v1.18.0，如果版本不能满足，请参考[升级文档](/cn/Zadig%20v5.0/release-notes/v1.18.0/)先将其升级。
...
![安装](./_images/zadig_to_zadigx/install_3.png)
