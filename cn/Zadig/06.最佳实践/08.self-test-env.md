...
permalink: /cn/Zadig v5.0/env/self-test-env/
---
...
![自测模式架构](./_images/self-test-env/self_test_env_overview.png)
...
![开启自测模式](./_images/self-test-env/set_self_test_env.png)
...
![创建子环境](./_images/self-test-env/create_vice_env.png)
![创建子环境](./_images/self-test-env/create_vice_env_1.png)
![创建子环境](./_images/self-test-env/create_vice_env_2.png)
...
![自测联调效果](./_images/self-test-env/self_test_env_effect_1.png)

2. **增加 `x-env: dev-test-env1` 请求头**：访问服务 a，子环境中的服务 a 会接收到请求并给出响应，对于请求链路上的 b/c 服务，`dev` 环境中的服务会给出正常响应。

![自测联调效果](./_images/self-test-env/self_test_env_effect_2.png)
