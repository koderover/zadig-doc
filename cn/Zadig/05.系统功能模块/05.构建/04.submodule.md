...
permalink: /cn/Zadig v5.0/project/build/submodule
---
...
![开启子模块](./_images/submodule/enable_submodule.png)
...
将上一步骤中准备的私钥文件拷贝至镜像运行时`~/.SSH`路径下，构建并推送自定义构建镜像，具体方式参考[自定义镜像管理](/cn/Zadig%20v5.0/settings/custom-image/)。
