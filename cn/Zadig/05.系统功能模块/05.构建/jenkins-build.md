...
permalink: /cn/Zadig v5.0/project/build/jenkins/
---
...
### 前提
1. 需要先在 Zadig 系统中集成 Jenkins 服务器，详见[Jenkins 集成](/cn/Zadig%20v5.0/settings/jenkins)
...
![jenkins build](./_images/jenkins-build/jenkins_image_parameter.png)
![jenkins build](./_images/jenkins-build/jenkins_image_build.png)

### 如何配置
![jenkins build](./_images/jenkins-build/jenkins_build.png)
...
![jenkins build](./_images/jenkins-build/show_choice_values_in_jenkins.png)

### 使用效果

![jenkins build](./_images/jenkins-build/jenkins_build_result.png)
