...
permalink: /cn/Zadig v5.0/test/practice/
...
Zadig 系统有内置的 JMeter 应用可直接使用，如果内置版本无法满足自动化测试诉求，参考[软件包管理](/cn/Zadig%20v5.0/settings/app/)按需新增。本例以 JMeter 5.4.3 版本示例如下。

系统管理员登录 Zadig → 访问系统设置 → 集成管理 → 软件包管理，添加 JMeter：

![jMeter 实践](./_images/test_practice/jmeter_test_demo_0.png)
...
![jMeter 实践](./_images/test_practice/jmeter_test_demo_1_300.png)
![jMeter 实践](./_images/test_practice/jmeter_test_demo_2_300.png)
...
![jMeter 实践](./_images/test_practice/run_jmeter_test_220.png)

### 分析测试报告

暂不支持在平台直接浏览测试报告，待自动化测试运行完毕后，点击`下载`将测试报告下载到本地。

![jMeter 实践](./_images/test_practice/jmeter_test_demo_3_300.png)

解读下载的测试报告，查看本次压力测试的结果，分析性能瓶颈。

![jMeter 实践](./_images/test_practice/jmeter_test_demo_5.png)
![jMeter 实践](./_images/test_practice/jmeter_test_demo_4.png)
...
Zadig 系统有内置的 Ginkgo 应用及 Go 应用可直接使用，如果内置版本无法满足自动化测试诉求，参考[软件包管理](/cn/Zadig%20v5.0/settings/app/)按需新增。本例依赖 Go 1.16 以及 Ginkgo 2.0.0，配置示例如下。

系统管理员登录 Zadig → 访问系统设置 → 集成管理 → 软件包管理，分别添加 Go 和 Ginkgo：

![ginkgo 实践](./_images/test_practice/ginkgo_test_demo_0_330.png)
![ginkgo 实践](./_images/test_practice/ginkgo_test_demo_0_1_330.png)
...
![ginkgo 实践](./_images/test_practice/ginkgo_test_demo_1_330.png)
...
![ginkgo 实践](./_images/test_practice/run_ginkgo_test_300.png)

### 分析测试报告

待自动化测试运行完毕后点击查看测试报告，可查看每一条用例的执行详情，快速过滤失败的用例重点分析。

![ginkgo 实践](./_images/test_practice/ginkgo_test_demo_3_300.png)
![ginkgo 实践](./_images/test_practice/ginkgo_test_demo_4_300.png)
...
### 配置 Python 自定义镜像
执行 Pytest 环境中需事先安装 Python，在 Zadig 中配置自定义镜像，参考[自定义镜像管理](/cn/Zadig%20v5.0/settings/custom-image/)。
...
![pytest 实践](./_images/test_practice/pytest_demo_0.png)

### 配置自动化测试

![pytest 实践](./_images/test_practice/pytest_demo_1_300.png)
![pytest 实践](./_images/test_practice/pytest_demo_2_300.png)
...
![pytest 实践](./_images/test_practice/pytest_demo_3_300.png)

### 分析测试报告

待自动化测试运行完毕后点击查看测试报告，可查看每一条用例的执行详情，快速过滤失败的用例重点分析。

![pytest 实践](./_images/test_practice/pytest_demo_4_300.png)
![pytest 实践](./_images/test_practice/pytest_demo_5_300.png)
