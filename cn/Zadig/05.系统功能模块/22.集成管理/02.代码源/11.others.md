...
permalink: /cn/Zadig v5.0/settings/codehost/others/
---
...
![github_ssh_key](./_images/others/github_ssh_key.png)
![github_ssh_key](./_images/others/github_ssh_key_1.png)

### 步骤 2：将配置填入 Zadig 系统

管理员登录 Zadig 系统，依次访问`系统设置` -> `系统集成` -> `代码源` -> 点击添加按钮。

![other_git_config](./_images/others/ssh_key_git_config.png)
...
![other_git_config](./_images/others/gitlab_access_token.png)

2. 复制生成的 Access Token 信息即可。

![other_git_config](./_images/others/gitlab_access_token_2.png)

### 步骤 2：将配置填入 Zadig 系统

管理员登录 Zadig 系统，依次访问`系统设置` -> `集成管理` -> `代码源` -> 点击添加按钮。

![other_git_config](./_images/others/access_token_git_config.png)
