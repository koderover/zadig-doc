...
permalink: /cn/Zadig v5.0/settings/codehost/gitee/
---
...
![gitee](./_images/gitee/gitee_1.png)
![gitee](./_images/gitee/gitee_2.png)

### 步骤 2：配置 Gitee 第三方应用

![gitee](./_images/gitee/gitee_3.png)
...
![gitee](./_images/gitee/gitee_4.png)

### 步骤 4：将配置填入 Zadig 系统

切换到 Zadig 系统，管理员依次点击`系统设置` -> `系统集成` -> `代码源` -> 点击添加按钮。

![gitee](./_images/gitee/gitee_5.png)
...
![gitee](./_images/gitee/gitee_6.png)
