...
permalink: /cn/Zadig v5.0/settings/cloud-service/
---
...
点击 `系统设置` -> `系统集成` -> `云服务` -> `添加阿里云 DMS 数据管理服务`：

![cloud_service](./_images/cloud_service/cloud_service_add.png)
...
![dms_admin_permission](./_images/cloud_service/dms_admin_permission.png)