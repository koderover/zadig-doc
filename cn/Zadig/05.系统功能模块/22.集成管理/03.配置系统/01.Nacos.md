...
permalink: /cn/Zadig v5.0/settings/configsystem/nacos/
---
...
![Nacos配置](./_images/Nacos/nacos_config_01_341.png)
...
在自定义工作流中编排 Nacos 配置变更任务即可实现 Nacos 配置自动变更，参考：[Nacos 配置变更](/cn/Zadig%20v5.0/project/workflow-jobs/#nacos-配置变更)。
