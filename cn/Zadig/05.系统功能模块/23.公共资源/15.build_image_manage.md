...
permalink: /cn/Zadig v5.0/settings/custom-image/
---
...
点击 `系统设置` ->`自定义镜像` -> `添加`，如下图所示：

![添加自定义镜像](./_images/build_image_manage/image_create_420.png)
...
![使用自定义镜像](./_images/build_image_manage/image_build_220.png)
