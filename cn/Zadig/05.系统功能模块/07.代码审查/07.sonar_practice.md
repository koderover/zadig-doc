...
permalink: /cn/Zadig v5.0/sonar-scan/practice/
---
...
在 Zadig 使用代码扫描需先集成 Sonar Server，具体方式参考[文档](/cn/Zadig%20v5.0/settings/sonar/)。

![sonar-practice](./_images/sonar_practice/sonar_practice_1.png)
...
![sonar-practice](./_images/sonar_practice/sonar_practice_2.png)

配置说明：
- 扫描环境：基础运行环境
- 依赖的软件包：选择对应版本的 JAVA 和 Maven，软件包的管理参考[文档](/cn/Zadig%20v5.0/settings/app/)
...
![sonar-practice](./_images/sonar_practice/sonar_practice_3.png)
...
<img src="./_images/sonar_practice/sonar_practice_4.png" width="400" >
<img src="./_images/sonar_practice/sonar_practice_5.png" width="400" >
...
![sonar-practice](./_images/sonar_practice/sonar_practice_6.png)

- **效果展示**：在 GitLab 上提交代码，创建 Merge Request，自动触发代码扫描，并在 MR 上获得扫描结果。

<img src="./_images/sonar_practice/sonar_practice_7_310.png" width="400" >
<img src="./_images/sonar_practice/sonar_practice_8.png" width="400" >
...
<img src="./_images/sonar_practice/sonar_practice_9.png" width="400" >
<img src="./_images/sonar_practice/sonar_practice_10.png" width="400" >
<img src="./_images/sonar_practice/sonar_practice_11.png" width="400" >
...
![sonar-practice](./_images/sonar_practice/sonar_practice_12.png)

- **使用模板**：新建代码扫描 → 选择「使用模板」并选择模板 → 填写代码信息。

![sonar-practice](./_images/sonar_practice/sonar_practice_13.png)