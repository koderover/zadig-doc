...
permalink: /cn/Zadig v5.0/settings/user-management/
---
...
![create_user](./_images/user_manage/create_user.png)
...
![delete_user](./_images/user_manage/delete_user_220.png)
...
![create_user_group](./_images/user_manage/create_user_group_341.png)
...
![delete_user_group](./_images/user_manage/delete_user_group_330.png)
...
![create_system_role](./_images/user_manage/create_system_role_320.png)

### 角色列表

查看系统的所有角色，点击`编辑`可查看该角色包括的权限。其中 `admin` 是内置的系统管理员角色。

![system_role_list](./_images/user_manage/system_role_list.png)

## 项目角色

定义全局项目角色，在项目中可使用全局项目角色。

![global_project_role_list](./_images/user_manage/global_project_role_list.png)
