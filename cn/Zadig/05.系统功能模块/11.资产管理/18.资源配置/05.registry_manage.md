...
permalink: /cn/Zadig v5.0/settings/image-registry/
---
...
![reg](./_images/registry_manage/reg_add_v180.png)
...
![reg](./_images/registry_manage/reg_add_ali.png)
...
![reg](./_images/registry_manage/reg_add_ali_ee.png)
...
![reg](./_images/registry_manage/reg_add_tcr.png)
...
![reg](./_images/registry_manage/reg_add_tcr_ee.png)
...
![reg](./_images/registry_manage/reg_add_swr.png)
...
![reg](./_images/registry_manage/reg_add_aws.png)
...
![reg](./_images/registry_manage/reg_add_ar.png)

参数说明：
- `地址`：镜像仓库地址
- `命名空间`：项目名称/代码库名称
- `用户名`：登录 AR 镜像仓库的账号，一般为：`_json_key_base64`
- `服务账号密钥`：登录 AR 镜像仓库的密钥，需对原始密钥进行 base64 处理，具体参考[官方文档](https://cloud.google.com/artifact-registry/docs/docker/authentication?hl=zh-cn#json-key)

### Harbor

![reg](./_images/registry_manage/reg_add_harbor.png)
...
![reg](./_images/registry_manage/reg_add_dockerhub.png)
...
![jfrog](./_images/registry_manage/reg_add_jfrog.png)
...
![jfrogkey](./_images/registry_manage/jfrog_apikey.png)

### Nexus

<img src="./_images/registry_manage/reg_add_nexus.png" width="400">
<img src="./_images/registry_manage/reg_add_nexus_1.png" width="400">

参数说明：

- `地址`：镜像仓库地址
- `Repository Name`：Nexus 仓库名称
- `Docker 用户名`：登录镜像仓库的 Docker 用户名
- `Docker 密码`：登录镜像仓库的 Docker 密码

### 其他

![reg](./_images/registry_manage/reg_add_other.png)
