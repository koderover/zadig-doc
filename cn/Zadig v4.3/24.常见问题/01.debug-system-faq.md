...
permalink: /cn/Zadig v4.3/faq/debug-system/
---
...
恢复托管集群，在 Zadig 系统中重新连接挂接集群，参考 [集群管理](/cn/Zadig%20v4.3/pages/cluster_manage/)。
...
> 集群管理参考 [集群管理](/cn/Zadig%20v4.3/pages/cluster_manage/)。
