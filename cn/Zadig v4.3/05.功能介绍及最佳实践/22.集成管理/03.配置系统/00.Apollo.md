...
permalink: /cn/Zadig v4.3/settings/configsystem/apollo/
---
...
在工作流中编排 Apollo 配置变更任务即可实现 Apollo 配置自动变更，参考：[Apollo 配置变更](/cn/Zadig%20v4.3/project/workflow-jobs/#apollo-配置变更)。
