...
permalink: /cn/Zadig v3.1/workflow/approval/
---
...
::: tip
在开启飞书审批之前，需要先在系统中集成飞书审批应用，具体可参考文档：[集成飞书审批](/cn/Zadig%20v3.1/settings/approval/#飞书)。
:::
...
![common_workflow_config](./_images/config_lark_approval_1_310.png)
...
1. 配置手机号可参考文档：[账号信息](/cn/Zadig%20v3.1/preferences/#账号设置)。
...
::: tip
在开启钉钉审批之前，需要先在系统中集成钉钉审批应用，具体可参考文档：[集成钉钉审批](/cn/Zadig%20v3.1/settings/approval/#钉钉)。
:::
...
![common_workflow_config](./_images/workflow_dingtalk_approval_config_310.png)
...
::: tip
在开启企业微信审批之前，需要先在系统中集成企业微信审批应用，具体可参考文档：[集成企业微信审批](/cn/Zadig%20v3.1/settings/approval/#企业微信)。
:::
