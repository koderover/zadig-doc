...
permalink: /cn/Zadig v1.18.0/project/overview/
---
...
快速搭建参考：
- [K8s YAML 项目](/cn/Zadig%20v1.18.0/project/k8s-yaml/)
- [K8s Helm Chart 项目](/cn/Zadig%20v1.18.0/project/helm-chart/)
- [K8s 托管项目](/cn/Zadig%20v1.18.0/project/host-k8s-resources/)
- [主机项目](/cn/Zadig%20v1.18.0/project/vm/)
...
- `访问权限`：可选`公开`或`私有`，定义该项目的默认权限。
    - 公开项目：用户默认享有 `read-only` 角色中的权限，可查看项目中的资源。该角色的细节请阅[权限配置](/cn/Zadig%20v1.18.0/project/permission/#权限配置)。
