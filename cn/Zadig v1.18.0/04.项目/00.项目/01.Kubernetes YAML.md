...
permalink: /cn/Zadig v1.18.0/project/k8s-yaml/
---
...
### 服务配置
创建服务并为服务配置构建。创建服务可参考文档：[新建 K8s YAML 服务](/cn/Zadig%20v1.18.0/project/service/k8s/#新建服务)。
...
点击`添加构建`，为服务组件添加构建配置，可参考文档：[构建配置](/cn/Zadig%20v1.18.0/project/build/)。
