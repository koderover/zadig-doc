...
permalink: /cn/Zadig v3.0/test/apipost/
---
...
参考文档：[通知配置](/cn/Zadig%20v3.0/project/test/#通知配置)。
...
配置工作流，编排构建、部署（开发环境）、测试任务，参考文档：[工作流](/cn/Zadig%20v3.0/project/common-workflow/)。
