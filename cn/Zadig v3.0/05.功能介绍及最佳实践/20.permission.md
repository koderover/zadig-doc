...
permalink: /cn/Zadig v3.0/project/permission/
---
...
- 角色是一系列权限的集合，在[角色管理](/cn/Zadig%20v3.0/project/permission/#角色管理)中可查看角色中的权限细节
...
陈述各个权限项和功能的对应关系，各功能模块中完整的功能文档分别参见：[工作流](/cn/Zadig%20v3.0/project/common-workflow/)/[环境](/cn/Zadig%20v3.0/project/env/k8s)/[服务](/cn/Zadig%20v3.0/project/service/k8s/)/[构建](/cn/Zadig%20v3.0/project/build/)/[测试](/cn/Zadig%20v3.0/project/test/)/[版本管理](/cn/Zadig%20v3.0/project/version/)/[代码扫描](/cn/Zadig%20v3.0/project/scan/)。
...
- 选择参与成员，只有项目成员才可以被选择，若需要添加的用户不在成员列表中，可在[成员管理](/cn/Zadig%20v3.0/project/permission/#成员管理)中添加。
