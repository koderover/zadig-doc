...
permalink: /cn/ZadigX v1.4.0/stable/zadig-to-zadigx/
---
...
1. 升级操作不可逆，Zadig / ZadigX 的数据结构差异较大，降级会造成不可用。如果要试用 ZadigX，建议使用[官方安装小助手](https://koderover.com/installer)来全新安装。
2. Zadig 的版本不能低于 v1.17.0，如果版本不能满足，请参考[升级文档](/cn/Zadig%20v1.17.0/release-notes/v1.17.0/#版本升级过程)先将其升级。
