...
permalink: /cn/ZadigX v1.4.0/stable/backup-and-restore/
---

投入生产使用后，建议定时对 ZadigX 系统的数据做备份，当数据库故障等极端情况发生时，可参考本手册快速恢复。
...
参考文档：[安装 ZadigX](/ZadigX%20v1.4.0/stable/install/)。
