...
permalink: /cn/ZadigX v1.4.0/settings/codehost/gitee/
---

本文主要介绍在 ZadigX 上如何集成 Gitee 代码源。

::: tip
Gitee 代码源在 ZadigX 中的使用范围说明如下：
...
:::tip 注意
应用回调地址中 `koderover.yours.com` 需要替换为 ZadigX 系统部署的实际地址
:::
...
点击 `同意授权` 后，跳转到 ZadigX 系统，至此 Gitee 集成完毕。
