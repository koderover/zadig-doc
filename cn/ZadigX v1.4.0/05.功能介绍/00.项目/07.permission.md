...
permalink: /cn/ZadigX v1.4.0/project/permission/
---
...
![权限管理](../_images/system_role_1.png)
...
![权限配置](../_images/update_project_basic_info_2.png)
...
- 角色：一系列权限的集合，在[角色管理](/ZadigX%20v1.4.0/project/permission/#角色管理)中可查看角色中的权限细节。
- 策略：工作流/环境资源粒度的权限集合，对私有项目适用。在[策略管理](/ZadigX%20v1.4.0/project/permission/#策略管理)中可查看该策略的权资源和限细节。
...
- 选择参与成员，若需要添加的用户不在成员列表中，可在[成员管理](/ZadigX%20v1.4.0/project/permission/#成员管理)中添加，并选择 `read-project-only` 角色。
