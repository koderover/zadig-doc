...
permalink: /cn/ZadigX v1.4.0/release/center
---
...
ZadigX 发布中心集成了所有发布工作流，目前支持蓝绿发布、金丝雀发布、分批次灰度发布、Istio 发布、更新 K8s YAML等任务，相关概念、具体使用方法及操作流程可见[发布工作流](/ZadigX%20v1.4.0/project/release-workflow/)。