...
permalink: /cn/ZadigX v1.4.0/product-manual/usage/
---
...
IDE 热部署，本地编写完代码热部署到远端环境，具体参考：[VSCode 插件使用指南](/ZadigX%20v1.4.0/zadig-toolkit/overview/)。
...
- [ZadigX 发布工作流](/ZadigX%20v1.4.0/project/release-workflow/)
- [ZadigX 工作流审批](/ZadigX%20v1.4.0/project/workflow-approval/)
...
- [客户交付](/ZadigX%20v1.4.0/plutus/overview/)
