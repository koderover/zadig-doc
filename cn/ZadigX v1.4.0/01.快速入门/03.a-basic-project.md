...
permalink: /cn/ZadigX v1.4.0/quick-start/a-basic-project/
---
...
::: tip
如果你使用的不是 GitHub 代码源，也可以将代码下载，上传到自己的代码源后再在 ZadigX 中集成，参考文档：[代码源集成](/ZadigX%20v1.4.0/settings/codehost/overview/)。
:::
