...
permalink: /cn/v1.7.0/install/install-on-k8s/
---
...
```bash
curl -LO https://github.com/koderover/zadig/releases/download/v1.7.0/install.sh
chmod +x ./install.sh
```
...
| MONGO_DB                   | zadig                        | 否               | 数据库名，要求 MongoDB 数据库版本 ≥ 3.4，若不配置，则使用安装脚本中内置的 MongoDB 数据库称                                                                                                                                                 |
| MYSQL_HOST                 | ""                           | 否               | Zadig 用户信息数据存储，要求 MySQL 数据库版本 ≥ 5.7，若不配置，则使用安装脚本中内置的单节点 MySQL                                                                                         |
