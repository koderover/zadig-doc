...
permalink: /cn/ZadigX dev/faq/troubleshooting-guide/
---
...
这个是 ZadigX 系统的 spock-dind 服务挂载的 pvc 的空间不足导致的，可以使用我们系统设置-系统配置-缓存清理功能一键清理这些数据，详见[缓存清理](/ZadigX%20dev/settings/system-settings/)
...
在[工作流里配置触发器](/ZadigX%20dev/project/workflow/#git-webhook)后无需再在 GitLab 系统中手动添加 Webhook 设置。
