...
permalink: /cn/ZadigX dev/settings/app/
---
...
- [构建配置](/ZadigX%20dev/project/build/)
- [测试配置](/ZadigX%20dev/project/test/#测试配置)
- [代码扫描配置](/ZadigX%20dev/project/scan/)
- [通用任务配置](/ZadigX%20dev/project/workflow-jobs/#通用任务)
