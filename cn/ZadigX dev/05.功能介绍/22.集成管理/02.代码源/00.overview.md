...
permalink: /cn/ZadigX dev/settings/codehost/overview/
---
...
| Gitee 公有云 | [Gitee 代码源集成](/ZadigX%20dev/settings/codehost/gitee/)| 采用 OAuth2 的方式进行授权认证 |
| Gitee 私有部署  | [Gitee 代码源集成](/ZadigX%20dev/settings/codehost/gitee-enterprise/)| 采用 OAuth2 的方式进行授权认证 |
...
> 如何实现和 Jira Issue 的联动可参考文档：[在 ZadigX 中追踪 Jira Issue](/ZadigX%20dev/settings/jira/#在-zadigx-中追踪-issue)。
...
> 如何实现基于 PR 的独立测试环境可参考文档：[Pull Request 独立测试环境](/ZadigX%20dev/workflow/trigger/#进阶使用场景-pull-request-独立测试环境)。
