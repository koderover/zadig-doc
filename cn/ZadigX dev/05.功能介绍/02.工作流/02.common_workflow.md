...
permalink: /cn/ZadigX dev/project/common-workflow/
---
...
### 任务
点击阶段下方的 `+任务` 为阶段增加任务配置，系统支持的任务类型及具体配置可参考文档 [工作流任务](/ZadigX%20dev/project/workflow-jobs/)。
...
支持`全局变量/其他任务输出`配置方式的任务可参考文档：[不同任务中支持的配置方式](/ZadigX%20dev/project/workflow-jobs/#不同任务中支持的配置方式)。<br>
...
### 集群资源配置
参考文档：[集群共享存储资源配置](/ZadigX%20dev/pages/cluster_manage/#共享存储资源配置)。
...
> 支持高级配置的任务请参考文档：[高级配置](/ZadigX%20dev/project/workflow-jobs/#高级配置)。
