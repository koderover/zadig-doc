...
permalink: /cn/ZadigX dev/settings/custom-task/
---
...
> 支持的代码源清请参考文档：[代码源信息](/ZadigX%20dev/settings/codehost/overview/)。
...
1. 参考 [代码源集成](/ZadigX%20dev/settings/codehost/overview/)，将上述代码库在 ZadigX 中集成。
2. 参考 [镜像仓库集成](/ZadigX%20dev/settings/image-registry/)，将构建镜像对应的镜像仓库在 ZadigX 中集成。
