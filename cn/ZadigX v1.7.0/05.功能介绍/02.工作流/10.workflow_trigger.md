...
permalink: /cn/ZadigX v1.7.0/project/workflow-trigger/
---
...
产品工作流中支持 Git 触发器和定时器，具体使用可参考文档：[产品工作流触发器操作](/ZadigX%20v1.7.0/project/workflow/#git-webhook)、[产品工作流定时器操作](/ZadigX%20v1.7.0/project/workflow/#定时器)。
...
- 其他参数：请参考 [Git 触发器基本配置](/ZadigX%20v1.7.0/project/workflow/#自动创建)中的描述
...
3. 参考 [Git 触发器基本配置](/ZadigX%20v1.7.0/project/workflow/#自动创建)，填写 Zadig 中的相关配置后保存即可。
...
- 其他参数：参考[定时器配置](/ZadigX%20v1.7.0/project/workflow/#定时器)
