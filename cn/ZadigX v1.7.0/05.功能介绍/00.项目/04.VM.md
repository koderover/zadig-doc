...
permalink: /cn/ZadigX v1.7.0/project/vm/
---
...
> 可参阅 [主机服务](/ZadigX%20v1.7.0/project/service/vm/)，完成相关配置项。
...
主机项目中，项目管理员点击`配置` -> `主机管理`可在项目中对主机资源进行管理，具体配置可参考 [添加主机](/ZadigX%20v1.7.0/settings/vm-management/#添加主机)。
