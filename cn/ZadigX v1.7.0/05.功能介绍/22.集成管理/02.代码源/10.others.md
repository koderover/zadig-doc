...
permalink: /cn/ZadigX v1.7.0/settings/codehost/others/
---
...
### 步骤 2：将配置填入 ZadigX 系统

管理员登录 ZadigX 系统，依次访问`系统设置` -> `系统集成` -> `代码源` -> 点击添加按钮。
...
管理员登录 ZadigX 系统，依次访问`系统设置` -> `集成管理` -> `代码源集成` -> 点击添加按钮。
