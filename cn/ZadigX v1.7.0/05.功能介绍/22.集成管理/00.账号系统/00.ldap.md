...
permalink: /cn/ZadigX v1.7.0/settings/account/ldap/
---
...
::: tip 扩展阅读
- LDAP 配置无误后，登录 ZadigX 即可将对应 LDAP 账号同步到 ZadigX 系统中
- 在 ZadigX 上删除 LDAP 账号会清理其在 ZadigX 系统中的权限，但并不会同步删除 LDAP 系统中的数据
:::
...
- 若安装 ZadigX 系统时未修改，则默认的管理员账号/密码为 `admin`/`Zadig123`。
:::
