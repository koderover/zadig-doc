...
permalink: /cn/v1.6.0/project/workflow/
---
...
- `镜像版本回退` <sup style='color: red'>新</sup>： 若开启，则工作流执行完毕后，被更新服务的镜像会回退到工作流任务执行前的版本。更多信息可阅读：[工作流的镜像版本回退](/v1.6.0/workflow/image/rollback/)。
...
::: warning
如果你的 Zadig 系统版本低于 1.3.0，则需在代码管理平台正确配置 Webhook，代码变更触发功能才生效，具体配置过程见 [Webhook 配置](/v1.6.0/settings/webhook-config/)
:::
