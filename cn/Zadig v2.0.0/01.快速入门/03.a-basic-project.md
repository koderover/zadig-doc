...
permalink: /cn/Zadig v2.0.0/quick-start/a-basic-project/
---
...
- 安装 Zadig，参考[安装文档](/cn/Zadig%20v2.0.0/install/helm-deploy)
- 集成 GitHub 代码源并 fork [案例源码](https://github.com/koderover/zadig/tree/main)，代码源集成参考文档：[GitHub 集成](/cn/Zadig%20v2.0.0/settings/codehost/github/)
- 集成镜像仓库，参考文档：[`镜像仓库集成`](/cn/Zadig%20v2.0.0/settings/image-registry/)

::: tip
如果你使用的不是 GitHub 代码源，也可以将代码下载，上传到自己的代码源后再在 Zadig 中集成，参考文档：[代码源集成](/cn/Zadig%20v2.0.0/settings/codehost/overview/)。
:::
...
> 钉钉和企业微信的配置请参考文档：[通知配置](/cn/Zadig%20v2.0.0/project/workflow/#im-状态通知)。
