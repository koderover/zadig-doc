...
permalink: /cn/Zadig v2.0.0/settings/configsystem/nacos/
---
...
在自定义工作流中编排 Nacos 配置变更任务即可实现 Nacos 配置自动变更，参考文档：[Nacos 配置变更](/cn/Zadig%20v2.0.0/project/workflow-jobs/#nacos-配置变更)。
