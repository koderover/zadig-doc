...
permalink: /cn/Zadig v2.0.0/settings/configsystem/apollo/
---
...
在自定义工作流中编排 Apollo 配置变更任务即可实现 Apollo 配置自动变更，参考文档：[Apollo 配置变更](/cn/Zadig%20v2.0.0/project/workflow-jobs/#apollo-配置变更)。
