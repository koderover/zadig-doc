...
环境创建完成后，点击不同的环境 Tab 即可切换到该环境的详情页面，生产环境右上角会有`生产`标识。更多信息请参考测试环境中的描述：[查看环境](/ZadigX%20v1.6.0/project/env/helm/chart/#查看环境)。
...
具体操作可参考文档 [添加 ZadigX 服务](/ZadigX%20v1.6.0/project/env/helm/chart/#添加服务)。
...
参考文档：[睡眠与唤醒](/ZadigX%20v1.6.0/project/env/k8s/#睡眠与唤醒)。
