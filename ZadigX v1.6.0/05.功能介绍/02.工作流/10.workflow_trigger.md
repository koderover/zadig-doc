...
3. 支持的代码源请参考文档：[代码源信息](/ZadigX%20v1.6.0/settings/codehost/overview/#功能兼容列表)。
:::

点击工作流右侧的 `触发器` -> 选择 `Git 触发器`即可配置，支持自动创建和手动创建两种方式，实现代码变更自动触发工作流。

<img src="../_images/common_workflow_config_webhook.png" width="400">
<img src="../_images/common_workflow_config_webhook_0.png" width="400">
...
第三步：填写 Zadig 中的相关配置后保存即可，参考文档：[Git 触发器基本配置](/ZadigX%20v1.6.0/project/workflow/#自动创建)。
