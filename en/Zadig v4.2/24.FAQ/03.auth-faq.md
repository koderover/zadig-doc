...
permalink: /en/Zadig v4.2/faq/auth/
---
...
In System Settings -> Integration Management -> System Integration -> Account System Integration, you can view the configuration of the integrated account system. Refer to [LDAP](/en/Zadig%20v4.2/settings/account/ldap/) / [OAuth](/en/Zadig%20v4.2/settings/account/oauth2/) / [GitHub](/en/Zadig%20v4.2/settings/account/github/) / [Custom](/en/Zadig%20v4.2/settings/account/custom/) account system to modify the information that is checked incorrectly.
...
Usually the reason is OAuth Configuration error, you can check [OAuth](/en/Zadig%20v4.2/settings/account/oauth2/) for checking. The following error configuration is an example:
