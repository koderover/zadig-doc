...
Step 2: Configure the production environment. See: [K8s YAML Production Environment](/en/Zadig%20v4.2/project/env/release/).
...
See: [Production Environment](/en/Zadig%20v4.2/project/env/release/#%E6%96%B0%E5%BB%BA%E7%8E%AF%E5%A2%83).
