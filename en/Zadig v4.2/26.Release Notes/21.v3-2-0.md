...
permalink: /en/Zadig v4.2/release-notes/v3.2.0/
---

Zadig v3.2.0 was released on November 1, 2024.
...
- Workflow image distribution tasks support multi-region synchronization using cloud vendor image synchronization
