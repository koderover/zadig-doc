...
permalink: /en/Zadig v4.2/release-notes/v3.4.1/
---
...
If the current system version < v3.4.0, please upgrade to v3.4.0 first. For specific upgrade steps, please refer to [v3.4.0 Upgrade Method](/cn/Zadig%20v3.4/release-notes/v3.4.0/#版本升级过程), and then upgrade to v3.4.1 using the following method.
:::

Please refer to the corresponding upgrade documentation based on your installation method:

- [Script installation](/cn/Zadig%20v3.4/install/helm-deploy/#升级)
- [Helm installation](/cn/Zadig%20v3.4/install/helm-deploy/#升级)
- [Official channel](/cn/Zadig%20v3.4/stable/install/#升级)
