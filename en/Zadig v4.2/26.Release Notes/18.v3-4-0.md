...
permalink: /en/Zadig v4.2/release-notes/v3.4.0/
---

Zadig v3.4.0 was released on May 6, 2025.
...
If the current system version < v3.3.0, please upgrade to v3.3.0 first. For specific upgrade steps, please refer to [v3.3.0 Upgrade Method](/Zadig%20v3.3/release-notes/v3.3.0/#%E7%89%88%E6%9C%AC%E5%8D%87%E7%BA%A7%E8%BF%87%E7%A8%8B), and then upgrade to v3.4.0 using the following method.
:::

Please perform the corresponding upgrade process according to different installation methods:

- [Script installation](/en/Zadig%20v3.4/install/helm-deploy/#%E5%8D%87%E7%BA%A7)
- [Helm installation](/en/Zadig%20v3.4/install/helm-deploy/#%E5%8D%87%E7%BA%A7)
- [Official channel](/en/Zadig%20v3.4/stable/install/#%E5%8D%87%E7%BA%A7)