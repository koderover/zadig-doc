...
permalink: /en/Zadig v4.2/install/helm-deploy/
---
...
::: tip
See [License](/en/Zadig%20v4.2/enterprise-mgr/#license) for license setup.
:::
...
- See [Backup Data](/en/Zadig%20v4.2/stable/backup-and-restore/#data-backup)
...
- Upgrade command:
  ...
  helm repo update
  helm upgrade {releaseName} -n {Namespace} --version=4.2.0 koderover-chart/zadig -f zadig.yaml
  ```
...
::: tip
If you have your own S3 object storage, you can skip MinIO. See [Object Storage](/en/Zadig%20v4.2/settings/object-storage/).
:::
