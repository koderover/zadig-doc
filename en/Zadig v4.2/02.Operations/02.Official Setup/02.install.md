...
permalink: /en/Zadig v4.2/stable/install/
---
...
- Be sure to backup data, see: [Backup data](/en/Zadig%20v4.2/stable/backup-and-restore/#data-backup)
...
Restore backup data for the target version, see: [Data Import](/en/Zadig%20v4.2/stable/backup-and-restore/#data-import)
