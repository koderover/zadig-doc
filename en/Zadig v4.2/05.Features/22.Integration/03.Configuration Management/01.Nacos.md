...
permalink: /en/Zadig v4.2/settings/configsystem/nacos/
---
...
Orchestrate Nacos Configuration Change tasks in a custom workflow to achieve Nacos configuration changes, refer to: [Nacos Configuration Change](/en/Zadig%20v4.2/project/workflow-jobs/#nacos-configuration-change).