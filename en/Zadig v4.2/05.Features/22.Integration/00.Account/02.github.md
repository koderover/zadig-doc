...
permalink: /en/Zadig v4.2/settings/account/github/
---
...
See: [setting the default account system](/en/Zadig%20v4.2/settings/account/ldap/#optional-set-as-the-default-account-system).