...
permalink: /en/Zadig v4.2/project/env/helm/chart/
---
...
- Other introductions can be found K8s YAML Description in the test environment: [View the environment](/en/Zadig%20v4.2/project/env/k8s/#view-the-environment)
...
- Supports direct pasting or importing configurations from the code base. For supported code sources, refer to [Code Source Information](/en/Zadig%20v4.2/settings/codehost/overview/#function-compatibility-list)
- After the environment is created successfully, the newly created configuration here will take effect in the environment / cluster. You can also manage the environment configuration after the environment is created, refer to [the environment configuration management.](/en/Zadig%20v4.2/project/env/k8s/#environment-configuration)
...
- Import from the specified code base values. For supported code sources, refer to [Code Source Information](/en/Zadig%20v4.2/settings/codehost/overview/#function-compatibility-list) .
...
Refer to [Create a new environment](/en/Zadig%20v4.2/project/env/k8s/#production-environment) .

## Copy Environment

> Only the test environment supports copying environments.

Reference K8s YAML Description in the Test Environment: [Copy Environment](/en/Zadig%20v4.2/project/env/k8s/#copy-environment) .
...
- Import values files from the code base. For supported code base, refer to [Code Source Information](/en/Zadig%20v4.2/settings/codehost/overview/#function-compatibility-list)
- Using variable groups, variable groups manage reference [variable group configuration](/en/Zadig%20v4.2/project/helm-chart/#variable-groups)
...
For environment configuration Ingress ConfigMap , Secret , PVC resources, refer to [Environment Configuration Management](/en/Zadig%20v4.2/project/env/k8s/#environment-configuration) for details.

## Self-Test Mode

Refer to [Self-test mode](/en/Zadig%20v4.2/project/env/k8s/#self-test-mode) .

## Sleep and Wake Up

Refer to [Sleep and Wake Up](/en/Zadig%20v4.2/project/env/k8s/#sleep-and-wake-up) .
