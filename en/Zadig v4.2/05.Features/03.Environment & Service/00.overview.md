...
permalink: /en/Zadig v4.2/env/overview/
---
...
- [Build configuration](/en/Zadig%20v4.2/project/build/#zadig-build)
- [Workflow deployment task configuration](/en/Zadig%20v4.2/project/workflow-jobs/#deployment)

2. Directly modify the service component image in the environment to update it, see [Service instance operation](/en/Zadig%20v4.2/project/env/service/#service-instance-operations) .
3. Update service components by modifying the mirror information in the service configuration file and updating the service in the environment. See [Update service](/en/Zadig%20v4.2/project/env/service/#basic-information) .