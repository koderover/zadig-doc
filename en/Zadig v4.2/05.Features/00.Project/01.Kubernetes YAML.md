...
permalink: /en/Zadig v4.2/project/k8s-yaml/
---
...
### Configure Services
Create and configure services. See [New K8s YAML Service](/en/Zadig%20v4.2/project/service/k8s/#create-a-new-service) for details. The system automatically parses K8s resources and service components.
...
Click `Add Build` to configure build settings. See [Build Configuration](/en/Zadig%20v4.2/project/build/).
