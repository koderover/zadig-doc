...
permalink: /en/Zadig v4.2/project/helm-chart/
---
...
Create and configure services. See [New K8s Helm Chart Service](/en/Zadig%20v4.2/project/service/helm/chart/#create-a-new-service) for details.

![Service Configuration](../../../_images/helm_chart_sample_onboarding_2.png)

The system automatically parses service components from the values file. Click `Add Build` to configure build settings. See [Build Configuration](/en/Zadig%20v4.2/project/build/).
...
> For parameter details, see [Create a new environment](/en/Zadig%20v4.2/project/env/k8s/#create-a-new-environment).
...
Environment global variables can reference variable groups. See [update global variables](/en/Zadig%20v4.2/project/env/helm/chart/#update-global-variables) for details.