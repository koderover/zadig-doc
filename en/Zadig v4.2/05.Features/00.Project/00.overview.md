...
permalink: /en/Zadig v4.2/project/overview/
---
...
- [K8s YAML project](/en/Zadig%20v4.2/project/k8s-yaml/)
- [K8s Helm Chart project](/en/Zadig%20v4.2/project/helm-chart/)
- [K8s Managed project](/en/Zadig%20v4.2/project/host-k8s-resources/)
- [Freestyle project](/en/Zadig%20v4.2/project/vm/)
...
- `Access`: Choose `Public` or `Private` to define the default permissions for the project.
    - Public project: Users enjoy permissions in role `read-only` by default to view resources in the project. See [permission configuration](/en/Zadig%20v4.2/project/permission/#permission-configuration) for details of this role.
...
For specific integration parameters, see [Code Source Integration](/en/Zadig%20v4.2/settings/codehost/overview/).

### Host
> Suitable for Freestyle projects.

For specific integration parameters, see [Host Integration](/en/Zadig%20v4.2/settings/vm-management/#add-a-host).