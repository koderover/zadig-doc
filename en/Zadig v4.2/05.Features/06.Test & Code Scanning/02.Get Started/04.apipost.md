...
permalink: /en/Zadig v4.2/test/apipost/
---
...
Refer to [Notification Configuration](/en/Zadig%20v4.2/project/test/#%E9%80%9A%E7%9F%A5%E9%85%8D%E7%BD%AE).
...
Configure workflows to orchestrate build, deployment (development environment), and testing tasks. Refer to [Workflows](/en/Zadig%20v4.2/project/common-workflow/).
