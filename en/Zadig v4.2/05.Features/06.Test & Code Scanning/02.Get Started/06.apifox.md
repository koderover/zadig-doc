...
permalink: /en/Zadig v4.2/test/apifox/
---
...
Configure workflows to orchestrate build, deployment (development environment), and test tasks. Refer to [Workflows](/en/Zadig%20v4.2/project/common-workflow/).
