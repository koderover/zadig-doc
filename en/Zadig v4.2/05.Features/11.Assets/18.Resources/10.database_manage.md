...
permalink: /en/Zadig v4.2/settings/database/
---
...
Orchestrate SQL Data Change Tasks in the workflow to realize automated data changes. Refer to [SQL Change Tasks](/en/Zadig%20v4.2/project/workflow-jobs/#sql-data-changes).