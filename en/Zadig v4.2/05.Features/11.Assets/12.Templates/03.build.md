...
permalink: /en/Zadig v4.2/template/build/
---
...
Go to `Assets` → `Templates` → `Build` to enter the build template management page. Click the `+` button, enter the template name, and refer to [Build Configuration](/en/Zadig%20v4.2/project/build/) to complete the configuration of the build template.
...
Refer to [Using Build Templates](/en/Zadig%20v4.2/project/build/template/).