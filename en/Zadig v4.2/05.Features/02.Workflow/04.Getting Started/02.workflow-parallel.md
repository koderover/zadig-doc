...
permalink: /en/Zadig v4.2/workflow/parallel/
---
...
::: tip
Zadig workflow execution concurrency depends on system resource limits. Administrators need to set reasonable [task concurrency settings](/en/Zadig%20v4.2/settings/system-settings/#task-concurrency-settings) in system settings.
:::
