...
permalink: /en/Zadig v4.2/project/workflow-trigger/
---
...
- Other parameters: Refer to the description in [Git Trigger Basic Configuration](/en/Zadig%20v4.2/project/common-workflow/#git-trigger)
...
3. Refer to [Git Trigger Basic Configuration](/en/Zadig%20v4.2/project/common-workflow/#git-trigger), fill in the relevant configuration in Zadig and save.
...
2. Supported code sources refer to [Code Source Information](/en/Zadig%20v4.2/settings/codehost/overview/#feature-compatibility-list).
:::
...
- Other parameters: Refer to [Timer Configuration](/en/Zadig%20v4.2/project/common-workflow/#timer)
...
Trigger workflow by calling OpenAPI. For specific operations, refer to [Execute Workflow](/en/Zadig%20v4.2/api/workflow/#execute-workflow).