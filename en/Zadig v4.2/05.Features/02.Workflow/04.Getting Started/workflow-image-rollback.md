...
permalink: /en/Zadig v4.2/workflow/image/rollback/
---
...
> [K8s YAML Deployed projects](/en/Zadig%20v4.2/project/k8s-yaml/) and [Helm Chart Deployed projects](/en/Zadig%20v4.2/project/helm-chart/) support the image version fallback function.
