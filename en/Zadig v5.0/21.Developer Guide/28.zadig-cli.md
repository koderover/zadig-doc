...
![Install CLI and Skill](./_images/zadig_cli_install.png)
...
![Check CLI version](./_images/zadig_cli_version.png)
...
![Check connection status](./_images/zadig_cli_auth_status.png)
...
![Check local installation and network status](./_images/zadig_cli_doctor.png)
...
![Check Agent Skill](./_images/zadig_cli_doctor_agent.png)
