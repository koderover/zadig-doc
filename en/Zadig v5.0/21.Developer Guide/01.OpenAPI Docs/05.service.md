...
```
POST /openapi/service/loader/load/:codehostId?repoName=<repoName>&branchName=<branchName>&remoteName=<remoteName>&repoOwner=<repoOwner>&namespace=<namespace>&production=<production>
```
...
```
POST /openapi/service/loader/load/1?repoName=demo&branchName=main&repoOwner=koderover&production=false
```
