...
```
POST /openapi/service/loader/load?codehostName=<codehostName>&repoName=<repoName>&branchName=<branchName>&remoteName=<remoteName>&repoOwner=<repoOwner>&namespace=<namespace>&production=<production>
```
...
| Parameter Name | Type   | Description                                                            | Required |
| -------------- | ------ | ---------------------------------------------------------------------- | -------- |
| `codehostName` | string | Code source name                                                       | Yes      |
| `repoName`     | string | Repository name                                                       | Yes      |
...
Create a test service for project `demo` from the `main` branch of codehost `github-demo`:
...
| Parameter Name | Description                                                          | Type   | Required |
| -------------- | -------------------------------------------------------------------- | ------ | -------- |
| `codehostName` | Code source name                                                     | string | Yes      |
...
Create a Helm service for project `demo` from the `main` branch of codehost `github-demo`:
