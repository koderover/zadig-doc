...
| `display_name`      | string            | Workflow Name                                                              |
| `project`           | string            | Project identifier                                                         |
| `description`       | string            | Workflow description information                                           |
| `concurrency_limit` | int               | Workflow task concurrency number, -1 means unlimited, 0 means unexecutable |
| `stages`            | [][Stage](#Stage) | Phase configuration                                                        |

<h4 id="Stage">Stage Parameter description</h4>

| Parameter Name | Type          | Description                            |
| -------------- | ------------- | -------------------------------------- |
| `name`         | string        | Stage name                             |
| `parallel`     | bool          | Whether to enable concurrent execution |
| `jobs`         | []interface{} | Task Configuration                     |
