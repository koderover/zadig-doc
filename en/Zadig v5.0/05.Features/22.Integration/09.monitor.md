...
Configure `Grafana Service Monitoring Task` in a custom workflow to use Grafana Monitor whether the service is healthy, refer to [Grafana](/en/Zadig%20v5.0/project/workflow-jobs/#grafana-service-monitoring) .