...
![Add an AI Model](./_images/ai/ai_model_add.png)
...
![SiliconFlow](./_images/ai/ai_siliconflow_1.png)

2. In Zadig, go to `System Settings` → `Integrations` → `AI Models`, and add the AI model.

![SiliconFlow](./_images/ai/ai_siliconflow.png)
