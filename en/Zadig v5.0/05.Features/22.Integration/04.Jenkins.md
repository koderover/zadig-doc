...
You can then orchestrate the execution of Jenkins Job tasks in the workflow. For more details, reference the documentation: [Execute Jenkins Job](/en/Zadig%20v5.0/project/workflow-jobs/#ci-cd).
