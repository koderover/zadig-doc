...
- Other parameters: Refer to the description in [Git Trigger Basic Configuration](/en/Zadig%20v5.0/project/common-workflow/#git-trigger)
...
3. Refer to [Git Trigger Basic Configuration](/en/Zadig%20v5.0/project/common-workflow/#git-trigger), fill in the relevant configuration in Zadig and save.
...
- Other parameters: Refer to [Timer Configuration](/en/Zadig%20v5.0/project/common-workflow/#timer)
