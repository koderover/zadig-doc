...
permalink: /en/Zadig v5.0/workflow/image/rollback/
---
...
> [K8s YAML Deployed projects](/en/Zadig%20v5.0/project/k8s-yaml/) and [Helm Chart Deployed projects](/en/Zadig%20v5.0/project/helm-chart/) support the image version fallback function.
