...
Configure workflows to orchestrate build, deployment (development environment), and testing tasks. Refer to [Workflows](/en/Zadig%20v5.0/project/common-workflow/).
