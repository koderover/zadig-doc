...
Describes the correspondence between each permission item and function. For the complete functional documents in each functional module, refer to [Workflow](/en/Zadig%20v5.0/project/common-workflow/) / [Environment](/en/Zadig%20v5.0/project/env/k8s) / [Service](/en/Zadig%20v5.0/project/service/k8s/) / [Build](/en/Zadig%20v5.0/project/build/) / [Test](/en/Zadig%20v5.0/project/test/) / [Version Management](/en/Zadig%20v5.0/project/version/) / [Code Scan](/en/Zadig%20v5.0/project/scan/).
