...
permalink: /en/Zadig v5.0/install/helm-deploy/
---
...
- See [Backup Data](/en/Zadig%20v5.0/stable/backup-and-restore/#data-backup)
...
- Upgrade command:
  ...
  helm repo update
  helm upgrade {releaseName} -n {Namespace} --version=5.0.0 koderover-chart/zadig -f zadig.yaml
  ```
...
::: tip
If you have your own S3 object storage, you can skip MinIO. See [Object Storage](/en/Zadig%20v5.0/settings/object-storage/).
:::
