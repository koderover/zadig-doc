...
1. Change the `DOCKER_REPO` variable in the root [Makefile](https://github.com/koderover/dex/blob/release-1.10.0/Makefile) to your own public mirror repository
...
kubectl set image deployment/<Dex 的 deployment> dex=<新生成的 Dex 镜像> --record -n <Zadig Namespace> # Replace Dex images
```
...
Refer [to setting the default account system](/en/Zadig%20v3.4/settings/account/ldap/#%E5%8F%AF%E9%80%89-%E8%AE%BE%E7%BD%AE%E4%B8%BA%E9%BB%98%E8%AE%A4%E8%B4%A6%E5%8F%B7%E7%B3%BB%E7%BB%9F) .