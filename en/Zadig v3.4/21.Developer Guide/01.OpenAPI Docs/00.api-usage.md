...
|                                                             | View environment K8S service Yaml       | Test environment: [GET /openapi/environments/services/yaml](/en/Zadig%20v3.4/api/env/#view-environment-k8s-service-yaml)<br> Production environment: [GET /openapi/environments/production/services/yaml](/en/Zadig%20v3.4/api/env/#view-environment-k8s-service-yaml)                             |
|                                                             | View environment Helm service Values    | Test environment: [GET /openapi/environments/services/values](/en/Zadig%20v3.4/api/env/#view-environment-helm-service-values)<br> Production environment: [GET /openapi/environments/production/services/values](/en/Zadig%20v3.4/api/env/#view-environment-helm-service-values)                   |
...
| Retry create version                | [POST /openapi/delivery/releases/retry](/en/Zadig%20v3.4/api/delivery/#retry-create-version)                 |
