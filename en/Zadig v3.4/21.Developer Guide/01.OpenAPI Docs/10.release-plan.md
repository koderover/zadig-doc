...
| ------------ | ------ | ----------------------- | -------- | ------ |
| `pageNum`    | int    | Pagination parameters-current page count       | Yes       | None      |
| `pageSize`   | int    | Pagination parameters-the number of displayed items on the current page | Yes       | None     |
...
| `manager` | string |  Publish the username of the person in charge                                             |Yes|None|
| `manager_identity_type` | string |  Release person in charge user type, system (default type), ldap, oauth, etc.                                            |Yes|None|
