...
permalink: /en/Zadig v3.4/api/delivery-center/
---
...
| -------------- | ------- | ------------- | ------------------------ | -------- |
| `projectName`  | string  | Project identifier      | Default is empty, query all items   | optional |
| `workflowName` | string  | The name of the workflow  | Default is empty, query all workflows | optional |
| `taskId`       | integer | Workflow Task ID | Default is empty, query all tasks  | optional |
| `serviceName`  | string  | Service name      | Default is empty, query all services   | optional |
