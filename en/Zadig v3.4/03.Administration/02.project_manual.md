...
Step 2: Configure the production environment. See: [K8s YAML Production Environment](/en/Zadig%20v3.4/project/env/k8s/#production-environment).
...
See: [Production Environment](/en/Zadig%20v3.4/project/env/k8s/#production-environment).
