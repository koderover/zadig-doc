...
::: tip
1. You need to integrate the code source in the system, refer to [Code Source Integration](/en/Zadig%20v3.4/settings/codehost/overview/)
...
::: tip
You need to create K8s YAML templates in the system template library first, refer to [K8s YAML Template Management](/en/Zadig%20v3.4/template/k8s_yaml/).
:::
