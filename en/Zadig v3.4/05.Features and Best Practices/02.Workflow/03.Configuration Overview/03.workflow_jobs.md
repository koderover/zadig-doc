...
The mirror can be pushed to a specified mirror repository.
...
- `Source Mirror Repository` : The source of the mirror to be distributed.
- `Target Mirror Repository` : The target repository for mirror distribution.
- `Distribution Method` :
  - `Image Push` : Retag the mirror and push it to the target mirror repository
