...
- `Type`: Supports string, multi-line text, single-choice, multiple-choice, file, code repository, image, and [dynamic variables](/en/Zadig%20v4.1/workflow/dynamic-variable/).
