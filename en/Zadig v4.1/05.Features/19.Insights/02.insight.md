...
permalink: /en/Zadig v4.1/stat/insight/
---
...
- **API Configuration**: Configures the API to retrieve data, with external system integration reference documentation: [External System](/en/Zadig%20v4.1/settings/others/)
