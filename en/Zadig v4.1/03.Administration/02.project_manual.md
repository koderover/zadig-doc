...
Step 2: Configure the production environment. See: [K8s YAML Production Environment](/en/Zadig%20v4.1/project/env/k8s/#production-environment).
...
See: [Production Environment](/en/Zadig%20v4.1/project/env/k8s/#production-environment).
