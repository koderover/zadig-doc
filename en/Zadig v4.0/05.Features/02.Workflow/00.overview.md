...
| Release Strategies | Helm Chart Deployment | Directly deploy Charts from the Helm repository to the environment | [Check](/en/Zadig%20v4.0/project/workflow-jobs/#helm-chart-deployment) |
