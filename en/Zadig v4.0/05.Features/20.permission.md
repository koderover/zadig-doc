...
permalink: /en/Zadig v4.0/project/permission/
---
...
- Roles are a collection of permissions, in [role management](/en/Zadig%20v4.0/project/permission/#role-management) , you can view permission details in roles
...
Describes the correspondence between each permission item and function. For the complete functional documents in each functional module, refer to [Workflow](/en/Zadig%20v4.0/project/common-workflow/) / [Environment](/en/Zadig%20v4.0/project/env/k8s) / [Service](/en/Zadig%20v4.0/project/service/k8s/) / [Build](/en/Zadig%20v4.0/project/build/) / [Test](/en/Zadig%20v4.0/project/test/) / [Version Management](/en/Zadig%20v4.0/project/version/) / [Code Scan](/en/Zadig%20v4.0/project/scan/).
...
- Select participating members, only project members can be selected. If the users who need to be added are not in the member list, they can be added in [member management](/en/Zadig%20v4.0/project/permission/#member-management) .
