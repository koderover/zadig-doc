...
|                                                             | View Environment Helm Service Values    | Test: [GET /openapi/environments/service/values](/en/Zadig%20v4.0/api/env/#view-environment-helm-service-values)<br>Production: [GET /openapi/environments/production/service/values](/en/Zadig%20v4.0/api/env/#view-environment-helm-service-values-2)                                          |
