...
| API Function Description     | API Links                                                                             |
| :--------------- | :----------------------------------------------------------------------------------- |
| Create a publishing plan     | [POST /openapi/release_plan/v1](/en/Zadig%20v4.0/api/release-plan/#release-plan)        |
| Get a list of release plans | [GET /openapi/release_plan/v1](/en/Zadig%20v4.0/api/release-plan/#release-plan)     |
| Get release plan details | [GET /openapi/release_plan/v1/:id](/en/Zadig%20v4.0/api/release-plan/#release-plan) |
