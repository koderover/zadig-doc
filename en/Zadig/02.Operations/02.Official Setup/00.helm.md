...
permalink: /en/Zadig v4.3/install/helm-deploy/
---
...
::: tip
See [License](/en/Zadig%20v4.3/enterprise-mgr/#license) for license setup.
:::
...
- See [Backup Data](/en/Zadig%20v4.3/stable/backup-and-restore/#data-backup)
...
::: tip
If you have your own S3 object storage, you can skip MinIO. See [Object Storage](/en/Zadig%20v4.3/settings/object-storage/).
:::
