...
permalink: /en/Zadig v5.0/stable/install/
---
...
![Configure authorization credentials](./_images/install/install_customer_1.png)
![Configure authorization credentials](./_images/install/install_customer_2.png)
...
![Configure authorization credentials](./_images/install/install_customer_211_3.png)
...
![Install](./_images/install/install_1.png)
...
![Install](./_images/install/install_2.png)
...
![Local installation](./_images/install/install_zadig_on_init.png)

### Step 4: Configure License

After registration and login, select "Paid Version" to configure the license.

<img src="./_images/install/config_license_v210_1.png" width="400">
<img src="./_images/install/config_license_v210_2.png" width="400">
...
- Be sure to backup data, see: [Backup data](/en/Zadig%20v5.0/stable/backup-and-restore/#data-backup)
- Backup current installation parameters
![Backup](./_images/install/upgrade_1.png)
...
Restore backup data for the target version, see: [Data Import](/en/Zadig%20v5.0/stable/backup-and-restore/#data-import)

### Step 2: Perform Rollback

Customer console > `Version`, select the target version, then click `Deploy`.

![Install](./_images/install/rollback.png)
