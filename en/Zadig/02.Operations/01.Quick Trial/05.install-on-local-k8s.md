...
permalink: /en/Zadig v5.0/install/install-on-local-k8s/
---
...
```
![Local installation](./_images/install-on-local-k8s/install_zadig_on_local_1.png)
...
![Local installation](./_images/install-on-local-k8s/install_zadig_on_init.png)

::: tip
For license setup, see: [License](/en/Zadig%20v5.0/enterprise-mgr/#license)
:::
