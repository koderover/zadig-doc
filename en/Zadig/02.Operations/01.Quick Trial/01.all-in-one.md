...
permalink: /en/Zadig v5.0/install/all-in-one/
---
...
**GitHub:**
```bash
curl -LO https://github.com/koderover/zadig/releases/download/v5.0.0/all_in_one_install_quickstart.sh
...
<img src="./_images/all-in-one/all_in_one_success.png" alt="Install result" title="Install result">
...
<img src="./_images/all-in-one/get_endpoint.png" alt="Access endpoint" title="Access endpoint">

Access address is shown in output.

::: tip
See [License](/en/Zadig%20v5.0/enterprise-mgr/#license) for license setup.
:::
