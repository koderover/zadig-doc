...
```
POST /openapi/environments/<environmentKey>/pod/<podName>/restart?projectKey=<projectKey>
```
...
```
POST /openapi/environments/production/<environmentKey>/pod/<podName>/restart?projectKey=<projectKey>
```
