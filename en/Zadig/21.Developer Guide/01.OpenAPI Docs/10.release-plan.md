...
permalink: /en/Zadig v5.0/api/release-plan/
---
...
| `parameters`   | [][Parameter](/en/Zadig%20v5.0/api/workflow/#parameter) | Global variables, see custom workflow section for detailed fields   |
| `inputs`       | [][Input](/en/Zadig%20v5.0/api/workflow/#input_arg)     | Workflow job inputs, see custom workflow section for detailed fields |
| `remark`       | string                                                  | Remark                                                               |
