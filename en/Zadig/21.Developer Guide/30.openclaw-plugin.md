...
<img src="./_images/openclaw-plugin/openclaw_plugin_1.png" width="400">
<img src="./_images/openclaw-plugin/openclaw_plugin_2.png" width="400">
...
<img src="./_images/openclaw-plugin/openclaw_plugin_3.png" width="400">

4. Start using it: after installation, send a message in any integrated channel, such as Lark, to activate Zadig capabilities.

<img src="./_images/openclaw-plugin/openclaw_plugin_4.png" width="400">
<img src="./_images/openclaw-plugin/openclaw_plugin_5.png" width="400">
...
![OpenClaw Plugin](./_images/openclaw-plugin/openclaw_plugin_6.png)

2. Development self-testing and integration. Run workflows and view service status and service logs.

![OpenClaw Plugin](./_images/openclaw-plugin/openclaw_plugin_7.png)

3. Build log analysis and optimization. Analyze workflow build logs.

![OpenClaw Plugin](./_images/openclaw-plugin/openclaw_plugin_8.png)

4. Batch clean up unused builds. Batch delete builds that are not referenced.

![OpenClaw Plugin](./_images/openclaw-plugin/openclaw_plugin_9.png)
