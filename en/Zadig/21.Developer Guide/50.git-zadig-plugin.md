---
title: Git-Zadig Plugin
date: 2023-01-08 11:49:07
permalink: /en/Zadig v5.0/developer-center/git-zadig/
---
...
![git-zadig](./_images/git-zadig-plugin/git_zadig_flow.jpg)
...
Configure the Zadig workflow according to actual requirements and add corresponding Git triggers, refer to [documentation](/en/Zadig%20v5.0/project/workflow-config/#git-trigger).

1. Use git-zadig tool to sync code during the build process

![git-zadig](./_images/git-zadig-plugin/git_zadig_admin_1_220.png)

2. Configure triggers

![git-zadig](./_images/git-zadig-plugin/git_zadig_admin_2_220.png)
...
![git-zadig](./_images/git-zadig-plugin/git_zadig_admin_3.png)
...
![git-zadig](./_images/git-zadig-plugin/git_zadig_developer_1_220.png)
...
git zadig upload
```
![git-zadig](./_images/git-zadig-plugin/git_zadig_developer_2.png)
...
<img src="./_images/git-zadig-plugin/git_zadig_developer_3.png" width="400">
<img src="./_images/git-zadig-plugin/git_zadig_developer_4.png" width="400">
...
<img src="./_images/git-zadig-plugin/git_zadig_developer_5.png" width="400">
<img src="./_images/git-zadig-plugin/git_zadig_developer_6.png" width="400">

3. IM notification effect

![git-zadig](./_images/git-zadig-plugin/git_zadig_developer_7.png)
...
![git-zadig](./_images/git-zadig-plugin/git_zadig_developer_8.png)

2. Perform git operations in the current project, you can find that hook checks have been injected.

![git-zadig](./_images/git-zadig-plugin/git_zadig_developer_9.png)
