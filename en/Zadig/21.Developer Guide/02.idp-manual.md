...
permalink: /en/Zadig v5.0/idp-manual/
---
...
![Navigation Page](./_images/idp-manual/plugin_1.png)
...
![Tab](./_images/idp-manual/plugin_2.png)
...
```javascript
// UseVue2 components and Options API
export default {
  name: 'MyComponent',
  data() {
    return {
...
#### Lazy Loading
```javascript
// UseVue async components for lazy loading
export default {
  name: 'App',
  components: {
