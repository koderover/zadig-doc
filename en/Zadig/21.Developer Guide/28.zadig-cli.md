...
![Install CLI and Skill](./_images/zadig-cli/zadig_cli_install-2.png)
...
![Check CLI version](./_images/zadig-cli/zadig_cli_version-2.png)
...
![Check connection status](./_images/zadig-cli/zadig_cli_auth_status-2.png)
...
![Check local installation and network status](./_images/zadig-cli/zadig_cli_doctor-2.png)
...
![Check Agent Skill](./_images/zadig-cli/zadig_cli_doctor_agent-2.png)
...
![Copy a project](./_images/zadig-cli/zadig_cli_copy_project-2.png)

### Day-to-day operations: clean up workflows

Batch-clean unused workflows.

![Clean up workflows](./_images/zadig-cli/zadig_cli_cleanup_workflow-2.png)

### Delivery: update a service

Update a service by running a workflow.

![Update a service with a workflow](./_images/zadig-cli/zadig_cli_update_service-2.png)

### Troubleshooting: view service logs

View and analyze service logs.

![View service logs](./_images/zadig-cli/zadig_cli_service_log-2.png)

### Efficiency analysis: view build logs

View workflow build logs to identify efficiency bottlenecks.

![Analyze build logs](./_images/zadig-cli/zadig_cli_build_log-2.png)
