...
permalink: /en/Zadig v5.0/workflow/ingress-gray-release/
---
...
<img src="./_images/ingress-gray-release/ingress_gray_release_1.png" width="500" >
...
![ingress-gray](./_images/ingress-gray-release/ingress_gray_release_2.png)
...
![ingress-gray](./_images/ingress-gray-release/ingress_gray_release_3.png)

2. Add ingress-blue to prepare for production release configuration.

<img src="./_images/ingress-gray-release/ingress_gray_release_4.png" width="400" >
<img src="./_images/ingress-gray-release/ingress_gray_release_5.png" width="400" >
...
<img src="./_images/ingress-gray-release/ingress_gray_release_6.png" width="400" >
<img src="./_images/ingress-gray-release/ingress_gray_release_7.png" width="400" >

1. `Blue-Green Environment Deployment`: Use the "Blue-Green Environment Deployment" task to add service a.

![ingress-gray](./_images/ingress-gray-release/ingress_gray_release_8.png)

2. `导 50 流量` : Use "K8s YAML Update", select ingress-blue Configuration, and set `nginx.ingress.kubernetes.io/canary: "true"` and `nginx.ingress.kubernetes.io/canary-weight: "50"` .

![ingress-gray](./_images/ingress-gray-release/ingress_gray_release_9.png)

3. `Check New Version`: Use the "General Script Execution" or "Test Execution" task to configure the corresponding check scripts and perform automated testing for the new version.
4. `Approval`: Enable "Manual Approval" in the production upgrade stage to ensure the reliability of the release.

![ingress-gray](./_images/ingress-gray-release/ingress_gray_release_10.png)

5. `Production Upgrade`: Use the "Blue-Green Release" task, ensuring the "Blue-Green Environment Deployment" task is correctly selected in the configuration.

![ingress-gray](./_images/ingress-gray-release/ingress_gray_release_11.png)

6. `Cut Off Traffic`: Use the "K8s YAML Update" task, select the ingress-blue configuration, and set `nginx.ingress.kubernetes.io/canary: "false"` and `nginx.ingress.kubernetes.io/canary-weight: "0"`.

![ingress-gray](./_images/ingress-gray-release/ingress_gray_release_12.png)
...
<img src="./_images/ingress-gray-release/ingress_gray_release_13.png" width="400" >
<img src="./_images/ingress-gray-release/ingress_gray_release_14.png" width="400" >
...
<img src="./_images/ingress-gray-release/ingress_gray_release_15.png" width="400" >
<img src="./_images/ingress-gray-release/ingress_gray_release_16.png" width="400" >
...
<img src="./_images/ingress-gray-release/ingress_gray_release_17.png" width="400" >
<img src="./_images/ingress-gray-release/ingress_gray_release_18.png" width="400" >
...
<img src="./_images/ingress-gray-release/ingress_gray_release_19.png" width="400" >
<img src="./_images/ingress-gray-release/ingress_gray_release_20.png" width="400" >
