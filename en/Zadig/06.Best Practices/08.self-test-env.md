...
permalink: /en/Zadig v5.0/env/self-test-env/
---
...
![Self-test Mode Architecture](./_images/self-test-env/self_test_env_overview.png)
...
![Enable Self-Test Mode](./_images/self-test-env/set_self_test_env.png)
...
<img src="./_images/self-test-env/set_self_test_env_1.png" width="400">
<img src="./_images/self-test-env/set_self_test_env_2.png" width="400">
...
![Create Sub-Environment](./_images/self-test-env/create_vice_env.png)
![Create Sub-Environment](./_images/self-test-env/create_vice_env_1.png)
![Create Sub-Environment](./_images/self-test-env/create_vice_env_2.png)
...
![Self-Test Joint Debugging Effect](./_images/self-test-env/self_test_env_effect_1.png)
...
![Self-Test Joint Debugging Effect](./_images/self-test-env/self_test_env_effect_2.png)
