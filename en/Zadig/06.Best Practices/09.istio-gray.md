...
permalink: /en/Zadig v5.0/env/istio-gray-release/
---
...
![Create New Project](./_images/istio-gray/istio_gray_release_3.png)
...
![Create New Service](./_images/istio-gray/istio_gray_release_4.png)
...
![Enable Grayscale](./_images/istio-gray/istio_gray_release_7.png)
...
![Create New Workflow](./_images/istio-gray/istio_gray_release_10.png)
...
![Add Service](./_images/istio-gray/istio_gray_release_13.png)
...
![Update Grayscale Environment](./_images/istio-gray/istio_gray_release_14.png)
...
![Based on Traffic Ratio](./_images/istio-gray/istio_gray_release_15.png)
...
![Based on Request Header](./_images/istio-gray/istio_gray_release_22.png)
...
![Based on Request Header](./_images/istio-gray/istio_gray_release_23.png)
...
![Release Production Environment](./_images/istio-gray/istio_gray_release_24.png)
...
In the above content, we explored using environmental capabilities to update Istio grayscale release strategies. If, in actual applications, the grayscale release process has been standardized, you can automate this process by choreographing a workflow task named "Istio Grayscale Policy Update". This simplifies operations, ensures that each release follows the established process, reduces manual errors, and improves efficiency and reliability.
...
![Based on Traffic Ratio Workflow](./_images/istio-gray/istio_gray_release_25.png)
...
![Based on Request Header Workflow](./_images/istio-gray/istio_gray_release_26.png)