...
permalink: /en/Zadig v5.0/faq/debug-system/
---
...
![mysql_pod_startup_probe_warning](./_images/debug-system-faq/mysql_pod_startup_probe_warning.png)
...
![zadig_init_job_error](./_images/debug-system-faq/zadig_init_job_error.png)
...
Recover the managed cluster and reconnect the downed cluster in the Zadig system. Reference documentation: [Cluster Management](/en/Zadig%20v5.0/pages/cluster_manage/).
...
> Cluster management reference documentation: [Cluster Management](/en/Zadig%20v5.0/pages/cluster_manage/).
