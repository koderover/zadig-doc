...
permalink: /en/Zadig v5.0/faq/product-usage/
---
...
![Container Exception](./_images/product-usage-faq/log_pod_error.png)
...
![Real-time Logs](./_images/product-usage-faq/log_runtime.png)
...
![pod debug](./_images/product-usage-faq/log_pod_debug.png)
...
![Namespace](./_images/product-usage-faq/log_get_namespace.png)

The command execution result is shown below

![View Service Container List](./_images/product-usage-faq/log_kubectl_get_po.png)
...
![Build Configuration Supports Multiple Services](./_images/product-usage-faq/build_config_demo_for_multi_services.png)

### Use Build Templates

Reference documentation: [Build Templates](/en/Zadig%20v5.0/template/build/).
...
2. By configuring workflow Webhook, you can trigger workflow runs when code is pushed to the code repository and Pull Request (Merge Request) is submitted, realizing the process from submission to build automation. For details, refer to [Code Changes Trigger Workflow](/en/Zadig%20v5.0/workflow/trigger/#code-changes-trigger).
...
- [AI Technical Support Claire](/en/Zadig%20v5.0/claire/): Join the Claire community group and `@Claire` for configuration, troubleshooting, and best practices
