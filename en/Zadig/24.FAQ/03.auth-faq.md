...
permalink: /en/Zadig v5.0/faq/auth/
---
...
![auth_faq_login_1](./_images/auth-faq/auth_faq_login_1.png)
![auth_faq_login_2](./_images/auth-faq/auth_faq_login_2.png)
...
![configmap_user_config](./_images/auth-faq/configmap_user_config.png)
...
![secret_dex](./_images/auth-faq/secret_dex.png)

### Third-Party Account System Configuration

In System Settings -> Integration Management -> System Integration -> Account System Integration, you can view the configuration of the integrated account system. Refer to [LDAP](/en/Zadig%20v5.0/settings/account/ldap/) / [OAuth](/en/Zadig%20v5.0/settings/account/oauth2/) / [GitHub](/en/Zadig%20v5.0/settings/account/github/) / [Custom](/en/Zadig%20v5.0/settings/account/custom/) account system to modify the information that is checked incorrectly.

![system_integration_user_config](./_images/auth-faq/system_integration_user_config.png)
...
![auth_faq_dex_1](./_images/auth-faq/auth_faq_dex_1.png)
...
![auth_faq_dex_2](./_images/auth-faq/auth_faq_dex_2.png)

## OAuth Login Error Internal Server Error, Failed to authenticate:Oauth Connector:not found xx claim

Usually the reason is OAuth Configuration error, you can check [OAuth](/en/Zadig%20v5.0/settings/account/oauth2/) for checking. The following error configuration is an example:

![auth_faq_oauth_config_1](./_images/auth-faq/auth_faq_oauth_config_1.png)
...
![auth_faq_oauth_add_1](./_images/auth-faq/auth_faq_oauth_add_1.png)