...
permalink: /en/Zadig v5.0/quick-start/a-basic-project/
---
...
- Install Zadig: [Installation Documentation](/en/Zadig%20v5.0/install/guide)
- Integrate GitHub as the code source and fork the [example source code](https://github.com/koderover/zadig/tree/main). For code source integration, refer to: [GitHub Integration](/en/Zadig%20v5.0/settings/codehost/github/)
- Integrate the image registry: [Image Registry Integration](/en/Zadig%20v5.0/settings/image-registry/)

::: tip
If you do not use GitHub as the code source, you can download the code and upload it to your own code source, then integrate it in Zadig. See: [Code Source Integration](/en/Zadig%20v5.0/settings/codehost/overview/).
:::
...
<img src="./_images/a-basic-project/basic_project_create_project_220.png" width="400">
<img src="./_images/a-basic-project/basic_project_create_project_1.png" width="400">

Click "Create Now" to enter the project initialization wizard, then click "Next" to create a service:

<img alt="创建项目" title="Tips for creating a project successfully" src="./_images/a-basic-project/basic_project_create_project_2_220.png">
...
<img src="./_images/a-basic-project/basic_project_create_project_3_0.png" width="400">
<img src="./_images/a-basic-project/basic_project_create_project_3.png" width="450">
...
<img src="./_images/a-basic-project/basic_project_create_project_4.png" width="400" alt="新建服务" title="Create a new service">
...
<img src="./_images/a-basic-project/basic_project_create_build.png" width="400">
<img src="./_images/a-basic-project/basic_project_create_build_1_220.png" width="400">
...
<img src="./_images/a-basic-project/basic_project_create_env_1.png" width="400" alt="新建环境和工作流" title="Create a new environment and workflow">
...
<img src="./_images/a-basic-project/basic_project_pipeline_run_1_220.png" width="400" alt="运行工作流" title="Run the workflow">

After the workflow finishes, the service version in the environment is automatically updated:

<img src="./_images/a-basic-project/basic_project_view_service.png" width="400" alt="查看更新后的服务" title="View updated services">
...
<img src="./_images/a-basic-project/basic_project_create_webhook.png" width="400" alt="触发器" title="trigger">

Add a trigger, select Git trigger, fill in the configuration, and save:

<img src="./_images/a-basic-project/basic_project_create_webhook_1_220.png" width="400" alt="触发器" title="trigger">

After submitting a pull request in GitLab, the check list displays the corresponding workflow status:

<img src="./_images/a-basic-project/basic_project_create_pr_220.png" width="400" alt="创建 pull request" title="Create a pull request">

Click the task link to jump to Zadig to view workflow details and track code changes:

<img src="./_images/a-basic-project/pipeline_trigger_by_wehook_220.png" width="400" alt="查看 Webhook 触发的工作流" title="View Webhook-triggered workflows">

After the workflow finishes, the environment service image is updated:

<img src="./_images/a-basic-project/show_service_updated_by_webhook.png" width="400" alt="查看更新后的服务" title="View updated services">
...
> For DingTalk and WeCom configuration, see: [Notification Configuration](/en/Zadig%20v5.0/workflow/im/)

Step 1: Add a Bot in Feishu and get the Webhook address:

<img src="./_images/a-basic-project/basic_project_lark_add_bot.png" width="400" alt="Feishu configuration step one">

<img src="./_images/a-basic-project/basic_project_lark_edit_bot.png" width="400" alt="Feishu Configuration Step 2">
...
<img src="./_images/a-basic-project/basic_project_workflow_feishu_config_220.png" width="400" alt="Workflow notification Feishu configuration">

Notification example:

<img src="./_images/a-basic-project/basic_project_lark_webhook_notification_220.png" width="400" alt="Feishu notification effect">
