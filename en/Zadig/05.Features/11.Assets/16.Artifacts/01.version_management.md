...
permalink: /en/Zadig v5.0/delivery/version-management/
---
...
<img alt="版本交付" title="Version delivery" src="./_images/version_management/version_list_220.png">
...
- Click on a specific version to view its details.
  ...
  <img alt="版本交付" title="Version delivery" src="./_images/version_management/k8s_version_detail_220.png">

  - K8s Helm Chart Project Version Details: Includes a complete, downloadable Chart configuration.

  <img alt="版本交付" title="Version delivery" src="./_images/version_management/helm_version_detail.png">

- For more detailed descriptions of version management, refer to [Version Management](/en/Zadig%20v5.0/project/version/).