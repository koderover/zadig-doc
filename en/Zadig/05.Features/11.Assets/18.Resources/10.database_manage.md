...
permalink: /en/Zadig v5.0/settings/database/
---
...
![reg](./_images/database_manage/add_database_220.png)

## How to Use

Orchestrate SQL Change Execution tasks in the workflow to realize automated data changes. Refer to [SQL Change Execution](/en/Zadig%20v5.0/project/workflow-jobs/#sql-change-execution).