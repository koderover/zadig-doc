...
permalink: /en/Zadig v5.0/settings/object-storage/
---
...
![obj](./_images/object_storage/obj_add_v180.png)
...
![obj](./_images/object_storage/obj_add.png)
...
![obj](./_images/object_storage/obj_tencent_add.png)
...
![obj](./_images/object_storage/obj_kodo_add.png)
...
![obj](./_images/object_storage/obj_huawei_add.png)
...
![obj](./_images/object_storage/obj_huoshan.png)
...
<img src="./_images/object_storage/s3_build_log_demo.png" width="260">
<img src="./_images/object_storage/s3_test_log_demo.png" width="260">
<img src="./_images/object_storage/s3_scan_log_demo.png" width="260">
...
<img src="./_images/object_storage/s3_build_log_demo_1.png">

### Workflow Build Cache

After selecting object storage as cache medium in the cache resource configuration of the cluster, the build cache of the workflow will be uploaded to the default object storage. For cluster cache resource configuration, please refer to the document: [cache resource configuration](/en/Zadig%20v5.0/pages/cluster_manage/#cache-resource-configuration) .
...
<img src="./_images/object_storage/s3_test_report_demo.png" width="400">
<img src="./_images/object_storage/s3_test_report_demo_1.png" width="400">

### File Storage

You can specify file storage in build, test, and general script execution, upload files to the specified object storage, refer to the document: [file storage](/en/Zadig%20v5.0/project/build/#more-build-steps) .

![obj](./_images/object_storage/s3_build_log_demo_3.png)

### Helm Chart Version

The version created in the Helm Chart project will be uploaded to the default object store and can be downloaded directly. To create a Helm Chart version, please refer to the document: [Version Management](/en/Zadig%20v5.0/project/version/#k8s-helm-chart-project) .

![obj](./_images/object_storage/s3_helm_chart_version_demo.png)