...
permalink: /en/Zadig v5.0/settings/vm-management/
---
...
![vm_list](./_images/machine_manage/vm_list_v180.png)

## Add a Host

Visit `Assets` → `Host Management`, click `New`, fill in the parameters, and save.

![machine_resource_add](./_images/machine_manage/machine_resource_add_v220.png)
...
![machine_resource_add](./_images/machine_manage/add_vm_ssh.png)
...
![machine_resource_add](./_images/machine_manage/creat_vm_agent_220.png)

![machine_resource_add](./_images/machine_manage/add_vm_agent_220.png)

### Bulk Import of Hosts

Administrators can access `Assets` → `Host Management`, click `New`

![machine_resource_bulk_import](./_images/machine_manage/machine_resource_bulk_import.png)
...
![machine_resource_use](./_images/machine_manage/machine_resource_use.png)

You can view the deployment details of the service by clicking on the service in `Environment`.

![machine_resource_show](./_images/machine_manage/machine_resource_show.png)

### Agent Access

For build and general script execution environments, select "Host" in the infrastructure and choose the corresponding execution host tag to run workflow tasks on the corresponding host.

![vm_agent_task](./_images/machine_manage/vm_agent_task.png)