...
permalink: /en/Zadig v5.0/template/dockerfile/
---

::: tip Background
<img style="width:22px; height:22px" src="./_images/dockerfile/docker.svg"></img> Dockerfile template capability, which allows users to wrap common image construction steps into templates, minimizing repetitive build configuration work.
:::
...
![Add Dockerfile template](./_images/dockerfile/create_dockerfile_template.png)
...
> For `Add Steps` instructions, refer to [the image build](/en/Zadig%20v5.0/project/build/#add-more-build-steps).
...
![Using Dockerfile templates](./_images/dockerfile/use_dockerfile_template.png)
...
![View Dockerfile template reference list](./_images/dockerfile/show_dockerfile_template_ref.png)