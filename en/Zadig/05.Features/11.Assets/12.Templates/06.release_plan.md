...
permalink: /en/Zadig v5.0/template/release_plan/
---
...
![Use the Release Plan Template](./_images/release_plan/release_template_1.png)

## Using Templates

Visit `Release Plan` → `Create Release Plan` → select the release plan template.

![Use the Release Plan Template](./_images/release_plan/release_template_2.png)