...
permalink: /en/Zadig v5.0/template/helm_chart/
---

::: tip Background
<img style="width:22px; height:22px" src="./_images/helm_chart/helm-chart.svg"></img> The Helm Chart template is suitable for projects deployed with Helm Chart, allowing users to deploy K8s applications more flexibly and efficiently.
:::
...
::: tip Tips
Refer to the code repository for supported code repository: [Code Source Information](/en/Zadig%20v5.0/settings/codehost/overview/#function-compatibility-list), and refer to the code repository integration: [code repository integration](/en/Zadig%20v5.0/settings/codehost/overview/)
:::

![Add Helm Chart template](./_images/helm_chart/create_helm_chart_template.png)
...
![Add Helm Chart template](./_images/helm_chart/helm_chart_template_variable.png)
...
> Turn on the `Automatic Synchronization` operation for the service. Refer to [the use template to create a new service](/en/Zadig%20v5.0/project/service/helm/chart/#create-a-new-service).
:::

![Apply to the service](./_images/helm_chart/apply_helm_template_to_service.png)

## Using Templates
When creating a new service in [the K8s Helm Chart project](/en/Zadig%20v5.0/project/helm-chart/), you can choose to import services from templates, and refer to [using templates to create a new service](/en/Zadig%20v5.0/project/service/helm/chart/#create-a-new-service).
