...
permalink: /en/Zadig v5.0/template/workflow/
---
...
<img src="./_images/workflow/workflow_template_310.png" width="400">
<img src="./_images/workflow/create_workflow_template_2.png" width="400">
...
![Save as a workflow template](./_images/workflow/save_as_template_workflow_01.png)

## Using Templates

To create a new workflow, you can manually configure it or use a workflow template with one click.

![Using workflow templates](./_images/workflow/use_workflow_template_01.png)
