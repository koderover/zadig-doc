...
permalink: /en/Zadig v5.0/template/build/
---
...
Go to `Assets` → `Templates` → `Build` to enter the build template management page. Click the `+` button, enter the template name, and refer to [Build Configuration](/en/Zadig%20v5.0/project/build/) to complete the configuration of the build template.
...
![Building templates](./_images/build/build_template_1.png)
...
Refer to [Using Build Templates](/en/Zadig%20v5.0/project/build/template/).