...
permalink: /en/Zadig v5.0/settings/shared-var/
---
...
- **System-level Shared Variables**: Click `System Settings` -> `Shared Variables` -> `Add`
- **Project-level Shared Variables**: Click Project -> `Configuration` -> `Shared Variables` -> `Add`

![shared_var_add](./_images/shared_var/shared_var_add.png)
