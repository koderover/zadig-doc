...
permalink: /en/Zadig v5.0/project/overview/
---
...
This article introduces the five types of projects supported by Zadig, how to quickly set them up, how to modify project basic information, how to group projects, and how to integrate system resources within a project.

## Project Types

Zadig supports the following five project types:
...
- `Agent Project`: Manage and publish agents; support registering external agents as well as building and publishing new agents.

## Quick Setup

See:

- [K8s YAML project](/en/Zadig%20v5.0/project/k8s-yaml/)
- [K8s Helm Chart project](/en/Zadig%20v5.0/project/helm-chart/)
- [K8s Managed project](/en/Zadig%20v5.0/project/host-k8s-resources/)
- [Freestyle project](/en/Zadig%20v5.0/project/vm/)
- [Agent Project](/en/Zadig%20v5.0/project/ai-agent/)
...
<img src="./_images/overview/update_project_basic_info_1_220.png" width="400">
<img src="./_images/overview/update_project_basic_info_2_220.png" width="400">
...
- `Access`: Choose `Public` or `Private` to define the default permissions for the project.
    - Public project: Users enjoy permissions in role `read-only` by default to view resources in the project. See [permission configuration](/en/Zadig%20v5.0/project/permission/#permission-configuration) for details of this role.
...
<img src="./_images/overview/project_group_config.png" width="400">
<img src="./_images/overview/project_group_config_1.png" width="400">
...
![System integration](./_images/overview/system_integration_in_project.png)

### Code Source

For specific integration parameters, see [Code Source Integration](/en/Zadig%20v5.0/settings/codehost/overview/).

### Host
> Suitable for Freestyle projects.

For specific integration parameters, see [Host Integration](/en/Zadig%20v5.0/settings/vm-management/#add-a-host).