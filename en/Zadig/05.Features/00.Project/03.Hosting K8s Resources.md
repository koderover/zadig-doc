...
permalink: /en/Zadig v5.0/project/host-k8s-resources/
---
...
<img src="./_images/Hosting-K8s-Resources/create_project_entrance_420.png" width="400">
<img src="./_images/Hosting-K8s-Resources/host_k8s_create_project_310.png" width="400">
...
2. For multi-cluster configuration, see [Cluster Management](/en/Zadig%20v5.0/pages/cluster_manage/).
:::

![Configure Hosting Project](./_images/Hosting-K8s-Resources/env_delegate_onboarding_1.png)

### Configure Service Build
The system automatically parses service components. Click `Add Build` to configure build settings. See [Build Configuration](/en/Zadig%20v5.0/project/build/).
...
![Configure Hosting Project](./_images/Hosting-K8s-Resources/env_delegate_on_boarding_2.png)
...
![Environment Overview](./_images/Hosting-K8s-Resources/env_delegate_enviroment_overview.png)
...
<img src="./_images/Hosting-K8s-Resources/env_delegate_service_details_0.png" width="400">
<img src="./_images/Hosting-K8s-Resources/env_delegate_service_details.png" width="400">
...
<img src="./_images/Hosting-K8s-Resources/env_delegate_start_pipeline_220.png" width="400">
<img src="./_images/Hosting-K8s-Resources/show_updated_host_service.png" width="400">
...
![Project Switching](./_images/Hosting-K8s-Resources/project_change_1.png)