...
permalink: /en/Zadig v5.0/project/vm/
---
...
<img src="./_images/VM/create_project_entrance_420.png" width="400">
<img src="./_images/VM/vm_onboarding_1_310.png" width="400">

### Configure Services
Click the `+` button to enter service name. Configure build, deployment, and health check settings.

> See [Host Service](/en/Zadig%20v5.0/project/service/vm/) for configuration details.

![Service configuration](./_images/VM/vm_onboarding_add_service_220.png)

### Create Environment

Create an environment and associate it with host resources.

![Join the environment](./_images/VM/vm_onboarding_3_220.png)

### Deploy via Workflow

Once environment and workflow are ready, click `Next` to select the dev environment workflow for service updates.

![Workflow delivery](./_images/VM/vm_onboarding_4_220.png)