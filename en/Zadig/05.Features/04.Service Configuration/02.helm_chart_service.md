---
title: K8s Helm Chart Service
date: 2022-03-17 22:12:20
permalink: /en/Zadig v5.0/project/service/helm/chart/
---
...
- `Sync from Code Repository` : Synchronize the service's configuration from the code base Helm Chart. For supported code sources, refer to [Code Source Information](/en/Zadig%20v5.0/settings/codehost/overview/#function-compatibility-list).
- `Import from Chart Repository`: Synchronize the service's Helm Chart configuration from the Chart repository.
...
::: tip
1. You need to integrate the code source in the system. For more information, refer to [Code Source Integration](/en/Zadig%20v5.0/settings/codehost/overview/)
2. For supported code sources, refer to [Code Source Information](/en/Zadig%20v5.0/settings/codehost/overview/#function-compatibility-list)
:::
...
![Import Helm Chart from Git Repository](./_images/helm_chart_service/helm_chart_from_git_repo.png)

Effect after synchronization:

![Effect of Importing Helm Chart from Git Repository](./_images/helm_chart_service/helm_service_from_repo_effect.png)

### Import Service from Chart Repository
::: tip Prerequisites
You need to integrate the Helm Chart repository first. For more information, refer to [Integrate Helm Chart Repository](/en/Zadig%20v5.0/settings/helm/).
:::

Click on "Import from Chart Repository", select the Chart repository and Chart, and create the service.
![Import Helm Chart from Chart Repository](./_images/helm_chart_service/helm_chart_from_chart_repo.png)

### Create a Single Service Using Templates
::: tip Prerequisites
You need to create a Helm Chart template in the system template library first. For more information, refer to [Helm Chart Template Management](/en/Zadig%20v5.0/template/helm_chart/)
:::
...
![Import Helm Chart from Git Repository](./_images/helm_chart_service/create_helm_chart_service_from_template.png)
...
![Import Helm Chart from Git Repository](./_images/helm_chart_service/create_helm_chart_service_from_template_2_420.png)
...
![Import Services from Helm Chart Template](./_images/helm_chart_service/create_helm_chart_service_from_template_in_bulk_0.png)
![Import Services from Helm Chart Template](./_images/helm_chart_service/create_helm_chart_service_from_template_in_bulk_1.png)
...
![Preview the Effect of Importing Services from Helm Chart Template](./_images/helm_chart_service/show_services_created_by_template_in_bulk.png)

## Service Version Rollback

Refer to [Service Version Rollback](/en/Zadig%20v5.0/project/service/versions/).

## Service Components

Refer to [Service Components](/en/Zadig%20v5.0/env/overview/#what-is-a-service-component#k8s-helm-chart-project).

![Helm Chart Service Component Customization](./_images/helm_chart_service/helm_chart_service_component_define.png)
...
![Customize Helm Release Name](./_images/helm_chart_service/k8s_helm_chart_release_rename.png)
...
![K8s Service Orchestration](./_images/helm_chart_service/k8s_helm_service_orchestration.png)
![K8s Service Orchestration](./_images/helm_chart_service/k8s_helm_service_orchestration_1.png)
...
![Update Helm Chart Service](./_images/helm_chart_service/helm_chart_service_update_2.png)
...
![Update Helm Chart Service](./_images/helm_chart_service/helm_chart_service_update_3.png)
...
![Update Helm Chart Service](./_images/helm_chart_service/helm_chart_service_update_4.png)
...
![Update Helm Chart Service](./_images/helm_chart_service/helm_chart_service_update_5.png)
...
![Delete Service](./_images/helm_chart_service/helm_chart_git_delete.png)

## Tag Management

By tagging services, you can quickly classify and search for service metadata. For more information, refer to [Tag Management](/en/Zadig%20v5.0/project/service/label/).

## Policy Configuration

![Service Policy Configuration](./_images/helm_chart_service/helm_service_strategy_config_410.png)
...
- `Delivery artifact naming rules`: For details, refer to [Policy configuration](/en/Zadig%20v5.0/project/service/k8s/#policy-configuration).
