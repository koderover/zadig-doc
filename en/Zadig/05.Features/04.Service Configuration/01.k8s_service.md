...
permalink: /en/Zadig v5.0/project/service/k8s/
---
...
![Create a New Service](./_images/k8s_service/service.png)
...
![Create a New Service](./_images/k8s_service/service_1.png)
...
![Update the Environment](./_images/k8s_service/service_4.png)

### Synchronize a Single Service from the Code Repository

::: tip
1. You need to integrate the code source in the system, refer to [Code Source Integration](/en/Zadig%20v5.0/settings/codehost/overview/)
...
![Sync New Service from Code Repository](./_images/k8s_service/sync_k8s_service_from_repo.png)

After synchronization, the effect is as follows:

![Sync New Service Effect from Code Repository](./_images/k8s_service/sync_k8s_service_from_repo_effect.png)
...
![Batch Sync New Services from Code Repository](./_images/k8s_service/sync_multi_k8s_service_from_repo.png)

After synchronization, the effect is as follows:

![Batch Sync New Service Effect from Code Repository](./_images/k8s_service/sync_multi_k8s_service_from_repo_effect.png)

### Create a New Service Using the Template

::: tip
You need to create K8s YAML templates in the system template library first, refer to [K8s YAML Template Management](/en/Zadig%20v5.0/template/k8s_yaml/).
:::
...
![Using K8s YAML Templates](./_images/k8s_service/use_k8s_yaml_template_1.png)
...
- Click `Add Service` and fill in the service name, select the resource type and corresponding configuration. Currently, deployment/statefulset/daemonset/cronjob/service/ingress/secret/configmap/pvc resources can be selected for import

![Import from K8s](./_images/k8s_service/create_k8s_service_from_k8s.png)
...
![Import from K8s](./_images/k8s_service/update_k8s_service_config_from_k8s.png)
...
![Modify the Service](./_images/k8s_service/service_5.png)
...
![Update Services in the Environment](./_images/k8s_service/service_4.png)

### Update Service Synchronized from the Code Repository

* Commit the service configuration changes to the code repository.

![Configuration Changes](./_images/k8s_service/service_upgrade_git.png)
...
![Manual Service Configuration Synchronization](./_images/k8s_service/service_upgrade_manual_update.png)
...
![Service Version Diff](./_images/k8s_service/service_upgrade_diff.png)
![Service Update](./_images/k8s_service/service_upgrade.png)
...
![Configuration Changes](./_images/k8s_service/update_service_created_by_template_1.png)

![Configuration Changes](./_images/k8s_service/update_service_created_by_template_2.png)
...
![Configuration Changes](./_images/k8s_service/update_service_created_by_template.png)
...
![Update Service Configuration](./_images/k8s_service/update_service_config_from_k8s.png)

## Delete Service

Click the delete button to the right of the service to delete the service.

![Delete the Service](./_images/k8s_service/delete_service.png)

## Service Version Rollback

Refer to the documentation: [Service Version Rollback](/en/Zadig%20v5.0/project/service/versions/).

## Service Components

![Service Components](./_images/k8s_service/k8s_container.png)

Reference Documentation: [Service Components](/en/Zadig%20v5.0/project/service/overview/#what-is-a-service-component).
...
![K8s Service Orchestration](./_images/k8s_service/k8s_service_orchestration.png)
![K8s Service Orchestration](./_images/k8s_service/k8s_service_orchestration_1.png)

## Tag Management

By tagging services, you can quickly classify and search for service metadata. For specific configuration and usage, refer to the [documentation](/en/Zadig%20v5.0/project/service/label/).

## Variable Configuration

Through variable configuration, you can share a single service configuration across multiple environments. For specific configuration and usage, refer to the [documentation](/en/Zadig%20v5.0/project/service/variable/).
...
![Service Policy Configuration](./_images/k8s_service/service_strategy_config.png)
