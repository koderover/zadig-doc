...
permalink: /en/Zadig v5.0/project/service/variable/
---
...
![variable](./_images/service_variable/var_500.png)

### System Built-in Variables
These include `$Namespace$`, `$Product$`, `$Service$`, `$EnvName$`, and `$ClusterName$`, which can be directly referenced in YAML. Specific descriptions are as follows:
...
- `$ClusterName$`: The name of the K8s cluster where the created environment is located
...
![variable](./_images/service_variable/var1.png)

### Global Variables
Click `Global Variable` to the right of the custom variable to configure it.

![variable](./_images/service_variable/public_var.png)
...
![variable](./_images/service_variable/public_var_1.png)
...
![New Environment Variable Rendering](./_images/service_variable/var_create_env.png)
...
<img src="./_images/service_variable/var_update_env.png" width="400">
<img src="./_images/service_variable/var_update_env_1.png" width="400">
...
<img src="./_images/service_variable/add_service_in_k8s_env_01.png" width="400">
<img src="./_images/service_variable/var_update_service.png" width="400">
...
- [Database Isolation](/en/Zadig%20v5.0/env/multi-env/#database-isolation)
- [Domain Name Differentiation](/en/Zadig%20v5.0/env/multi-env/#differentiated-domain-name-access)