...
permalink: /en/Zadig v5.0/project/service/vm/
---
...
![New Service](./_images/vm_service/service_vm_1_220.png)

### Build Configuration

For more details, refer to [Build Configuration](/en/Zadig%20v5.0/project/build/).
...
![Deployment Script](./_images/vm_service/service_vm_5_341.png)
...
Securely log into the target machine to perform deployment operations. You need to configure the host resources in the system in advance, refer to [Host Management](/en/Zadig%20v5.0/settings/vm-management/).
...
![Deployment Script](./_images/vm_service/vm_agent_name.png)
...
![Deployment Script](./_images/vm_service/vm_dev_host_ips.png)
...
![Deployment Script](./_images/vm_service/host_name_demo.png)
...
![Configure Liveness](./_images/vm_service/service_vm_6.png)
...
![Configure Start and Stop Commands](./_images/vm_service/service_vm_cmd_config.png)

Operate service start and stop in the environment.

![Execute Service Start and Stop](./_images/vm_service/service_vm_cmd.png)
...
![Update Service](./_images/vm_service/service_vm_8.png)
...
![Delete Service](./_images/vm_service/service_vm_10.png)

## Tag Management

By tagging services, you can quickly classify and search for service metadata. For specific configuration and usage, refer to [documentation](/en/Zadig%20v5.0/project/service/label/).

## Policy Configuration

Click `Policy` to set the timeout time for the deployment service and the delivery object naming rules. For details, refer to [Policy configuration](/en/Zadig%20v5.0/project/service/k8s/#policy-configuration).

![Policy Configuration](./_images/vm_service/vm_service_strategy_config.png)