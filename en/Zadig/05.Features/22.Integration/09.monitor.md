...
permalink: /en/Zadig v5.0/settings/monitor/
---
...
![guanceyun](./_images/monitor/config_guanceyun_system.png)

### 步骤 2：在 Zadig 上配置观测云

系统管理员依次访问 `系统设置` -> `系统集成` -> `监控系统`，添加观测云的相关信息，如下图所示。

![guanceyun](./_images/monitor/config_guanceyun_system_1.png)
...
在自定义工作流中配置`观测云监测` 任务即可使用观测云监测服务是否健康，参考文档：[观测云监测](/en/Zadig%20v5.0/project/workflow-jobs/#观测云监测)。 -->
...
<img src="./_images/monitor/config_grafana_system_320_1.png" width="400" />
<img src="./_images/monitor/config_grafana_system_320_2.png" width="400" />
<img src="./_images/monitor/config_grafana_system_320_3.png" width="400" />
<img src="./_images/monitor/config_grafana_system_320_4.png" width="400" />
...
![grafana](./_images/monitor/config_grafana_system_2.png)
...
Configure `Grafana Service Monitoring` in a custom workflow to use Grafana to monitor whether the service is healthy, refer to [Grafana Service Monitoring](/en/Zadig%20v5.0/project/workflow-jobs/#grafana-service-monitoring) .