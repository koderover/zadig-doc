...
permalink: /en/Zadig v5.0/settings/account/feishu/
---
...
1. Visit [Feishu Open Platform](https://open.feishu.cn/) and create an "Custom Apps," as shown below.

![lark](./_images/feishu/lark_account_1.png)

2. Configure the permission scope in permission management, as shown below.

![lark](./_images/feishu/lark_account_2.png)
...
![lark](./_images/feishu/lark_account_3.png)
