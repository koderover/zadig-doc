...
permalink: /en/Zadig v5.0/settings/account/github/
---
...
![GitHub](./_images/github/user_account_github.png)
...
See: [setting the default account system](/en/Zadig%20v5.0/settings/account/ldap/#optional-set-as-the-default-account-system).