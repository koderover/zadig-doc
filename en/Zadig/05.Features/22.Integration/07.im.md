...
permalink: /en/Zadig v5.0/settings/approval/
---
...
![approval](./_images/im/approval_1.png)
...
![approval](./_images/im/larkapp_config_420.png)
...
![im_bot](./_images/im/lark_im_bot_1.png)
...
![approval](./_images/im/approval_3.png)

5. Obtain the `App ID` and `App Secret`.

![approval](./_images/im/approval_4_420.png)
...
![approval](./_images/im/approval_6_420.png)
...
![common_workflow_config](./_images/im/dingtalk_app_config_1.png)
...
![common_workflow_config](./_images/im/dingtalk_app_config_3.png)
...
![common_workflow_config](./_images/im/dingtalk_app_config_2.png)
...
![common_workflow_config](./_images/im/dingtalk_app_config_4.png)

### Step 2: Integrate IM Application

Visit Zadig, click `System Settings` -> `Integrations` -> `IM`, and add the DingTalk approval application as shown below.

![approval](./_images/im/dingtalk_approval_config_220.png)
...
![common_workflow_config](./_images/im/dingtalk_app_config_5.png)
...
![common_workflow_config](./_images/im/dingtalk_app_config_6.png)
...
![approval](./_images/im/wx_11.png)
![approval](./_images/im/wx_12.png)

3. In the Zadig approval integration, fill in the `Token` and `EncodingAESKey` and save.

![approval](./_images/im/wx_13.png)
...
![approval](./_images/im/wx_14.png)
![approval](./_images/im/wx_15.png)

## Extended Reading

### Using Feishu Approval in Zadig

Refer to [Feishu approval](/en/Zadig%20v5.0/workflow/approval/#feishu-approval)

### Using Lark Approval in Zadig

Refer to [Lark approval](/en/Zadig%20v5.0/workflow/approval/#lark-approval)

### Using DingTalk Approval in Zadig

Refer to [DingTalk Approval](/en/Zadig%20v5.0/workflow/approval/#dingtalk-approval)


### Using WeChat Work Approval in Zadig

Refer to [WeChat Work Approval](/en/Zadig%20v5.0/workflow/approval/#enterprise-wechat-approval)