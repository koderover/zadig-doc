...
permalink: /en/Zadig v5.0/settings/codehost/github/
---
...
![github](./_images/github/github3.png)

The page will now display the complete `Client ID` and `Client Secret`.

![github](./_images/github/github4.png)
...
![github](./_images/github/github5.png)
...
![github](./_images/github/github6.png)
