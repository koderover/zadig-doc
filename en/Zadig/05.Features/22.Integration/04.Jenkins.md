...
permalink: /en/Zadig v5.0/settings/cicd/
---
...
![api-token](./_images/Jenkins/generate_jenkins_token_1.png)
![api-token](./_images/Jenkins/generate_jenkins_token_2.png)
...
![add-jenkins-server](./_images/Jenkins/add_jenkins_server_300.png)

You can then orchestrate Jenkins Job Execution tasks in the workflow. For more details, reference the documentation: [Jenkins Job Execution](/en/Zadig%20v5.0/project/workflow-jobs/#jenkins-job-execution).
