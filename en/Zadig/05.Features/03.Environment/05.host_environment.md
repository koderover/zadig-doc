...
permalink: /en/Zadig v5.0/project/env/k8s/host/
---
...
<img src="./_images/host_environment/create_host_env.png" width="400">
<img src="./_images/host_environment/create_host_env_1.png" width="400">

Parameter Explanation:

- `Environment Name`: Enter the environment name
- `K8s Cluster`: The Kubernetes cluster where the service to be hosted is located. Note: This cluster must be integrated into Zadig in advance. For details, refer to [Cluster Management](/en/Zadig%20v5.0/pages/cluster_manage)
...
<img src="./_images/host_environment/list_host_env.png" width="400">
<img src="./_images/host_environment/list_host_env_1.png" width="400">
...
![Change Record](./_images/host_environment/env_oplog_host.png)
...
![Configuration Management](./_images/host_environment/config_host_env.png)
