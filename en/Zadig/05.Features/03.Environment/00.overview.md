...
The information of the service component comes from the Deployment/StatefulSet/DaemonSet/CronJob/InitContainer resources in the service K8s YAML configuration. The following figure is an example:
...
3. Update service components by modifying the mirror information in the service configuration file and updating the service in the environment. See [Update service](/en/Zadig%20v5.0/project/env/service/#basic-information) .