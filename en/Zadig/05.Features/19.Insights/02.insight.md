...
permalink: /en/Zadig v5.0/stat/insight/
---
...
- **AI Efficiency Diagnostics**: Provides objective, actionable improvement recommendations through AI analysis. Refer to [AI Efficiency Diagnostics](/en/Zadig%20v5.0/ai/insight-analysis/).
...
![Performance Insight](./_images/insight/insight_overview_310.png)
...
![Performance Insight - Build](./_images/insight/build_insight_310.png)
...
![Performance Insight - Test](./_images/insight/test_insight_310.png)
...
![Performance Insight - Deployment](./_images/insight/deploy_insight_310.png)
...
![Performance Insight](./_images/insight/insight_config_220.png)
...
- **API Configuration**: Configures the API to retrieve data, with external system integration reference documentation: [External System](/en/Zadig%20v5.0/settings/others/)
...
![Performance Insight](./_images/insight/insight_config_1_220.png)
