...
permalink: /en/Zadig v5.0/project/build/share/
---
...
![Shared Build](./_images/share-build/share_build_config.png)
...
![Use Shared Build](./_images/share-build/how_to_use_share_build_config_220.png)

- You can also choose to reuse existing build configurations as needed to achieve build sharing when configuring services.

![Reuse Existing Build When Creating a New Service](./_images/share-build/share_build_when_create_service.png)
...
![Configure Workflow](./_images/share-build/share_build_workflow_config.png)