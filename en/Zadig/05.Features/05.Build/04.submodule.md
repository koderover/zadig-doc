...
permalink: /en/Zadig v5.0/project/build/submodule
---
...
![Enable Submodule](./_images/submodule/enable_submodule.png)
...
Copy the private key file prepared in the previous step to the `~/.ssh` path in the image runtime, build, and push the custom build image. For more details, refer to [Custom Image Management](/en/Zadig%20v5.0/settings/custom-image/).
