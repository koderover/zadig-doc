...
permalink: /en/Zadig v5.0/project/permission/
---
...
- Project Roles: Project-level permission configuration, refer to [Project Roles](#project-roles)
...
System roles include built-in roles and custom roles.

### Built-in Roles
- `admin`: System administrator. Can operate all resources in the system and modify system settings.
- `global-read-only`: System-wide read-only role. Can view all projects and resources in the system (except system settings).

### Custom Roles

System administrators can define custom roles and assign permissions in `System Roles`.

Click on the avatar in the upper right corner > User Management > System Role to configure.

![Permission Management](./_images/permission/system_role_420.png)

System roles can be specified in user information.

![Permission Management](./_images/permission/system_role_1.png)

## Project Access Permissions

System administrators or project administrators can click Configure > Modify > Edit Access Permissions to set the public/private attributes of the project. The differences are:
...
<img src="./_images/permission/project_permission_config.png" width="400">
<img src="./_images/permission/update_project_basic_info_2.png" width="400">
...
![Project Permission Configuration](./_images/permission/project_permission_config.png)

### Member Management

In `Member Management`, view the user member list and corresponding roles of the project, and configure user roles as needed.

- Roles are a collection of permissions, in [role management](/en/Zadig%20v5.0/project/permission/#role-management) , you can view permission details in roles
- Support adding user groups to project members to implement permission configuration for batch users

![View Project Member List](./_images/permission/project_member_list.png)

### Role Management
Includes built-in roles and custom roles.
...
![View read-only Permissions](./_images/permission/read_only_permission.png)

#### Custom Roles

In `Role Management`, you can customize roles and assign permissions.

![Project Role List](./_images/permission/project_role_list.png)

### Permission List

Describes the correspondence between each permission item and function. For the complete functional documents in each functional module, refer to [Workflow](/en/Zadig%20v5.0/project/workflow-config/) / [Environment](/en/Zadig%20v5.0/project/env/k8s) / [Service](/en/Zadig%20v5.0/project/service/k8s/) / [Build](/en/Zadig%20v5.0/project/build/) / [Test](/en/Zadig%20v5.0/project/test/) / [Version Management](/en/Zadig%20v5.0/project/version/) / [Code Scan](/en/Zadig%20v5.0/project/scan/).
...
<table>
	...
	<tr>
		<td>Configure</td>
		<td>- Update environment variables (K8s YAML projects), update global variables (K8s Helm Chart projects)<br>- Configure hosting (K8s hosted projects)<br>- Enable/disable self-test mode<br>- Environment sleep and wake<br>- Add/update/delete services<br>- Edit environment configuration (Ingress/ConfigMap/Secret/PVC), delete environment configuration<br>- View environment change records</td>
	</tr>
	<tr>
		<td>Delete</td>
	...
	<tr>
		...
		<td>- Replace service instance images, start container debugging<br>- Update service instances<br>- Host service start/stop</td>
	</tr>
	<tr>
		<td>Service Debug</td>
	...
	<tr>
		<td>Restart</td>
		<td>- Restart service instances</td>
	</tr>
	<tr>
		<td>Rollback</td>
		<td>- Roll back service versions and environment configuration versions</td>
	</tr>
	<tr>
		<td>Scale Replicas</td>
		<td>- Adjust service instance replica count</td>
	</tr>
	<tr>
...
![Collaboration Mode Management](./_images/permission/collaboration_mode_config.png)

Configuration instructions:

- Fill in the name of the collaboration mode, such as `developer`.
- Select participating members, only project members can be selected. If the users who need to be added are not in the member list, they can be added in [member management](/en/Zadig%20v5.0/project/permission/#member-management) .
...
![Collaboration Mode Management](./_images/permission/collaboration_mode_config_2.png)
...
![Collaboration Mode Management](./_images/permission/collaboration_mode_config_3.png)