...
permalink: /en/Zadig v5.0/release/plan/
---
...
Release plans support two views: list view and calendar view. The calendar view provides a clearer schedule overview.

![Release Plan](./_images/release-plan/release_plan_calendar_view.png)

## Planning
Release Management -> Release Plan: Create a new release plan, fill in the details, and save it as a draft. This feature supports multi-person collaboration for planning the release.

<img src="./_images/release-plan/release_plan_1.png" width="400">
<img src="./_images/release-plan/release_plan_2.png" width="400">
...
- `Approval Configuration`: Configure approval as needed, supporting three methods: Zadig, Feishu, and DingTalk
    - `Zadig` : The approval application will be sent to the email address corresponding to the account Zadig For specific approval configuration, please refer to the document [Zadig](/en/Zadig%20v5.0/workflow/approval/#zadigx-%E5%AE%A1%E6%89%B9/)
    - `Feishu` : The approval application will be sent to Feishu. For specific approval configuration, please refer to the document [Feishu for approval.](/en/Zadig%20v5.0/workflow/approval/%E9%A3%9E%E4%B9%A6%E5%AE%A1%E6%89%B9/)
    - `Dingtalk` : The approval application will be sent to DingTalk. For specific approval configuration, please refer to the document [DingTalk approval.](/en/Zadig%20v5.0/workflow/approval/%E9%92%89%E9%92%89%E5%AE%A1%E6%89%B9/)
...
![Release Plan](./_images/release-plan/release_plan_3.png)
...
![Release Plan](./_images/release-plan/release_plan_4.png)
...
<img src="./_images/release-plan/release_plan_5.png" width="400">
<img src="./_images/release-plan/release_plan_6.png" width="400">
...
The system keeps a detailed record of the release plan's operation logs, including information changes. Click `Operation Record` to view them.

![Release Plan](./_images/release-plan/release_plan_7.png)
...
| `manager`       | string         | Release task owner                                                                                                                                                                                                           |
| `manager_id`    | string         | Release task owner ID                                                                                                                                                                                                        |
...
| `executed_time` | int            | Execution time                                                                                                                                                                                                               |
...
| `tapd`                   | [WorkflowTapdJobSpec](#hook-workflow-tapd-job-spec)                        | Tapd job Spec             |
...
<h4 id="hook-workflow-tapd-job-spec">WorkflowTapdJobSpec Parameter Description</h4>
...
| `source_status` | string                                  | Source status, optional values: open/done |
| `status`        | string                                  | Target status, optional values: open/done |
| `iterations`    | [][Iteration](#hook-workflow-iteration) | Iteration list                           |

<h4 id="hook-workflow-iteration">Iteration Parameter Description</h4>
...
| `result`          | string | Result, enum values: success, failed, executing                       | Yes      | None    |
| `failed_reason`   | string | Failed reason                                                         | No       | None    |
| `description`     | string | Description, used when result is executing                            | No       | None    |
