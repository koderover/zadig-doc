...
permalink: /en/Zadig v5.0/project/version/
---
...
<img alt="版本交付" title="Version delivery" src="./_images/version/k8s_version_detail_220.png">
...
<img src="./_images/version/version_delivery_yaml_5.png" width="400">
<img src="./_images/version/version_delivery_yaml_6.png" width="400">
<img src="./_images/version/version_delivery_yaml_7.png" width="400">
...
<img alt="版本交付" title="Version delivery" src="./_images/version/version_select.png">
...
![Version delivery](./_images/version/version_delivery_helm_1.png)

- Enter the version creation process. The first step is to fill in the basic information.

![Version delivery](./_images/version/version_delivery_helm_2.png)
...
![Version delivery](./_images/version/version_delivery_helm_3_400.png)
...
![Version delivery](./_images/version/version_delivery_helm_3_1.png)
...
> Helm Repo needs to be integrated in advance, refer to [Helm Repo](/en/Zadig%20v5.0/settings/helm/#how-to-integrate) for specific configuration.<br> When configuring the image Tag , if one Chart including multiple [service components](/en/Zadig%20v5.0/project/service/overview/#what-is-a-service-component) , `Apply All` can be used to quickly set the image of all service components Tag .

![Version delivery](./_images/version/version_delivery_helm_4.png)
...
![Version delivery](./_images/version/version_delivery_helm_5.png)

### Version Release

- Execute the "Deployment" task in the workflow, select a version, and deploy all service **images** contained in the version to the specified environment.

<img src="./_images/version/version_delivery_helm_6.png" width="400">
<img src="./_images/version/version_delivery_helm_7.png" width="400">
<img src="./_images/version/version_delivery_helm_8.png" width="400">
...
<img src="./_images/version/version_delivery_helm_9.png" width="400">
<img src="./_images/version/version_delivery_helm_10.png" width="400">
<img src="./_images/version/version_delivery_helm_11.png" width="400">
...
1. Integrate external systems. For specific integration methods, refer to [Other External Systems Integration](/en/Zadig%20v5.0/settings/others/).
2. In the Project - Version Management, enable `Hook Configuration` as shown in the figure below.

![Hook configuration](./_images/version/hook_config.png)
