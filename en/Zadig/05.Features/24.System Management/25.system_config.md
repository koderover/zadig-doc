...
permalink: /en/Zadig v5.0/settings/system-settings/
---
...
![system_webhook](./_images/system_config/system-webhook-en.jpg)
...
| --- | --- | --- | --- | --- |
| `object_kind` | string | Object type. Currently fixed as `workflow`. | None | Yes |
| `event` | string | Event name. Currently supported: `start_execute`, `complete_execute`. | None | Yes |
| `workflow` | [Workflow](#workflow) | Workflow task details. | None | Yes |
| `release_plan` | null | Release plan event field. It is always `null` for workflow events. | `null` | Yes |

<h4 id="workflow">Workflow Fields</h4>

| Field | Type | Description | Default Value | Is it Required |
| --- | --- | --- | --- | --- |
| `task_id` | int | Workflow task ID. | None | Yes |
| `project_name` | string | Project identifier. | None | Yes |
| `project_display_name` | string | Project display name. | None | Yes |
| `workflow_name` | string | Workflow identifier. | None | Yes |
| `workflow_display_name` | string | Workflow display name. | None | Yes |
| `release_plan` | [WorkflowReleasePlan](#workflow-release-plan) | Release plan information when the workflow is triggered by a release plan; otherwise omitted. | None | No |
| `status` | string | Current task status. | None | Yes |
| `remark` | string | Execution remark. | None | Yes |
| `detail_url` | string | Link to the task details page. | None | Yes |
| `error` | string | Error message. | None | Yes |
| `create_time` | int | Task creation time. | None | Yes |
| `start_time` | int | Task start time. | None | Yes |
| `end_time` | int | Task end time. | None | Yes |
| `stages` | array | Stage and job details. | None | Yes |
| `task_creator` | string | Task creator name. | None | Yes |
| `task_creator_id` | string | Task creator ID. | None | Yes |
| `task_creator_email` | string | Task creator email. | None | Yes |
| `task_type` | string | Task type. Currently `workflow`. | None | Yes |

<h4 id="workflow-release-plan">WorkflowReleasePlan Fields</h4>

| Field | Type | Description | Default Value | Is it Required |
| --- | --- | --- | --- | --- |
| `id` | string | Release plan ID. | None | Yes |
| `name` | string | Release plan name. | None | Yes |
| `index` | int | Release plan index. | None | Yes |
