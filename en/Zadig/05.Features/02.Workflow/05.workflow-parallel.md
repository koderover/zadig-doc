...
permalink: /en/Zadig v5.0/workflow/parallel/
---
...
::: tip
Zadig workflow execution concurrency depends on system resource limits. Administrators need to set reasonable [task concurrency settings](/en/Zadig%20v5.0/settings/system-settings/#task-concurrency-settings) in system settings.
:::
...
![Workflow Concurrent Configuration](./_images/workflow-parallel/workflow_parallel_3.png)
...
![Workflow Execution Order](./_images/workflow-parallel/workflow_parallel_2.png)
...
![Workflow Concurrent Configuration](./_images/workflow-parallel/workflow_parallel_4.png)
...
![工作流并发配置](./_images/workflow-parallel/workflow_parallel_1.png)
