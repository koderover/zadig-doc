...
permalink: /en/Zadig v5.0/workflow/approval/
---
...
![common_workflow_config](./_images/workflow-approval/approval_job_config_500.png)
...
![common_workflow_config](./_images/workflow-approval/zadig_approval_result_310.png)

## Feishu Approval

::: tip
**Prerequisites**: Before using Feishu approval, you need to integrate the Feishu approval application in the system. For details, refer to [Integrated Feishu Approval](/en/Zadig%20v5.0/settings/approval/#feishu).
...
![common_workflow_config](./_images/workflow-approval/config_lark_approval_1_500.png)

Parameter Description:
- `Approval Title`: Support customizing the approval title
...
1. To configure a mobile phone number, refer to [Account Information](/en/Zadig%20v5.0/preferences/#account-settings).
...
![common_workflow_config](./_images/workflow-approval/lark_approval_effect_500.png)

The approval information will be synchronized to the workflow:

![common_workflow_config](./_images/workflow-approval/lark_approval_effect_1_500.png)

## DingTalk Approval

::: tip
Before turning on DingTalk approval, you need to integrate DingTalk approval application in the system. For details, refer to [Integrated DingTalk Approval](/en/Zadig%20v5.0/settings/approval/#dingtalk).
:::
...
![common_workflow_config](./_images/workflow-approval/workflow_dingtalk_approval_config_500.png)
...
![common_workflow_config](./_images/workflow-approval/dingtalk_approval_effect.png)

The approval information will be synchronized to the workflow:
![common_workflow_config](./_images/workflow-approval/dingtalk_approval_effect_1_310.png)


## Enterprise WeChat Approval

::: tip
Before starting Enterprise WeChat approval, you need to integrate Enterprise WeChat approval applications in the system. For details, refer to [Integrated Enterprise WeChat Approval](/en/Zadig%20v5.0/settings/approval/#enterprise-wechat).
:::
...
![common_workflow_config](./_images/workflow-approval/workflow_qw_approval_config_500.png)
...
![common_workflow_config](./_images/workflow-approval/qw_approval_effect.png)

The approval information will be synchronized to the workflow:
![common_workflow_config](./_images/workflow-approval/qw_approval_effect_1_310.png)
