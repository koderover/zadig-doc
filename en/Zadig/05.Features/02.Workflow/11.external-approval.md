...
permalink: /en/Zadig v5.0/workflow/external-approval/
---
...
Refer to the [creation of a pre-approval form OpenAPI](/en/Zadig%20v5.0/api/workflow/) documentation to submit approval data to the Zadig system.
...
![Start Pre-approval](./_images/external-approval/enable_external_approval.png)
...
![Execute Workflow](./_images/external-approval/external_approval_execute.png)
