...
permalink: /en/Zadig v5.0/project/release-workflow/
---
...
<img src="./_images/workflow-deploy-strategy/mse_gray_deploy.png" width="400">
...
**MSE Grayscale Service Offline Task**
...
<img src="./_images/workflow-deploy-strategy/mse_gray_1.png" width="400">
<img src="./_images/workflow-deploy-strategy/mse_gray_2.png" width="400">
...
- `Gray Scale Mark`: Set grayscale marks, and resources with these grayscale marks will be automatically deleted during subsequent MSE Grayscale Service Offline
...
Add the "MSE Grayscale Service Offline" task to the workflow and configure the grayscale environment.

<img src="./_images/workflow-deploy-strategy/mse_gray_offline_1.png" width="400">
<img src="./_images/workflow-deploy-strategy/mse_gray_offline.png" width="400">
...
![Configure Workflow](./_images/workflow-deploy-strategy/run_mse_workflow.png)
...
<img src="./_images/workflow-deploy-strategy/mse_detail.png" width="350">
<img src="./_images/workflow-deploy-strategy/mse_detail_1.png" width="450">

#### MSE Grayscale Service Offline

After the grayscale service is verified correctly, start the workflow and execute the MSE Grayscale Service Offline task. Select the grayscale mark that needs to be offline to automatically remove the corresponding grayscale service.

<img src="./_images/workflow-deploy-strategy/mse_offline.png" width="400">
<img src="./_images/workflow-deploy-strategy/mse_offline_1.png" width="400">
...
![Create New Workflow](./_images/workflow-deploy-strategy/release_workflow_blue_green_1_310.png)

2. Configure the Blue-Green Environment Deployment task. Select the "Blue-Green Environment Deployment" task and configure it.

![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_blue_green_2_310.png)
...
![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_blue_green_2_0.png)
...
![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_blue_green_3_310.png)

4. Configure the approval task.

![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_blue_green_4_310.png)

5. Configure the blue-green release task. Select the "Blue-Green Release" task and configure it.

![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_blue_green_5_310.png)

Parameter Description:
- `Select "Blue-Green Environment Deployment" Task`: Select the preceding Blue-Green Environment Deployment task
...
![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_blue_green_7.png)
...
<img src="./_images/workflow-deploy-strategy/release_workflow_blue_green_9.png" width="400">
<img src="./_images/workflow-deploy-strategy/release_workflow_blue_green_9_0.png" width="400">

- You can view the blue-green service details in the environment.

<img src="./_images/workflow-deploy-strategy/release_workflow_blue_green_10.png" width="400">
<img src="./_images/workflow-deploy-strategy/release_workflow_blue_green_11.png" width="400">
...
![Create New Workflow](./_images/workflow-deploy-strategy/release_workflow_canary_1_310.png)

2. Configure the Canary Environment Deployment task. Select the "Canary Environment Deployment" task and configure it.

![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_canary_2_310.png)
...
![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_canary_3_310.png)

4. Configure the approval task.

![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_canary_4_310.png)

5. Configure the canary release task. Select "Canary Release" and configure it.

![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_canary_5_310.png)
...
<img src="./_images/workflow-deploy-strategy/release_workflow_canary_8.png" width="400">
<img src="./_images/workflow-deploy-strategy/release_workflow_canary_9.png" width="400">
...
![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_canary_11.png)
...
![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_canary_13.png)
...
<img src="./_images/workflow-deploy-strategy/release_workflow_gray_1.png" width="400">
<img src="./_images/workflow-deploy-strategy/release_workflow_gray_2.png" width="400">
...
![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_gray_3.png)
...
![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_gray_4.png)

- The workflow executes according to the set tasks, and the execution status is shown below.

![Execute Workflow](./_images/workflow-deploy-strategy/release_workflow_gray_6.png)
...
<img src="./_images/workflow-deploy-strategy/release_workflow_gray_rollback_1.png" width="400">
<img src="./_images/workflow-deploy-strategy/release_workflow_gray_rollback_2.png" width="400">
...
<img src="./_images/workflow-deploy-strategy/release_workflow_gray_rollback_3.png" width="400">
<img src="./_images/workflow-deploy-strategy/release_workflow_gray_rollback_4.png" width="400">

- The workflow executes according to the set tasks, and the execution status is shown below.

![Execute Workflow](./_images/workflow-deploy-strategy/release_workflow_gray_rollback_5.png)
...
<img src="./_images/workflow-deploy-strategy/release_workflow_istio_1.png" width="400">
<img src="./_images/workflow-deploy-strategy/release_workflow_istio_2.png" width="400">
...
![Configure Workflow](./_images/workflow-deploy-strategy/release_workflow_istio_3.png)
...
![Execute Workflow](./_images/workflow-deploy-strategy/release_workflow_istio_5.png)

- The workflow executes according to the set tasks, and the execution status is shown below.

![Execute Workflow](./_images/workflow-deploy-strategy/release_workflow_istio_6.png)

## Istio Rollback

If an unexpected interrupt occurs during the Istio release process or needs to roll back to the state before release, you can use the "Istio Rollback" task.

### How It Works

- Clean up the destination rule named <span v-pre>`<workload_name>-zadig`</span>
...
- In any case, attempt to delete the deployment named <span v-pre>`<workload_name>-zadig-copy`</span>

### How to Use
#### Configure Istio Rollback
1. Edit the workflow and add the "Istio Rollback" task: Click "+ Task", select the "Istio Rollback" task, and configure it.

<img src="./_images/workflow-deploy-strategy/release_workflow_istio_rollback_1.png" width="400">
<img src="./_images/workflow-deploy-strategy/release_workflow_istio_rollback_2.png" width="400">
...
#### Perform Istio Rollback

- Click the "Execute" button and select the container that needs to be rolled back.

![Execute Workflow](./_images/workflow-deploy-strategy/release_workflow_istio_rollback_3.png)

- The workflow executes according to the set tasks, and the execution status is shown below.

![Execute Workflow](./_images/workflow-deploy-strategy/release_workflow_istio_rollback_5.png)