...
| Agent | AI Release Specialist | Perform AI risk analysis based on change and release context, and output conclusions and recommendations | [Check](/en/Zadig%20v5.0/project/workflow-jobs/#ai-release-specialist) |
|  | AI Task | Connect to a custom Agent or AI model and automatically execute intelligent tasks based on the prompt | [Check](/en/Zadig%20v5.0/project/workflow-jobs/#ai-task) |
