...
permalink: /en/Zadig v5.0/test/apipost/
---
...
<img src="./_images/apipost/apipost_demo_cmd_300.png" width="400">
<img src="./_images/apipost/apipost_demo_cmd_1_300.png" width="400">
...
![Apipost](./_images/apipost/add_node_for_testdemo.png)
...
<img src="./_images/apipost/apipost_demo_2_300.png" width="400">
<img src="./_images/apipost/apipost_demo_3_300.png" width="400">
...
Refer to [Notification Configuration](/en/Zadig%20v5.0/project/test/#%E9%80%9A%E7%9F%A5%E9%85%8D%E7%BD%AE).
...
![Apipost](./_images/apipost/apipost_im_demo.png)

## Test Report Analysis

Click the test results link in the IM notification to view and analyze the test report.

![Apipost](./_images/apipost/apipost_im_demo_1.png)

## Test Left Shift

Configure workflows to orchestrate build, deployment (development environment), and testing tasks. Refer to [Workflows](/en/Zadig%20v5.0/project/workflow-config/).

![Apipost](./_images/apipost/apipost_left_test_demo_0.png)
...
<img src="./_images/apipost/apipost_left_test_demo_2.png" width="400">
<img src="./_images/apipost/apipost_left_test_demo.png" width="400">