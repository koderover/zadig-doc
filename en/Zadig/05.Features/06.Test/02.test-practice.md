...
permalink: /en/Zadig v5.0/test/practice/
...
The Zadig system has a built-in JMeter application that can be used directly. If the built-in version does not meet your automated testing needs, refer to [Software Package Management](/en/Zadig%20v5.0/settings/app/) to add the required version. This example uses JMeter 5.4.3.
...
![jMeter Practice](./_images/test-practice/jmeter_test_demo_0.png)
...
![jMeter Practice](./_images/test-practice/jmeter_test_demo_1_300.png)
![jMeter Practice](./_images/test-practice/jmeter_test_demo_2_300.png)
...
![jMeter Practice](./_images/test-practice/run_jmeter_test_220.png)
...
![jMeter Practice](./_images/test-practice/jmeter_test_demo_3_300.png)

Interpret the downloaded test report to view the results of the load test and analyze performance bottlenecks.

![jMeter Practice](./_images/test-practice/jmeter_test_demo_5.png)
![jMeter Practice](./_images/test-practice/jmeter_test_demo_4.png)
...
The Zadig system has built-in Ginkgo and Go applications that can be used directly. If the built-in versions do not meet your automated testing needs, refer to [Software Package Management](/en/Zadig%20v5.0/settings/app/) to add the required versions. This example depends on Go 1.16 and Ginkgo 2.0.0, and the configuration is as follows.
...
![ginkgo Practice](./_images/test-practice/ginkgo_test_demo_0_330.png)
![ginkgo Practice](./_images/test-practice/ginkgo_test_demo_0_1_330.png)
...
![ginkgo Practice](./_images/test-practice/ginkgo_test_demo_1_330.png)
...
![ginkgo Practice](./_images/test-practice/run_ginkgo_test_300.png)
...
![ginkgo Practice](./_images/test-practice/ginkgo_test_demo_3_300.png)
![ginkgo Practice](./_images/test-practice/ginkgo_test_demo_4_300.png)
...
To execute Pytest, Python needs to be installed in the environment. In Zadig, configure a custom image by referring to [Custom Image Management](/en/Zadig%20v5.0/settings/custom-image/).
...
![pytest Practice](./_images/test-practice/pytest_demo_0.png)

### Configuring Automated Testing

![pytest Practice](./_images/test-practice/pytest_demo_1_300.png)
![pytest Practice](./_images/test-practice/pytest_demo_2_300.png)
...
![pytest Practice](./_images/test-practice/pytest_demo_3_300.png)

### Analyzing the Test Report

After the automated test is completed, click to view the test report to see the execution details of each test case and quickly filter and analyze failed test cases.

![pytest Practice](./_images/test-practice/pytest_demo_4_300.png)
![pytest Practice](./_images/test-practice/pytest_demo_5_300.png)