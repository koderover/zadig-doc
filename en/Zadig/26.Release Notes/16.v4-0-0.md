...
permalink: /en/Zadig v4.2/release-notes/v4.0.0/
---

Zadig v4.0.0 was released on August 29, 2025.
...
If the current system version < v3.4.1, please upgrade to v3.4.1 first. For specific upgrade steps, please refer to [v3.4.1 Upgrade Method](/en/Zadig%20v4.0/release-notes/v3.4.1/#version-upgrade-process), and then upgrade to v4.0.0 using the following method.
:::
