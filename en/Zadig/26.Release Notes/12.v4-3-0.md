...
permalink: /en/Zadig v5.0/release-notes/v4.3.0/
---
...
If the current system version < v4.2.1, please upgrade to v4.2.1 first. For specific upgrade steps, please refer to [v4.2.1 Upgrade Method](/en/Zadig%20v5.0/release-notes/v4.2.1/#version-upgrade-process), and then upgrade to v4.3.0 using the following method.
:::
