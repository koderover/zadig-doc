...
permalink: /en/Zadig v5.0/test-manual/
---
...
SonarQube example: Add code scanning, specify `SonarQube` scanning tool, configure codebase to scan, scan scripts, and enable quality gate inspection. See: [Code Scan](/en/Zadig%20v5.0/project/scan/#%E6%96%B0%E5%BB%BA%E4%BB%A3%E7%A0%81%E6%89%AB%E6%8F%8F).

<img src="./_images/test_manual/daily_admin_17.png" width="400">
<img src="./_images/test_manual/daily_admin_18.png" width="400">

2. Configure code change triggers in code scan. See: [Trigger configuration](/en/Zadig%20v5.0/project/scan/#%E8%A7%A6%E5%8F%91%E5%99%A8%E4%B8%8E%E9%80%9A%E7%9F%A5).
![Test Management Operation Manual](./_images/test_manual/daily_admin_19.png)

#### How to Orchestrate

Edit workflow and add `Code Scan` task at specified stage (e.g., before building) to integrate code scanning into workflow.

![Test Management Operation Manual](./_images/test_manual/test_manual_0_220.png)
...
1. Add new test, configure basic information, code information, and test scripts, specify report directory in test report configuration. See: [Testing](/en/Zadig%20v5.0/project/test/).

<img src="./_images/test_manual/daily_admin_20.png" width="400">
<img src="./_images/test_manual/daily_admin_21.png" width="400">

2. Configure code change triggers in tests. See: [Trigger configuration](/en/Zadig%20v5.0/project/test/#webhook-%E8%A7%A6%E5%8F%91%E5%99%A8).
![Test Management Operation Manual](./_images/test_manual/daily_admin_22.png)

3. Configure IM notifications in test. See: [Notifications Configuration](/en/Zadig%20v5.0/project/test/#%E9%80%9A%E7%9F%A5%E9%85%8D%E7%BD%AE).
![Test Management Operation Manual](./_images/test_manual/test_manual_1.png)

#### How to Orchestrate

Edit workflow and add `Test` task at specified stage (e.g., after deployment).

<img src="./_images/test_manual/test_manual_2_220.png" width="400">
<img src="./_images/test_manual/test_manual_3_220.png" width="400">
...
#### How to Configure
Configuration process is similar to unit testing. See: [Configure tests in Zadig](/en/Zadig%20v5.0/test-manual/#%E5%A6%82%E4%BD%95%E9%85%8D%E7%BD%AE-2)

#### How to Orchestrate

Edit workflow, add `Test` tasks, specify task type as `Service Test`. See: [Workflow test configuration](/en/Zadig%20v5.0/project/workflow-jobs/#%E6%B5%8B%E8%AF%95%E4%BB%BB%E5%8A%A1).
![Test Management Operation Manual](./_images/test_manual/daily_admin_23.png)
...
Edit workflow, add `Test` tasks, specify task type as `Product Test`. See: [Workflow test configuration](/en/Zadig%20v5.0/project/workflow-jobs/#%E6%B5%8B%E8%AF%95%E4%BB%BB%E5%8A%A1).
![Test Management Operation Manual](./_images/test_manual/product_test_demo.png)
...
<img src="./_images/test_manual/test_manual_4.png" width="300">
<img src="./_images/test_manual/test_manual_5.png" width="300">
<img src="./_images/test_manual/test_manual_6.png" width="300">
### Testing Stage

> Process: Static Scan (Quality Gate Enabled) > Build > Deploy > Automated Testing > IM Notification

Zadig can quickly set up independent development and testing environments. See: [New Environment](/en/Zadig%20v5.0/project/env/k8s/#%E6%96%B0%E5%BB%BA%E7%8E%AF%E5%A2%83). By integrating test orchestration into the workflow, you can build automated test suites in both the development and testing environments, and incorporate testing capabilities into every aspect of the team's daily collaboration:
...
![Test Management Operation Manual](./_images/test_manual/test_manual_7.png)
...
<img src="./_images/test_manual/test_manual_8_220.png" width="400">
<img src="./_images/test_manual/test_manual_9_220.png" width="400">
...
![Test Management Operation Manual](./_images/test_manual/test_manual_10.png)
...
2. Flexibly orchestrate release strategies such as MSE Grayscale, Blue-Green, Canary, Gradual Rollout, and Istio to ensure reliable releases. See: [Release Strategies](/en/Zadig%20v5.0/project/release-workflow/).
3. Add manual approval from the testing team during the release phase to ensure compliance in the business process.

<img src="./_images/test_manual/test_manual_11.png" width="400">
<img src="./_images/test_manual/test_manual_12.png" width="400">
...
![Test Management Operation Manual](./_images/test_manual/zadig_manual_datasight_220.png)
