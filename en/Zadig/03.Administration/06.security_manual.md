...
permalink: /en/Zadig v5.0/security-manual/
---
...
Add new code scan, select `SonarQube` scanning tool, and fill in code scanning configuration. See: [Code Scanning](/en/Zadig%20v5.0/project/scan/).

![Security Service Access Manual](./_images/security_manual/security_manual_0_220.png)

**Step 2: Orchestrate Code Scanning in Workflow**

Edit workflow and add code scanning task at specified stage (e.g., before build task). See: [Configure Workflow](/en/Zadig%20v5.0/project/workflow-config/).

![Security Service Access Manual](./_images/security_manual/security_manual_1_220.png)

### Software Composition Analysis SCA - Fortify

**Step 1: Build Custom Image**

1. Build custom image and upload to image registry. See: [Custom Image](/en/Zadig%20v5.0/settings/custom-image/#%E6%AD%A5%E9%AA%A4-1-%E7%94%9F%E6%88%90%E8%87%AA%E5%AE%9A%E4%B9%89%E9%95%9C%E5%83%8F).
2. Add custom image in Zadig. See: [Add custom image](/en/Zadig%20v5.0/settings/custom-image/#%E6%AD%A5%E9%AA%A4-2-%E5%88%9B%E5%BB%BA%E8%87%AA%E5%AE%9A%E4%B9%89%E9%95%9C%E5%83%8F).

![Security Service Access Manual](./_images/security_manual/fortify_demo_220.png)

**Step 2: Configure SCA Scan**

Add new `test` and complete specific configuration for Fortify SCA code scanning. Relevant parameters explained below. For detailed information, see: [Test](/en/Zadig%20v5.0/project/test/).
...
<img src="./_images/security_manual/fortify_demo1.png" width="400">
<img src="./_images/security_manual/fortify_demo2.png" width="400">

**Step 3: Orchestrate SCA Scan**

Orchestrate SCA scan in workflow. See: [Orchestrate tasks](/en/Zadig%20v5.0/project/workflow-jobs/#%E6%B5%8B%E8%AF%95%E4%BB%BB%E5%8A%A1).

<img src="./_images/security_manual/fortify_demo4.png" width="400">
<img src="./_images/security_manual/fortify_demo5.png" width="400">

Run workflow. After Fortify SCA execution completes, download scan results for analysis.

![Security Service Access Manual](./_images/security_manual/fortify_demo8.png)
...
::: tip
Flexibly use Zadig service variable capability in service YAML configuration content, and control whether to install Agent for service on demand. See: [Service variables](/en/Zadig%20v5.0/project/service/k8s/#%E5%8F%98%E9%87%8F%E9%85%8D%E7%BD%AE).
:::
...
Deploy the injected IAST Agent service to the environment. See: [Add service](/en/Zadig%20v5.0/project/env/k8s/#%E6%B7%BB%E5%8A%A0%E6%9C%8D%E5%8A%A1).

![Security Service Access Manual](./_images/security_manual/security_manual_2_220.png)
...
<img src="./_images/security_manual/security_manual_3_220.png" width="400">
<img src="./_images/security_manual/security_manual_4_220.png" width="400">
...
<img src="./_images/security_manual/security_manual_25.png" width="400">
<img src="./_images/security_manual/security_manual_6.png" width="400">
...
![Security Service Access Manual](./_images/security_manual/security_manual_7.png)
![Security Service Access Manual](./_images/security_manual/security_manual_8.png)
...
![Security Service Access Manual](./_images/security_manual/security_manual_9_220.png)
...
2. Flexibly orchestrate MSE Grayscale, Blue-Green, Canary, Batch Grayscale, Istio and other release strategies to ensure release reliability. See: [Release Strategies](/en/Zadig%20v5.0/project/release-workflow/).
3. Add manual approval from security team during release phase to ensure release compliance in business processes.

![Security Service Access Manual](./_images/security_manual/security_manual_10.png)
![Security Service Access Manual](./_images/security_manual/security_manual_11.png)