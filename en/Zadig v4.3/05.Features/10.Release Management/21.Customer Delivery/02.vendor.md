...
permalink: /en/Zadig v4.3/plutus/vendor/
---
...
2. Integrate the Helm Chart repository in Zadig. For specific integration methods, refer to [here](/en/Zadig%20v4.3/settings/helm/)
:::
