...
![system_webhook](../../../../../../en/_images/system%20webhook-en.jpg)
...
| Field | Description |
| --- | --- |
| `object_kind` | Object type. Currently fixed as `workflow`. |
| `event` | Event name. Currently supported: `start_execute`, `complete_execute`. |
| `workflow` | Workflow task details. |
| `release_plan` | Release plan information. If the current task is not triggered by a release plan, this field is `null`. |
| `workflow.task_id` | Workflow task ID. |
| `workflow.project_name` | Project identifier. |
| `workflow.project_display_name` | Project display name. |
| `workflow.workflow_name` | Workflow identifier. |
| `workflow.workflow_display_name` | Workflow display name. |
| `workflow.status` | Current task status. |
| `workflow.remark` | Execution remark. |
| `workflow.detail_url` | Link to the task details page. |
| `workflow.error` | Error message. |
| `workflow.create_time` | Task creation time. |
| `workflow.start_time` | Task start time. |
| `workflow.end_time` | Task end time. |
| `workflow.stages` | Stage and job details. |
| `workflow.task_creator` | Task creator name. |
| `workflow.task_creator_id` | Task creator ID. |
| `workflow.task_creator_email` | Task creator email. |
| `workflow.task_type` | Task type. Currently `workflow`. |
