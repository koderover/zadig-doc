...
permalink: /en/Zadig v4.3/project/build/submodule
---
...
Copy the private key file prepared in the previous step to the `~/.ssh` path in the image runtime, build, and push the custom build image. For more details, refer to [Custom Image Management](/en/Zadig%20v4.3/settings/custom-image/).
