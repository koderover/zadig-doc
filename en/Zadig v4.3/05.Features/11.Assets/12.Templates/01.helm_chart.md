...
permalink: /en/Zadig v4.3/template/helm_chart/
---
...
::: tip Tips
Refer to the code repository for supported code repository: [Code Source Information](/en/Zadig%20v4.3/settings/codehost/overview/#function-compatibility-list), and refer to the code repository integration: [code repository integration](/en/Zadig%20v4.3/settings/codehost/overview/)
:::
...
> Turn on the `Automatic Synchronization` operation for the service. Refer to [the use template to create a new service](/en/Zadig%20v4.3/project/service/helm/chart/#create-a-new-service).
:::

![Apply to the service](../../../../_images/apply_helm_template_to_service.png)

## Using Templates
When creating a new service in [the K8s Helm Chart project](/en/Zadig%20v4.3/project/helm-chart/), you can choose to import services from templates, and refer to [using templates to create a new service](/en/Zadig%20v4.3/project/service/helm/chart/#create-a-new-service).
