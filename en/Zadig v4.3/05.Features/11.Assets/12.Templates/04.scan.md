...
permalink: /en/Zadig v4.3/template/scan/
---
...
Go to `Assets` → `Templates` → `Scan` in sequence to enter the build template management page. Click the `+` button, enter the template name, and refer to [Scan Configuration](/en/Zadig%20v4.3/project/scan/) to complete the template configuration.
...
For more best practices, refer to [Sonar Scan Best Practices](/en/Zadig%20v4.3/sonar-scan/practice/).