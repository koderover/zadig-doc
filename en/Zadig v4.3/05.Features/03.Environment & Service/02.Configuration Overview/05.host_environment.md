...
permalink: /en/Zadig v4.3/project/env/k8s/host/
---
...
- `K8s Cluster`: The Kubernetes cluster where the service to be hosted is located. Note: This cluster must be integrated into Zadig in advance. For details, refer to [Cluster Management](/en/Zadig%20v4.3/pages/cluster_manage)
