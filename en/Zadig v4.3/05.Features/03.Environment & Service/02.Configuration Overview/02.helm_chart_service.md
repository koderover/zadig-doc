...
permalink: /en/Zadig v4.3/project/service/helm/chart/
---
...
- `Sync from Code Repository` : Synchronize the service's configuration from the code base Helm Chart. For supported code sources, refer to [Code Source Information](/en/Zadig%20v4.3/settings/codehost/overview/#function-compatibility-list).
...
::: tip
1. You need to integrate the code source in the system. For more information, refer to [Code Source Integration](/en/Zadig%20v4.3/settings/codehost/overview/)
2. For supported code sources, refer to [Code Source Information](/en/Zadig%20v4.3/settings/codehost/overview/#function-compatibility-list)
:::
...
::: tip Prerequisites
You need to integrate the Helm Chart repository first. For more information, refer to [Integrate Helm Chart Repository](/en/Zadig%20v4.3/settings/helm/).
:::

Click on "Import from Chart Repository", select the Chart repository and Chart, and create the service.
![Import Helm Chart from Chart Repository](../../../../_images/helm_chart_from_chart_repo.png)

### Create a Single Service Using Templates
::: tip Prerequisites
You need to create a Helm Chart template in the system template library first. For more information, refer to [Helm Chart Template Management](/en/Zadig%20v4.3/template/helm_chart/)
:::
...
Refer to [Service Version Rollback](/en/Zadig%20v4.3/project/service/versions/).

## Service Components

Refer to [Service Components](/en/Zadig%20v4.3/env/overview/#what-is-a-service-component#k8s-helm-chart-project).
...
By tagging services, you can quickly classify and search for service metadata. For more information, refer to [Tag Management](/en/Zadig%20v4.3/project/service/label/).
...
- `Delivery artifact naming rules`: For details, refer to [Policy configuration](/en/Zadig%20v4.3/project/service/k8s/#policy-configuration).
