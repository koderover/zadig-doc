...
permalink: /en/Zadig v4.3/project/service/label/
---
...
Tag the service with relevant meta information, and the third-party system obtains service meta information by calling Zadig OpenAPI. For OpenAPI details, refer to [document](/en/Zadig%20v4.3/api/service/#get-the-service-tag).