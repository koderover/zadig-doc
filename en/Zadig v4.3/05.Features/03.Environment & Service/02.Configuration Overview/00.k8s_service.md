...
permalink: /en/Zadig v4.3/project/service/k8s/
---
...
::: tip
1. You need to integrate the code source in the system, refer to [Code Source Integration](/en/Zadig%20v4.3/settings/codehost/overview/)
...
::: tip
You need to create K8s YAML templates in the system template library first, refer to [K8s YAML Template Management](/en/Zadig%20v4.3/template/k8s_yaml/).
:::
...
Refer to the documentation: [Service Version Rollback](/en/Zadig%20v4.3/project/service/versions/).

## Service Components

![Service Components](../../../../_images/k8s_container.png)

Reference Documentation: [Service Components](/en/Zadig%20v4.3/env/overview/#what-is-a-service-component) .
...
By tagging services, you can quickly classify and search for service metadata. For specific configuration and usage, refer to the [documentation](/en/Zadig%20v4.3/project/service/label/).

## Variable Configuration

Through variable configuration, you can share a single service configuration across multiple environments. For specific configuration and usage, refer to the [documentation](/en/Zadig%20v4.3/project/service/variable/).
