...
Refer to [Create a new environment](/en/Zadig%20v4.3/project/env/k8s/#production-environment) .
...
- Using variable groups, variable groups manage reference [variable group configuration](/en/Zadig%20v4.3/project/helm-chart/#variable-groups)
