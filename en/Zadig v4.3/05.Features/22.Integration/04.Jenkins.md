...
permalink: /en/Zadig v4.3/settings/cicd/
---
...
You can then orchestrate the execution of Jenkins Job tasks in the workflow. For more details, reference the documentation: [Execute Jenkins Job](/en/Zadig%20v4.3/project/workflow-jobs/#ci-cd).
