...
permalink: /en/Zadig v4.3/settings/account/oauth2/
---
...
Refer to [setting the default account system](/en/Zadig%20v4.3/settings/account/ldap/#optional-set-as-the-default-account-system).