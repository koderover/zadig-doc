...
permalink: /en/Zadig v4.3/settings/monitor/
---
...
在自定义工作流中配置`观测云监测` 任务即可使用观测云监测服务是否健康，参考文档：[观测云监测](/en/Zadig%20v4.3/project/workflow-jobs/#观测云监测)。 -->
...
Configure `Grafana Service Monitoring Task` in a custom workflow to use Grafana Monitor whether the service is healthy, refer to [Grafana](/en/Zadig%20v4.3/project/workflow-jobs/#grafana-service-monitoring) .