...
permalink: /en/Zadig v4.3/project/helm-chart/
---
...
<img src="../../../_images/create_project_entrance_420.png" width="400">
...
Create and configure services. See [New K8s Helm Chart Service](/en/Zadig%20v4.3/project/service/helm/chart/#create-a-new-service) for details.

![Service Configuration](../../../_images/helm_chart_sample_onboarding_2.png)

The system automatically parses service components from the values file. Click `Add Build` to configure build settings. See [Build Configuration](/en/Zadig%20v4.3/project/build/).

> For service component concepts, see [Service component](/en/Zadig%20v4.3/env/overview/#what-is-a-service-component).
...
> For parameter details, see [Create a new environment](/en/Zadig%20v4.3/project/env/k8s/#create-a-new-environment).
...
Environment global variables can reference variable groups. See [update global variables](/en/Zadig%20v4.3/project/env/helm/chart/#update-global-variables) for details.