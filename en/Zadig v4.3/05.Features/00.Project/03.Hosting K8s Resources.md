...
permalink: /en/Zadig v4.3/project/host-k8s-resources/
---
...
2. For multi-cluster configuration, see [Cluster Management](/en/Zadig%20v4.3/pages/cluster_manage/).
:::

![Configure Hosting Project](../../../_images/env_delegate_onboarding_1.png)

### Configure Service Build
The system automatically parses service components. Click `Add Build` to configure build settings. See [Build Configuration](/en/Zadig%20v4.3/project/build/).
