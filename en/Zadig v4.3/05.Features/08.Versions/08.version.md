...
permalink: /en/Zadig v4.3/project/version/
---
...
> Helm Repo needs to be integrated in advance, refer to [Helm Repo](/en/Zadig%20v4.3/settings/helm/#how-to-integrate) for specific configuration.<br> When configuring the image Tag , if one Chart including multiple [service components](/en/Zadig%20v4.3/env/overview/#what-is-a-service-component) , `Apply All` can be used to quickly set the image of all service components Tag .
...
1. Integrate external systems. For specific integration methods, refer to [Other External Systems Integration](/en/Zadig%20v4.3/settings/others/).
