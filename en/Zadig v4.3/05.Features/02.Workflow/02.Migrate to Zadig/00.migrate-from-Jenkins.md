...
permalink: /en/Zadig v4.3/workflow/migrate-from-jenkins
---
...
- Step 1: Integrate the code source. For the specific process, see [GitLab Code Source Integration](/en/Zadig%20v4.3/settings/codehost/gitlab/)
...
2. In Zadig , the mirror naming rules support unified configuration and management. For details, see [the documentation](/en/Zadig%20v4.3/project/service/k8s/#policy-configuration) , so there is no need to define the generation rules for IMAGE variables in the script.
...
In addition to the above triggers, Zadig supports various other triggers, including "JIRA Trigger," "Feishu Project Trigger," and "Generic Trigger." For more details, refer to [the documentation](/en/Zadig%20v4.3/project/workflow-trigger/).
