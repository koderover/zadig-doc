...
permalink: /en/Zadig v4.3/workflow/external-approval/
---
...
Refer to the [creation of a pre-approval form OpenAPI](/en/Zadig%20v4.3/api/workflow/) documentation to submit approval data to the Zadig system.
