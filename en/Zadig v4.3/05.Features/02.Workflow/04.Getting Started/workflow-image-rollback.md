...
permalink: /en/Zadig v4.3/workflow/image/rollback/
---
...
> [K8s YAML Deployed projects](/en/Zadig%20v4.3/project/k8s-yaml/) and [Helm Chart Deployed projects](/en/Zadig%20v4.3/project/helm-chart/) support the image version fallback function.
