...
permalink: /en/Zadig v4.3/project/workflow-trigger/
---
...
![Workflow Details Page](../../../../_images/workflow_trigger_6_430.png)
...
- Other parameters: Refer to the description in [Git Trigger Basic Configuration](/en/Zadig%20v4.3/project/common-workflow/#git-trigger)
...
3. Refer to [Git Trigger Basic Configuration](/en/Zadig%20v4.3/project/common-workflow/#git-trigger), fill in the relevant configuration in Zadig and save.
...
2. Supported code sources refer to [Code Source Information](/en/Zadig%20v4.3/settings/codehost/overview/#feature-compatibility-list).
:::
...
- Other parameters: Refer to [Timer Configuration](/en/Zadig%20v4.3/project/common-workflow/#timer)
...
Trigger workflow by calling OpenAPI. For specific operations, refer to [Execute Workflow](/en/Zadig%20v4.3/api/workflow/#execute-workflow).