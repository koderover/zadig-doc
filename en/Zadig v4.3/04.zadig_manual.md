...
permalink: /en/Zadig v4.3/product-manual/usage/
---
...
IDE hot deployment, where code written locally is hot-deployed to a remote environment. See: [VSCode Plugin Usage Guide](/en/Zadig%20v4.3/zadig-toolkit/overview/).
...
- [Zadig Release Strategies](/en/Zadig%20v4.3/project/release-workflow/)
- [Zadig Workflow Approval](/en/Zadig%20v4.3/workflow/approval/)
...
- [Customer Delivery](/en/Zadig%20v4.3/plutus/overview/)
