...
permalink: /en/Zadig v4.3/developer-center/git-zadig/
---
...
Configure the Zadig workflow according to actual requirements and add corresponding Git triggers, refer to [documentation](/en/Zadig%20v4.3/project/common-workflow/#git-trigger).
