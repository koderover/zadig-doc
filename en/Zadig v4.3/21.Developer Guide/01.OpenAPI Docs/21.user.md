...
permalink: /en/Zadig v4.3/api/user/
---
...
| `identity_type` | Identity type; required when integrating external account systems, such as ldap, lark, oauth, dingtalk, workwx | string | No |
...
| `last_login_time` | Last login time (Unix timestamp, seconds) | int |
