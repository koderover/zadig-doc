...
permalink: /en/Zadig v4.3/settings/custom-task/
---
...
> Please refer to the documentation for supported code sources: [Code Source Information](/en/Zadig%20v4.3/settings/codehost/overview/) .
...
1. Refer to [the code source integration](/en/Zadig%20v4.3/settings/codehost/overview/) to integrate the above code library in Zadig
2. Refer to [the image registry integration](/en/Zadig%20v4.3/settings/image-registry/) , the image registry corresponding to the image is integrated in Zadig
...
After the configuration is complete, add tasks to the workflow, select tasks and save the workflow. For more advanced functions, please refer to [the workflow](/en/Zadig%20v4.3/project/common-workflow/) .
