...
permalink: /en/Zadig v4.3/test-manual/
---
...
SonarQube example: Add code scanning, specify `SonarQube` scanning tool, configure codebase to scan, scan scripts, and enable quality gate inspection. See: [Code Scan](/en/Zadig%20v4.3/project/scan/#%E6%96%B0%E5%BB%BA%E4%BB%A3%E7%A0%81%E6%89%AB%E6%8F%8F).

<img src="../../_images/daily_admin_17.png" width="400">
<img src="../../_images/daily_admin_18.png" width="400">

2. Configure code change triggers in code scan. See: [Trigger configuration](/en/Zadig%20v4.3/project/scan/#%E8%A7%A6%E5%8F%91%E5%99%A8%E4%B8%8E%E9%80%9A%E7%9F%A5).
...
1. Add new test, configure basic information, code information, and test scripts, specify report directory in test report configuration. See: [Testing](/en/Zadig%20v4.3/project/test/).

<img src="../../_images/daily_admin_20.png" width="400">
<img src="../../_images/daily_admin_21.png" width="400">

2. Configure code change triggers in tests. See: [Trigger configuration](/en/Zadig%20v4.3/project/test/#webhook-%E8%A7%A6%E5%8F%91%E5%99%A8).
![Test Management Operation Manual](../../_images/daily_admin_22.png)

3. Configure IM notifications in test. See: [Notifications Configuration](/en/Zadig%20v4.3/project/test/#%E9%80%9A%E7%9F%A5%E9%85%8D%E7%BD%AE).
...
#### How to Configure
Configuration process is similar to unit testing. See: [Configure tests in Zadig](/en/Zadig%20v4.3/test-manual/#%E5%A6%82%E4%BD%95%E9%85%8D%E7%BD%AE-2)

#### How to Orchestrate

Edit workflow, add `Test` tasks, specify task type as `Service Test`. See: [Workflow test configuration](/en/Zadig%20v4.3/project/workflow-jobs/#%E6%B5%8B%E8%AF%95%E4%BB%BB%E5%8A%A1).
...
Edit workflow, add `Test` tasks, specify task type as `Product Test`. See: [Workflow test configuration](/en/Zadig%20v4.3/project/workflow-jobs/#%E6%B5%8B%E8%AF%95%E4%BB%BB%E5%8A%A1).
...
Zadig can quickly set up independent development and testing environments. See: [New Environment](/en/Zadig%20v4.3/project/env/k8s/#%E6%96%B0%E5%BB%BA%E7%8E%AF%E5%A2%83). By integrating test orchestration into the workflow, you can build automated test suites in both the development and testing environments, and incorporate testing capabilities into every aspect of the team's daily collaboration:
...
2. Flexibly orchestrate release strategies such as MSE Grayscale, Blue-Green, Canary, Gradual Rollout, and Istio to ensure reliable releases. See: [Release Strategies](/en/Zadig%20v4.3/project/release-workflow/).
