...
permalink: /en/Zadig v4.3/quick-start/a-basic-project/
---
...
- Install Zadig: [Installation Documentation](/en/Zadig%20v4.3/install/guide)
- Integrate GitHub as the code source and fork the [example source code](https://github.com/koderover/zadig/tree/main). For code source integration, refer to: [GitHub Integration](/en/Zadig%20v4.3/settings/codehost/github/)
- Integrate the image registry: [Image Registry Integration](/en/Zadig%20v4.3/settings/image-registry/)

::: tip
If you do not use GitHub as the code source, you can download the code and upload it to your own code source, then integrate it in Zadig. See: [Code Source Integration](/en/Zadig%20v4.3/settings/codehost/overview/).
:::
...
> For DingTalk and WeCom configuration, see: [Notification Configuration](/en/Zadig%20v4.3/workflow/im/)
