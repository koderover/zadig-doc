...
permalink: /en/Zadig v4.3/faq/product-usage/
---
...
Reference documentation: [Build Templates](/en/Zadig%20v4.3/template/build/).
...
2. By configuring workflow Webhook, you can trigger workflow runs when code is pushed to the code repository and Pull Request (Merge Request) is submitted, realizing the process from submission to build automation. For details, refer to [Code Changes Trigger Workflow](/en/Zadig%20v4.3/workflow/trigger/#code-changes-trigger).
