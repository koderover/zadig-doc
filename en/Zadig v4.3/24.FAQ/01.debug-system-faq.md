...
permalink: /en/Zadig v4.3/faq/debug-system/
---
...
Recover the managed cluster and reconnect the downed cluster in the Zadig system. Reference documentation: [Cluster Management](/en/Zadig%20v4.3/pages/cluster_manage/).
...
> Cluster management reference documentation: [Cluster Management](/en/Zadig%20v4.3/pages/cluster_manage/).
