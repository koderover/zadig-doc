...
permalink: /en/Zadig v4.3/stable/zadig-to-zadigx/
---
...
3. The version of Zadig must not be lower than v1.18.0. If the version does not meet this requirement, please refer to the [upgrade documentation](/en/Zadig%20v4.3/release-notes/v1.18.0/) to upgrade it first.
