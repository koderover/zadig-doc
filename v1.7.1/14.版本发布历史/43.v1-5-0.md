...
permalink: /v1.7.1/release-notes/v1.5.0/
---
...
2. 如果当前系统版本 < v1.3.1，请先升级到 v1.3.1，具体升级过程参见 [v1.3.1 升级方式](/v1.7.1/release-notes/v1.3.1/)，再按照以下方式升级到 v1.5.0
:::
...
2. 如果使用[`基于 Helm 命令安装`](/v1.7.1/install/helm-deploy/) 安装，执行以下步骤升级 v1.5.0：
