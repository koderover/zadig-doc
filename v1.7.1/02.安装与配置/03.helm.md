...
helm upgrade --install zadig --namespace ${NAMESPACE} koderover-chart/zadig --version=1.7.1 --set endpoint.FQDN=${DOMAIN} \
...
helm upgrade --install zadig --namespace ${NAMESPACE} koderover-chart/zadig --version=1.7.1 --set endpoint.type=IP \
    --set endpoint.IP=${IP} \
