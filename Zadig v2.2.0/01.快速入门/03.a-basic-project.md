...
- 安装 Zadig，参考[安装文档](/Zadig%20v2.2.0/install/helm-deploy)
...
- 集成镜像仓库，参考文档：[`镜像仓库集成`](/Zadig%20v2.2.0/settings/image-registry/)
...
> 钉钉和企业微信的配置请参考文档：[通知配置](/Zadig%20v2.2.0/project/workflow/#im-状态通知)。
