...
- 其他参数：请参考 [Git 触发器基本配置](/Zadig%20v2.2.0/project/workflow/#自动创建)中的描述
...
3. 参考 [Git 触发器基本配置](/Zadig%20v2.2.0/project/workflow/#自动创建)，填写 Zadig 中的相关配置后保存即可。
...
- 其他参数：参考[定时器配置](/Zadig%20v2.2.0/project/workflow/#定时器)
