...
permalink: /Zadig v2.2.0/release-notes/v1.18.0/
---
...
::: warning
内置软件包原始下载地址中的资源将会于 2023.10.31 删除，如果有使用需要，请参考文档 [软件包管理](/Zadig%20v2.2.0/settings/app/) 进行配置。
:::

## 版本升级过程
::: warning
如果当前系统版本 < v1.17.0，请先升级到 v1.17.0，具体升级过程参见 [v1.17.0 升级方式](/Zadig%20v2.2.0/release-notes/v1.17.0/#版本升级过程)，再按照以下方式升级到 v1.18.0
:::
