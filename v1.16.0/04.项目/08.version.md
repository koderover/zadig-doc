...
permalink: /v1.16.0/project/version/
---
...
> Helm 仓库需事先集成，具体配置参考 [Helm 仓库](/v1.16.0/settings/helm/)。<br>在配置镜像 Tag 时，若一个 Chart 中包括多个[服务组件](/v1.16.0/quick-start/concepts/#服务组件)，可使用`应用全部`来快速设置所有服务组件的镜像 Tag。
...
1. 集成外部系统，具体集成方式参见[其他外部系统集成](/v1.16.0/settings/others/)。
