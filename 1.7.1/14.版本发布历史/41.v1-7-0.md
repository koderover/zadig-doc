...
permalink: /v1.7.1/release-notes/v1.7.0/
---

2021 年 11 月 16 日，Zadig 正式发布 v1.7.1。
...
::: warning 背景信息
1. Kubernetes 集群版本需要 ≥ 1.16。
2. <font color=#FF000 >**不支持跨版本升级**</font>，如果当前 Zadig 系统版本 < v1.6.0，请先参考 [v1.6.0 升级方式](/v1.7.1/release-notes/v1.6.0/#版本升级方式) 升级到 v1.6.0，再按照以下方式升级到 v1.7.1。
3. v1.7.1 版本中未保留用户账号信息，安装完成后，使用系统提供的内置账号密码在用户管理里新建即可。
:::
...
bash uninstall.sh
```
#### 步骤 3：安装 Zadig v1.7.1 
1. 下载[安装脚本](https://github.com/koderover/zadig/releases/tag/v1.7.1)，执行安装脚本。
```bash
