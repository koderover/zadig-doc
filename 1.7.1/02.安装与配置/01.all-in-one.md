...
|版本 |下载源 | 说明 |
|---|---|---|
|Nightly|官方下载源：[https://download.koderover.com/install?type=all-in-one](https://download.koderover.com/install?type=nightly)| 基于最新代码定时发布 |
|正式版|官方下载源：[https://download.koderover.com/install?type=all-in-one](https://download.koderover.com/install?type=all-in-one) <br> GitHub 源：[https://github.com/koderover/zadig/releases/latest/download/all_in_one_install_quickstart.sh](https://github.com/koderover/zadig/releases/latest/download/all_in_one_install_quickstart.sh) | 适用于快速体验，不推荐生产使用 |
