...
环境创建完成后，点击不同的环境 Tab 即可切换到该环境的详情页面，生产环境右上角会有`生产`标识。更多信息请参考测试环境中的描述：[查看环境](/ZadigX%20v1.5.0/project/env/helm/chart/#查看环境)。
...
具体操作可参考文档 [添加 ZadigX 服务](/ZadigX%20v1.5.0/project/env/helm/chart/#添加服务)。
...
参考文档：[更新 ZadigX 服务](/ZadigX%20v1.5.0/project/env/helm/chart/#更新服务)。
...
参考文档：[删除服务](/ZadigX%20v1.5.0/project/env/helm/chart/#删除服务)。
