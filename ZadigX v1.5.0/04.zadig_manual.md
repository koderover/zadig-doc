...
## 软件交付面临的问题
系统的软件交付是个漫长且充满挑战的过程，和人、技术、流程、工具等关键要素都息息相关。企业在软件交付中遇到的问题包括但不限于：

1. 开发环境难模拟，多业务联调艰难，实际有效研发时间有限，研发团队交付效率低下。
2. 大量手工测试有效性低，环境不稳定并行验证效率低，自动化建设困难，测试团队价值难以体现。
3. 基于 Jenkins + 脚本等单点工具提升单点效率，运维团队手工操作繁重且工具链/脚本维护心智负担重，面向大规模交付时效率低成本高。
4. 跨部门碎片化沟通严重，大量时间花在流程制定上，各方能力受限。
5. ......

为了解决这些痛点问题，ZadigX 应运而生：通过平台工程解决流程挑战，通过技术升级提升组织效能，建立产研全流程一体化工程协同基线，充分释放团队生产力。
