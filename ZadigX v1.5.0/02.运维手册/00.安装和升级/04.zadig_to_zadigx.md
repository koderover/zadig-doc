...
permalink: /ZadigX v1.5.0/stable/zadig-to-zadigx/
---

本文档旨在提供从 Zadig 到 ZadigX 的升级指南，适用于 Zadig 已经正式投入使用，希望将其升级为 ZadigX 的用户，主要包括以下内容：

- [从 Zadig 升级到 ZadigX 的注意事项](#注意事项)，非常重要，请仔细阅读
- [升级前的准备工作](#准备工作)
- [从 Zadig 升级 ZadigX 的详细步骤](#升级步骤)

## 注意事项

1. ZadigX 和 Zadig 的数据结构差异较大，升级操作不可逆，降级会造成不可用。如果要试用 ZadigX，建议全新安装来体验，参考文档：[试用 ZadigX](/ZadigX%20v1.5.0/stable/quick-install/)。
2. Zadig 的版本不能低于 v1.17.0，如果版本不能满足，请参考[升级文档](/Zadig%20v1.17.0/release-notes/v1.17.0/#版本升级过程)先将其升级。
