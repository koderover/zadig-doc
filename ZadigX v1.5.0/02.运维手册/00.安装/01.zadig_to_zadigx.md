...
1. 升级操作不可逆，Zadig / ZadigX 的数据结构差异较大，降级会造成不可用。如果要试用 ZadigX，建议使用[官方安装小助手](https://www.koderover.com/trial)来全新安装。
2. Zadig 的版本不能低于 v1.17.0，如果版本不能满足，请参考[升级文档](/Zadig%20v1.17.0/release-notes/v1.17.0/#版本升级过程)先将其升级。
3. 升级前请[联系官方](https://www.koderover.com/contacts)以获取 ZadigX 使用许可证。
...
::: tip
管理员默认账号和密码分别是 admin 和 zadig，如果安装 Zadig 时有做修改，以修改的为准。
:::
