...
新增代码扫描，填写代码扫描配置，参考文档：[代码扫描](/ZadigX%20v1.5.0/project/scan/)。

::: tip
对于 SonarQube 工具，可开启质量门禁检查，参考文档：[质量门禁检查](/ZadigX%20v1.5.0/project/scan/#质量门禁检查)。
:::
...
2. 灵活编排蓝绿、金丝雀、分批次灰度、Istio 等发布策略，以确保发布可靠性，可参考：[发布工作流](/ZadigX%20v1.5.0/project/release-workflow/)。
