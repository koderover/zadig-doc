...
IDE 热部署，本地编写完代码热部署到远端环境，具体参考：[VSCode 插件使用指南](/Zadig%20v3.1/zadig-toolkit/overview/)。
...
- [Zadig 发布策略](/Zadig%20v3.1/project/release-workflow/)
- [Zadig 工作流审批](/Zadig%20v3.1/workflow/approval/)
...
- [客户交付](/Zadig%20v3.1/plutus/overview/)
