...
> Helm 仓库需事先集成，具体配置参考 [Helm 仓库](/Zadig%20v3.1/settings/helm/)。<br>在配置镜像 Tag 时，若一个 Chart 中包括多个[服务组件](/Zadig%20v3.1/env/overview/#什么是服务组件)，可使用`应用全部`来快速设置所有服务组件的镜像 Tag。
...
1. 集成外部系统，具体集成方式参见[其他外部系统集成](/Zadig%20v3.1/settings/others/)。
